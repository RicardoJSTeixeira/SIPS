...
(function ($) {
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (settings.voiceLogin) {
            $('#bot1-Msg1').removeClass('botTempo').attr('id', 'validateSipPhone').attr('type', 'submit');
            $('#bot2-Msg1').attr('id', 'cancelValidateSipPhone');
            $('#txt1').attr('id', 'validateSipPhoneInput').mask('?999999999', {
                placeholder : ""
            });
            ...
            $('#bot1-Msg1').removeClass('botTempo').attr('id', 'reValidateSipPhone').attr('type', 'submit');
            $('#bot2-Msg1').removeClass('botTempo').attr('id', 'cancelreValidateSipPhone');
            $('#bot3-Msg1').addClass('hidden')
            $('#txt1').attr('id', 'reValidateSipPhoneInput').mask('?999999999', {
                placeholder : ""
            });
            $('.MessageBoxButtonSection').append('<div id="validateSipPhoneError"></div>');
