    ...
    this.init = function(zone, rid) {
        ...
        zone.find("#plus-client").click(function(e) {
            ...
            zone.find("#mass_client_table tbody").append(
                    ...
                    .append($("<td>")
                            .append($("<input>", {type: "text", name: "cbd[]", placeholder: "",  'data-prompt-position': 'topRight:120', class: "span " + ((!~~recomendado) ? "validate[required]" : "")})
                                    .datetimepicker({format: 'dd-mm-yyyy', autoclose: true, language: "pt", startView: 2, minView: 2, initialDate: new Date(moment().subtract('years', 65).format()), 'data-prompt-position': 'topRight:120'}))
                            )
                    .append($("<td>")
