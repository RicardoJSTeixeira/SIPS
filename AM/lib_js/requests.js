    ...
    this.apoio_marketing = {
        ...
        new: function (am_zone) {
            ...
            $.get("/AM/view/requests/apoio_marketing.html", function (data) {
                am_zone.append(data);
                $('#apoio_am_form').stepy({
                    backLabel: "Anterior", nextLabel: "Seguinte", next: function () {
                        return ~~am_zone.find("#apoio_am_form").validationEngine("validate");
                    }, finishButton: false
                });

                am_zone.find("#data_rastreio1").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    minView: 2,
                ...
                am_zone.find("#data_rastreio2").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    minView: 2,
                ...
                am_zone.find("#data_inicio1").datetimepicker({
                    format: 'hh:ii',
                    autoclose: true,
                    language: "pt",
                    startView: 1,
                    ...
                    .on('changeDate', function () {
                        $("#data_inicio2").datetimepicker('setStartDate', moment(moment().format('YYYY-MM-DDT' + $(this).val())).add("minutes", 30).format("YYYY-MM-DDTHH:mm"));
                    });
                am_zone.find("#data_inicio2").datetimepicker({
                    format: 'hh:ii',
                    autoclose: true,
                    language: "pt",
                    startView: 1,
                    ...
                    .on('changeDate', function () {
                        $("#data_inicio1").datetimepicker('setEndDate', moment(moment().format('YYYY-MM-DDT' + $(this).val())).subtract("minutes", 30).format("YYYY-MM-DDTHH:mm"));
                        $("#data_fim1").datetimepicker('setStartDate', moment(moment().format('YYYY-MM-DDT' + $(this).val())).add("minutes", 30).format("YYYY-MM-DDTHH:mm"));
                    });
                am_zone.find("#data_fim1").datetimepicker({
                    format: 'hh:ii',
                    autoclose: true,
                    language: "pt",
                    startView: 1,
                    ...
                    .on('changeDate', function () {
                        $("#data_inicio2").datetimepicker('setEndDate', moment(moment().format('YYYY-MM-DDT' + $(this).val())).subtract("minutes", 30).format("YYYY-MM-DDTHH:mm"));
                        $("#data_fim2").datetimepicker('setStartDate', moment(moment().format('YYYY-MM-DDT' + $(this).val())).add("minutes", 30).format("YYYY-MM-DDTHH:mm"));
                    });
                am_zone.find("#data_fim2").datetimepicker({
                    format: 'hh:ii',
                    autoclose: true,
                    language: "pt",
                    startView: 1,
                    ...
                    .on('changeDate', function () {
                        $("#data_fim1").datetimepicker('setEndDate', moment(moment().format('YYYY-MM-DDT' + $(this).val())).subtract("minutes", 30).format("YYYY-MM-DDTHH:mm"));
                    });
                ...
                am_zone.on("change", "[name='horario_check']", function () {
                    if (~~$(this).val() === 1) {
        ...
        get_to_datatable: function (am_zone) {
            ...
            am_zone.on("click", ".ver_local_publicidade", function () {
                ...
                $.msg();
                $.post("/AM/ajax/requests.php", {
                    action: "get_locais_publicidade_from_apoio_marketing",
                    id: id
                }, function (data) {
            ...
            am_zone.on("click", ".decline_apoio_marketing", function () {
                ...
                bootbox.prompt("Qual o motivo?", function (result) {
                    if (result !== null) {
                        $.msg();
                        $.post('/AM/ajax/requests.php', {
                            action: "decline_apoio_marketing",
                            id: this_button.val(),
                            message: result
                        }, function () {
    ...
    this.relatorio_frota = {
        ...
        new: function (rf_zone) {
            ...
            $.get("/AM/view/requests/relatorio_frota.html", function (data) {
                rf_zone.append(data);
                rf_zone.find(".form_datetime").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    startView: 2,
                ...
                rf_zone.find(".rf_datetime").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    startView: 2,
                ...
                rf_zone.find("#button_rf_table_add_line").click(function (e) {
                    ...
                    rf_zone.find("#rf_datetime" + rfinput_count).datetimepicker({
                        format: 'yyyy-mm-dd',
                        autoclose: true,
                        language: "pt",
                        startView: 2,
    ...
    this.relatorio_correio = {
        ...
        new: function (rc_zone) {
            ...
            $.get("/AM/view/requests/relatorio_correio.html", function (data) {
                rc_zone.append(data);
                rc_zone.find(".form_datetime").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    minView: 2
                    ...
                    if (rc_zone.find("#relatorio_correio_form").validationEngine("validate")) {
                        if (rc_zone.find("#doc_obj_table_tbody tr").length) {
                            ...
                            $.each(rc_zone.find("#doc_obj_table_tbody tr"), function () {
                                docs_objs.push({
                                    anexo: $(this).find(".input_anexo").val(),
                                    n_doc: $(this).find(".input_n_doc").val(),
                                    lead_id: $(this).find(".input_lead_id").val(),
                                    confirmed: false,
                                    admin: 0
                                });
                            });
                            ...
                            $.post("ajax/requests.php", {
                                    action: "criar_relatorio_correio",
        ...
        get_to_datatable: function (rc_zone) {
            ...
            basic_path.on("click", "#correio_modal_div #add_anexo_yes_button", function (e) {
                ...
                if ($("#correio_modal_div #add_anexo_div").validationEngine("validate")) {
                    ...
                    var temp = {
                        anexo: $("#correio_modal_div #add_anexo_ficheiro").val(),
                        n_doc: $("#correio_modal_div #add_anexo_documento").val(),
                        lead_id: $("#correio_modal_div #add_anexo_lead_id").val(),
                        confirmed: 0,
                        admin: 1
                    };
                    ...
                    $.each($("#ver_anexo_correio_modal #tbody_ver_anexo_correio").find("tr"), function () {
                        anexo_array.push({
                            anexo: $(this).find(".input_anexo").text(),
                            n_doc: $(this).find(".input_n_doc").text(),
                            lead_id: $(this).find(".input_lead_id").text(),
                            confirmed: ~~$(this).find(".checkbox_confirm_anexo").is(":checked"),
                            admin: ~~$(this).hasClass("warning")
                        });
                    });
                    $.msg();
                    $.post('/AM/ajax/requests.php', {
                        action: "save_anexo_correio",
                        id: data_button.data().id_correio,
                        anexos: anexo_array
                    }, function () {
            ...
            rc_zone.on("click", ".ver_anexo_correio", function (e) {
                ...
                $("#anexo_add_button").toggle(SpiceU.user_level > 5);
                $.msg();
            ...
            basic_path.on("click", "#correio_modal_div #anexo_save_button", function () {
                var
                    anexo_array = [],
                    this_button = $(this),
                ...
                $.post("/AM/ajax/requests.php", {
                    action: "save_anexo_correio",
                    id: this_button.data().id_correio,
                    anexos: anexo_array
                }, function () {
                    $.msg('unblock');
                }, "json");
    ...
    this.relatorio_mensal_stock = {
        ...
        new: function (rms_zone) {
            ...
            $.get("/AM/view/requests/relatorio_mensal_stock.html", function (data) {
                ...
                rms_zone.find(".form_datetime").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    minView: 2
                    ...
                    if (rms_zone.find("#relatorio_mensal_stock_form").validationEngine("validate")) {
                        ...
                        if (rms_zone.find("#table_tbody_rfms tr").length) {
                            $.each(rms_zone.find("#table_tbody_rfms tr"), function () {
                                prdt_objs.push({
                                    quantidade: $(this).find(".quant").val(),
                                    descricao: $(this).find(".desc").val(),
        ...
        get_to_datatable: function (rms_zone) {
            ...
            basic_path.on("click", "#stock_modal_div #add_stock_yes_button", function (e) {
                ...
                if ($("#stock_modal_div #add_stock_div").validationEngine("validate")) {
                    ...
                    var temp = {
                        quantidade: $("#add_stock_div #add_stock_quantidade").val(),
                        descricao: $("#add_stock_div #add_stock_descricao").val(),
                        serie: $("#add_stock_div #add_stock_serie").val(),
                        obs: $("#add_stock_div #add_stock_obs").val(),
                        confirmed: 0,
                        admin: 1
                    };
                    ...
                    $.each($("#ver_anexo_mensal_stock_modal #tbody_ver_produto_mensal_stock").find("tr"), function () {
                        prod_array.push({
                            ...
                            serie: $(this).find(".td_helper_serie").text(),
                            obs: $(this).find(".td_helper_obs").text(),
                            confirmed: ~~$(this).find("td").first().find(":checkbox").is(":checked"),
                            admin: ~~$(this).hasClass("warning")
                        });
                    });
                    $.msg();
            ...
            basic_path.on("click", "#stock_save_button", function (e) {
                ...
                $.post("/AM/ajax/requests.php", {
                    action: "save_stock",
                    id: this_button.data().id_stock,
                    produtos: anexo_array
                }, function (data) {
                    $.msg('unblock');
                }, "json");
            });
    ...
    this.relatorio_movimentacao_stock = {
        ...
        new: function (rmovs) {
            ...
            $.get("/AM/view/requests/relatorio_movimentacao_stock.html", function (data) {
                rmovs.append(data);
                rmovs.find(".form_datetime").datetimepicker({
                    format: 'yyyy-mm-dd',
                    autoclose: true,
                    language: "pt",
                    minView: 2
                    ...
                    if (rmovs.find("#relatorio_movimentacao_stock_form").validationEngine("validate")) {
                        ...
                        if (rmovs.find("#table_tbody_rfms tr").length) {
                            $.each(rmovs.find("#table_tbody_rfms tr"), function () {
                                prdt_objs.push({
                                    quantidade: $(this).find(".quant").val(),
                                    destinatario: $(this).find(".destinatario").val(),
        ...
        get_to_datatable: function (rmovs) {
                ...
                if (this_button.parents("td").prev().prev().find("button").data().approved) {
                    bootbox.prompt("Comentários?", function (result) {
                        if (result !== null) {
                            $.msg();
                            $.post('/AM/ajax/requests.php', {
                                action: "accept_report_movimentacao",
                                id: this_button.val(),
                                message: result
                            }, function () {
                                this_button.parent("td").prev().text("Aprovado");
            ...
            rmovs.on("click", ".decline_report_movimentacao", function () {
                ...
                bootbox.prompt("Qual o motivo?", function (result) {
                    if (result !== null) {
                        $.msg();
                        $.post('/AM/ajax/requests.php', {
                            action: "decline_report_movimentacao",
                            id: this_button.val(),
                            message: result
                        }, function () {
                            this_button.parent("td").prev().text("Rejeitado");
            ...
            basic_path.on("click", "#mov_modal_div #add_mov_yes_button", function (e) {
                ...
                if ($("#mov_modal_div #add_mov_div").validationEngine("validate")) {
                    ...
                    var temp = {
                        destinatario: $("#add_mov_div #add_mov_destin").val(),
                        quantidade: $("#add_mov_div #add_mov_quantidade").val(),
                        descricao: $("#add_mov_div #add_mov_descricao").val(),
                        serie: $("#add_mov_div #add_mov_serie").val(),
                        obs: $("#add_mov_div #add_mov_obs").val(),
                        confirmed: 0,
                        admin: 1
                    };
                    prod_array.push(temp);
                    $.each($("#ver_anexo_mov_stock_modal #tbody_ver_produto_movimentacao_mov").find("tr"), function () {
                        prod_array.push({
                            destinatario: $(".td_helper_destinatario").val(),
                            quantidade: $(this).find(".td_helper_quantidade").text(),
                            descricao: $(this).find(".td_helper_descricao").text(),
                            serie: $(this).find(".td_helper_serie").text(),
                            obs: $(this).find(".td_helper_obs").text(),
                    ...
                    $.msg();
                    $.post('/AM/ajax/requests.php', {
                        action: "save_mov_stock",
                        id: data_button.data().id_movimentacao,
                        produtos: prod_array
                    }, function () {
            ...
            basic_path.on("click", "#mov_save_button", function (e) {
                ...
                $.each($("#ver_anexo_mov_stock_modal #tbody_ver_produto_movimentacao_mov").find("tr"), function () {
                    anexo_array.push({
                        destinatario: $(this).find(".td_helper_destinatario").text(),
                        quantidade: $(this).find(".td_helper_quantidade").text(),
                        descricao: $(this).find(".td_helper_descricao").text(),
                        serie: $(this).find(".td_helper_serie").text(),
                        obs: $(this).find(".td_helper_obs").text(),
                ...
                $.post("/AM/ajax/requests.php", {
                    action: "save_mov_stock",
                    id: this_button.data().id_movimentacao,
                    produtos: anexo_array
                }, function (data) {
                    $.msg('unblock');
                }, "json");
