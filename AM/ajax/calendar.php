...
date_default_timezone_set('GMT');// Atlantic/Azores |o gmt não tem hora de inverno, mas o dos açores é gmt mas no inverno fica gmt + 0 o que corrige todos os stress de quando muda a hora
