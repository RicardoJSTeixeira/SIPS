...
switch ($action) {
    ...
    case "populate_consults"://ALL MARCAÇOES
        ...
        $query = "SELECT extra2 'cod cliente', '' as 'interaction log', a.lead_id 'sugar ref', id_reservation , a.entry_date, consulta_razao ,start_date,consulta_razao,consulta_razao, id_user, '' as 'salesperson code', extra1 'camp cod', IF(exame,'YES','NO') "
