...
$db = new Mysqlidb('localhost', 'sipsadmin', 'sipsps2012', 'asterisk');
...
class MysqliDB {
    ...
    /**
	 * Pass in a raw insert and an array containing the parameters to bind to the prepaird statement.
	 *
     * @author purosinonimo
     * 
	 * @param string $query Contains a user-provided insert.
	 * @param array $bindData All variables to bind to the SQL statment.
	 * @return boolean
	 */
	public function rawInsert($query, $bindParams = NULL) 
	{
		$this->_query = filter_var($query, FILTER_SANITIZE_STRING);
		$stmt = $this->_prepareQuery();
	 ...
	 * @return boolean
	 */
	public function rawUpdate($query, $bindParams = NULL) 
	{
		$this->_query = filter_var($query, FILTER_SANITIZE_STRING);
		$stmt = $this->_prepareQuery();
	 ...
	 /**
	 * Pass in a raw DELETE and an array containing the parameters to bind to the prepaird statement.
	 *
     * @author purosinonimo
     * 
	 * @param string $query Contains a user-provided insert.
	 ...
	 * @return boolean
	 */
	public function rawDelete($query, $bindParams = NULL) 
	{
		$this->_query = filter_var($query, FILTER_SANITIZE_STRING);
		$stmt = $this->_prepareQuery();
