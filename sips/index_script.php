...
function showdispo(y)
{
	document.getElementById('calldispo').style.display = 'block';
	
}

function validachamada(y) {
 if (document.getElementById('tcontacto').value == '---') { alert('Escolha o tipo de contacto'); return false; } else {
	 if(document.getElementById('tcontacto').value != 'naocontacto') {
 		if	(document.getElementById('resultado').value == '---') { alert('Escolha o resultado da chamada'); return false; } } }
		
 if (document.getElementById('resultado').value == 'recusa' ) {		
		
 if	(document.getElementById('mrecusa').value == '---') { alert('Escolha o motivo de recusa'); return false; } }
 
 if (document.getElementById('resultado').value == 'venda') {
	 if (document.getElementById('venda').value == '---') { alert('Preencha os serviços que o cliente aderiu'); return false; } }
	
}
	
 //   window.onbeforeunload = confirmExit;
  //  function confirmExit() {
   //    alert ("ATENÇÃO! Tem que fazer submeter no fim da página. Escolha ficar na página e finalize.");
//		return false;
 //   }
</script>
...
<?php
	...
	$cav = mysql_query("SELECT cav from t_colaborador WHERE uservici = '$user'");
	
	$cav = mysql_fetch_assoc($cav);
	$cav = $cav['cav'];
...
<br /><label class="header">CAV: <? echo $cav; ?></label>
</td>
</tr>
</table>
</td>
<td valign=top width="600" rowspan="2">
<table border=1 width="600" align="center">
   ...
   <tr align="center">
      <td colspan="5" align="center" style='background-color:#FFF;'><Hr /> <!-- <label class="header">Dados de Despiste - Preencher o máximo possível!<br />
      </label> -->
...
<div id=div_intro style=' width:100%; background-color:#FFF;'>


<table width=95%>
<tr><td colspan=2>
<center><font size=3> -------- Apresentação e Despiste Inicial -------- <br><br> </font>
</td>
</tr>
<tr>
<td colspan='2'>
<font size=3>	Muito boa tarde, fala <? echo $user; ?> da ZON TVCabo, será possivel falar com o Sr/Sra. <? echo $nome; ?> ?
	<br><br>
	Estamos a contactar os moradores da sua área de residência devido a novas campanhas que temos para lhe sugerir.
	<br><br>
	Indique-me por favor que serviços tem actualmente na sua residência: </font>
	<br><br>
	<p>
        <label>
<font size=3>          <input type="checkbox" name="tvnetvoz[]" value="tv" <?php if ($tv == '1') { echo 'checked = "yes"'; } ?>/>
          TV</label>
        <br />
        <label>
          <input type="checkbox" name="tvnetvoz[]" value="net" <?php if ($net == '1') { echo 'checked = "yes"'; } ?> />
    <font size=3>      NET</label>
        <br />
        <label>
          <input type="checkbox" name="tvnetvoz[]" value="voz" <?php if ($voz == '1') { echo 'checked = "yes"'; } ?> />
    <font size=3>      VOZ</label>
        <br /></font>
      </p>
	  <br><br>
	<font size=3>Qual é o seu actual operador: <br><br>
	<select name="opactual" id="opactual">
	...
	<br><br>
	Quanto é que está a pagar pelos serviços que dispõe?
	<br>
...
<tr style='cursor:pointer;' onclick="Dnone('div_intro'); Dinline('div_cliente');">
<td width=30px>
<img  src='/images/icons/resultset_next.png' />
</td><td> Avançar </td>
</tr>
</table>
...
<div id=div_cliente style='display:none; width:100%; background-color:#FFF;'>
<table width=95% align='center'>
<tr><td colspan=2>

<center> -------- Apresentação da VAGA e Apresentação dos Pacotes ZON -------- <br><br>
</tr>
<tr>
<td width=50% align=center>
<a href='#'>Campanha Normal</a></td> <td width=50% align=center><a href='#'>Campanha Zonas Cabovisão</a></td>
</tr>
</td></tr>
<tr>
<td colspan='2'>
<font size=3>	Argumentos de venda:
	<br>
<font size=3>	Televisão
	<ul>
	<li>ZONBOX IRIS - Melhor Software em Portugal</li>
	<li>Gravação de TV - ZONBOX DVR</li>
	<li>Restart TV (Voltar ao inicio de qualquer programa) - IRIS</li>
	<li>35 Canais em todas as TV's (pacotes Digital OU IRIS)</li>
	<li>Maior oferta de canais em alta definição</li>
	<li>Videoclube mais completo do mercado</li>
	</ul>
	<br>
	Internet
	<ul>
	<li>Velocidades até 360Mb - Fibra</li>
	<li>Router Wireless ZON HUB</li>
	<li>ZONFON - Hotspots de Internet no país inteiro</li>
	</ul>
	<br>
	Telefone
	<ul>
	<li>Chamadas ilimitadas para toda a rede fixa nacional</li>
	<li>Chamadas para 50 destinos internacionais (21h - 09h + FDS dia inteiro)</li>
	<li>ZON Mobile com oferta de 5€ todos os meses de saldo</li>
	</ul>
</td>
</tr>
</table>
<table width=95%>
<tr onclick="javascript:Dnone('div_cliente'); Dinline('div_ni');" style='cursor:pointer'>
<td width=30px>
<img  src='/images/icons/resultset_next.png' />
</td><td>Não interessado / Já Cliente</td>
</tr>
<tr onclick="javascript:Dnone('div_cliente'); Dinline('div_callback');" style='cursor:pointer' >
<td width=30px>
<img src='/images/icons/resultset_next.png' />
</td><td>Agendar Call-Back</td>
</tr>
<tr onclick="javascript:Dnone('div_cliente'); Dinline('div_venda');" style='cursor:pointer'>
<td width=30px>
<img   src='/images/icons/resultset_next.png' />
</td><td>Fechar Venda</td>
</tr>
...
<div id=div_callback style='display:none;'>

<table width=95% style='font-size:18px'>

<tr><td colspan=2>

<center><font size=3> -------- Agendamento de CallBack -------- <br><br>
</tr>



<tr><td colspan=2>
<center><a href='#' onclick="javascript:Dnone('div_callback'); Dinline('div_cliente');" >Voltar</a></td></tr>
<tr>
<td colspan='2'>
	<center><font size=3>----------OBRIGATÓRIO CONFIRMAR DIA E HORA----------
<br><br>
	<font size=3>Sr/Sra <? echo $nome; ?> indique-me por favor qual é o melhor dia e hora para voltar a contactar: <br><br>

<tr><font size=3> <td width=33%>Dia:</td> <td><input style=width:150px type='text' name='diacb' /></td></tr>

<tr><font size=3><td>	Hora:</td><td> <input style=width:150px type='text' name='horacb' /></td></tr>

<tr><font size=3><td>	Confirme por favor o seu nome completo </td><td> <input style=width:350px type='text' name='nome' value='<? echo $nome ?>' /></td></tr>
<tr><font size=3><td>	Confirme também por favor o seu contacto preferencial:</td><td> <input style=width:350px type='text' name='contactopref' /></td></tr>
<tr><font size=3><td>	Confirme a sua morada completa: </td><td> <input style=width:350px type='text' name='morada' value='<? echo $morada ?>' /> </td></tr>
<tr><font size=3><td colspan=2>	
<br>
<font size=3>	Fica então agendado para esse dia e hora, irei contactá-lo/a nessa altura para revermos a nossa proposta.
	
	<br><br>
	Sr/Sra <? echo $nome; ?> agradecemos o tempo que nos dispensou.
	<br><br>
	Caso surja alguma questão não hesite em contactar-nos através do nº de apoio ao cliente 16990 ou do nosso site em www.zon.pt
	<br><br>
	Muito obrigado.
	<br><br>
</td></tr>
...
<div id=div_ni style='display:none;'>

<table width=95%>

<tr><td colspan=2>

<center><font size=3> -------- Cliente não Interessado ou Já cliente ZON -------- <br><br>
<tr>



<tr><td colspan=2>
<center><a href='#' onclick="javascript:Dnone('div_ni'); Dinline('div_cliente');" >Voltar</a>
</td></tr>
<tr>
<td colspan='2'>
	<br>
<font size=3>	Sr/Sra <? echo $nome; ?> agradecemos o tempo que nos dispensou.
	<br><br>
	<font size=3>Caso surja alguma questão não hesite em contactar-nos através do nº de apoio ao cliente 16990 ou do nosso site em www.zon.pt
	<br><br>
	<font size=3>Muito obrigado.
	<br>
...
<center><font size=3> -------- Fecho de Venda -------- <br><br>
</tr>



<tr><td colspan=2>
<center><a href='#' onclick="javascript:Dnone('div_venda'); Dinline('div_cliente');" >Voltar</a></td></tr>
<tr>


<td colspan='2'>
<br>
<font size=3>Em caso de venda começar por:
<ul>
	<li>Recapitular com o cliente o pacote a que está a aderir</li>
	<li>Informar eventuais aumentos de preço por fim de campanha</li>
	<li><b>Informar SEMPRE do prazo de fidelização (12 ou 24 meses)</b></li>
	<li>Indicar ao cliente que irá receber os documentos para a portabilidade</li>
	<li>Indicar ao cliente que deverá rescindir os serviços de TV+NET com o actual operador (caso se aplique)</li>
</ul>
<br>

<font size=3>Depois confirmar dados completos:
<ul>
	<li>Confirmar nome completo</li>
	<li>Confirmar morada completa</li>
	<li>Confirmar contactos telefónicos (portabilidade)</li>
	<li>Confirmar nº de BI</li>
	<li>Confirmar Nº de contribuinte</li>
</ul>
<br>
<font size=3>Efectuar agendamento com o cliente:<br>
<ul>
	<li>Agendar sempre para 48h ou 72h (n+2 ou n+3) e período manhã ou tarde</li>
	<li>Informar que irá ser contactado para confirmar a data de agendamento</li>
</ul>
<br>
<font size=3>Sr/Sra <? echo $nome; ?> agradecemos o tempo que nos dispensou.<br>
	<br>
	Caso surja alguma questão não hesite em contactar-nos através do nº de apoio ao cliente 16990 ou do nosso site em www.zon.pt <br>
	<br>
	Muito obrigado.
	<br>
...
<!-- DIV AREA   -->	  
      ...
      <p><label>Insira aqui os seus comentários</label></p>
       
          <textarea name="coment" id="coment" cols="80" rows="3" style="border:double"></textarea>
        
        <p><label>Histórico de comentários</label></p>
        <p><textarea name="coment_log" cols="80" rows="3" readonly="readonly" id="coment_log" style="border:double" ><?php echo $coment; ?></textarea></p>	  
      ...
      <div name='calldispo' id='calldispo' style='display:none; position:absolute; z-index:1000; top:600px; left:400px; width:600px; height:200px; background-color:#FFF; border:2px #000 solid;' >
      	<table align="center" width="500px">
        	<tr>
            	<td>Falei com:</td>
            	<td><select name="tcontacto" id='tcontacto'>
                	<option value='---'>---</option>
                	<option value='naocontacto'>Ninguém atendeu</option>
                    <option value="decisor">Pessoa decisora</option>
                    <option value="terceiro">Outra pessoa</option>
                
                </select>                
                </tr>
        	<tr>
        	  <td>Resultado:</td>
        	  <td><select name='resultado' id='resultado'>
        	    <option value='---'>---</option>
        	    <option value='recusa'>Recusou</option>
        	    <option value='callback'>Marquei Call-Back</option>
        	...
        	<tr>
            	...
            	<td>
            	  <select name='mrecusa' id='mrecusa'>
            	    <option value='---'>---</option>
  <option value='2ª Habitação'>2ª Habitação</option>
  <option value='Cliente Estrangeiro'>Cliente Estrangeiro</option>
  <option value='É caro'>É caro</option>
  <option value='Falta confiança no serviço'>Falta confiança no serviço</option>
  <option value='Insatisfação com a Zon'>Insatisfação com a Zon</option>
  <option value='Interesse para mais tarde'>Interesse para mais tarde</option>
  <option value='Já tem CLIX/OPTIMUS'>Já tem CLIX/OPTIMUS</option>
  <option value='Já tem MEO'>Já tem MEO</option>
  <option value='Já tem outros'>Já tem outros</option>
  <option value='Já tem PT'>Já tem PT</option>
  <option value='Já tem ZON 1P recusa mudar'>Já tem ZON 1P recusa mudar</option>
  <option value='Já tem ZON 2P recusa mudar'>Já tem ZON 2P recusa mudar</option>
  <option value='Já tem ZON 3P'>Já tem ZON 3P</option>
  <option value='Já tem ZON,  sem PC'>Já tem ZON,  sem PC</option>
  <option value='Melhor oferta de outro operador'>Melhor oferta de outro operador</option>
  <option value='Não quer Telemarketing'>Não quer Telemarketing</option>
  <option value='Não usa telefone fixo'>Não usa telefone fixo</option>
  <option value='NS/NR'>Não sabe/Não responde</option>
  <option value='Tem fidelização com outro operador'>Tem fidelização com outro operador</option>
            	    
            	    </select>
          	  </td>
                </tr>
             <tr>
             <td>Cliente aderiu a (apenas novos serviços):</td><td><select name='venda' id='venda'>
             	<option value='---'>---</option>
             	<option  value='tlf'>Telefone</option>
                <option value='tv, tlf'>TV + VOZ</option>
                <option value='tv, net, voz'>3Play</option>
                <option value='net, voz'>Net + Voz</option>
                <option value='tv'>Só TV</option>
                <option value='tv, net'>TV + Net</option>
             </select>
        	...
        	<tr>
        	  <td colspan="2" align="center"><br />
                ...
                <input type="submit" value='Submeter' name='submit' onclick="return validachamada();" /> 
        	    <br />
        	    <br />
        	         	    </td>
        	  </tr>
   ...
   <!--<tr>   <td align="center">Actual Operador</td>
 ...
 <!--   <tr>
  ...
  <tr>
      <td colspan="5" align="center"><input type="button" name="Submeter" id="Submeter" value="Submeter" onclick='showdispo();' />&nbsp;&nbsp;
