...
echo "<br><FONT style='font-family: Verdana, Helvetica, sans-serif; font-size: 12px;' COLOR=BLACK>&nbsp;&nbsp;&nbsp;Your system is now shuting down...<br />\n";
exec('/usr/share/goautodial/goautodialc.pl "/usr/bin/poweroff"');
exit;	
?> 