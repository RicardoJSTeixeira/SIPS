 ...
 if (preg_match("/\brunning\b/i", $startme))
	 
		{
			echo "<img style='border-style:none; border-width:0px;'  width=15px  src='images/g_status_ok.png'>";
	  		echo "&nbsp;<FONT FACE='VERDANA' COLOR=BLACK SIZE=2><b>ASTERISK Telephony is currently <FONT FACE='VERDANA' COLOR=GREEN SIZE=2><B>RUNNING</B></font>!</font>";
  		}
 		else
		{
			echo "<img style='border-style:none; border-width:0px;'  width=15px  src='images/g_status_no.png'>";
	  		echo "&nbsp;<FONT FACE='VERDANA' COLOR=BLACK SIZE=2><b>ASTERISK Telephony is currently not <FONT FACE='VERDANA' COLOR=RED SIZE=2><B>RUNNING</B></font>!</font>";
  		}
?>
</div>
</body> 
