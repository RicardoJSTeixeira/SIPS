...
<body>
<form action="myedit2.php" name="editacolab" id="editacolab" method="post" target="_self" >
...
<td width="600" height="80">
  <table width="600" align="center">
    ...
    <tr align="center">
      <td colspan="4" align="center"><label class="header">Dados Pessoais<br />
        (se aparecer tudo vazio não faças nada!)
      </label><hr />
