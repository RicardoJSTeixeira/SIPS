...
function loadintoIframe(iframeid, url, rtype){
	document.getElementById("span_loader").innerHTML = '<img src="ajaxlib/preloader.gif" ><span style="font-family: Helvetica; color: #4f6b72; font-size: 12px;">A Carregar</span>';	
	var rrt  = rtype;
	if (rrt == 'arg_ast_rel'){}	
	if (rrt == 'arg_ast_res'){}		
	if (rrt == 'arg_ast_sta'){}	
