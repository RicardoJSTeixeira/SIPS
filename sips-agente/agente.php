                            ...
                            <div class="row-fluid height100">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <ul>
                                                            ...
                                                            <li><a tabindex="-1" href="#" onclick="mpass(user);return false;"><i class="icon-key"></i>Alterar Password</a></li>
                                                            <li><a tabindex="-1" href="#" onclick="NormalLogout();return false;"><i class="icon-signout"></i>Logout</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="span7 height100">
                                    <div id="NoneInSessionBox" class="alert alert-block alert-error">
                                        ...
                                        <p>
                                            <a class="btn btn-danger" href="#" onClick="NoneInSessionCalL();return false;" >Voltar a fazer ligação</a>
                                            <a class="btn" href="#" onClick="NoneInSessionOK();return false;">Ignorar</a>
                                        </p>
                                    </div>
                                    ...
                                    <div class="alert alert-block alert-error" id="AgenTDisablEBoX">
                                        ...
                                        <p>
                                            <a href="#" class="btn btn-danger" onClick="LogouT('DISABLED');return false;">Logout</a>
                                            <a href="#" class="btn" onClick="hideDiv('AgenTDisablEBoX');return false;">Voltar</a>
                                        </p>
                                    </div>
                        ...
                        <span style="position:absolute; left:0px; top:50px; z-index:<?= ++$zi ?>; width:1200px; display:none;" valign="center" id="MaiNfooterspan">
                            ...
                            <table id="MaiNfooter" >
                                <TR>
                                    ...
                                    <td>
                                        <span id="MDstatusSpan">
                                            <a href="#" class="btn" onClick="NeWManuaLDiaLCalL('NO');return false;">Fazer Chamada Manual</a>
                                        </span>
                                        <a href="#" class="btn" onClick="NeWManuaLDiaLCalL('FAST');return false;"></a>
                                        <br />
                                            
                                        <span style="z-index:1000;" id="CallLogButtons">
                                            <span id="CallLogLinkSpan">
                                                <a href="#" class="btn" onClick="VieWCalLLoG();return false;">Ver o log de chamadas</a>
                                            </span>
                                        </span>
                                        ...
                                        <span style="z-index:<?= ++$zi ?>;" id="AgentViewLinkSpan">
                                            ...
                                            <span id="AgentViewLink">
                                                <a href="#" class="btn" onClick="AgentsViewOpen('AgentViewSpan', 'open');return false;">Ver colegas +</a>
                                            </span>
                                        </span>
                                        ...
                                        <span id="RecorDControl" style="display:none">
                                            <a href="#" class="btn" onClick="conf_send_recording('MonitorConf', session_id, '');return false;">
                                ...
                                <tr>
                                    <td align="right">
                                        <span id="webphoneLink">
                                            <a href="#" onClick="webphoneOpen('webphoneSpan', 'close');return false;">Ver Webphone -</a>
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <span style="display:none"><span id="HangupBothLines"><a href="#" onClick="bothcall_send_hangup();return false;"><img src="./images/vdc_XB_hangupbothlines.gif" border="0" alt="Hangup Both Lines" style="vertical-align:middle" /></a></span></span>
                                        </td>
                                    </tr>
    ...
    <?php } ?>
                                        ...
                                        <td align="left" style="height: 36px; width: 180px;">
                                            <span style="display:none;float:left;" id="Leave3WayCall">
                                                <a href="#" onClick="leave_3way_call('FIRST');return false;"><img src="/images/icons/telephone_go_32.png" border="0" alt="LEAVE 3-WAY CALL" style="vertical-align:middle" />Tranferir a Chamada</a>
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 36px; width: 180px;">
                                            ...
                                            <span style="float:left;" id="ParkCustomerDial">
                                                <a href="#" onClick="xfer_park_dial();return false;"><img src="/images/icons/telephone_add_32.png" alt="Park Customer Dial" style="vertical-align:middle" />Solicitar Transferência</a>
                                            </span>
...
if ($enable_xfer_presets == 'ENABLED') {
    ?>
                                                <span style="background-color: <?= $MAIN_COLOR ?>" id="PresetPullDown">
                                                    <a href="#" onClick="generate_presets_pulldown();return false;"><img src="./images/vdc_XB_presetsbutton.gif" border="0" alt="Presets Button" style="vertical-align:middle" /></a>
                                                </span>
                            <?php
                        } else {
                            ?>
                    ...
                    <span style="position:absolute;left:5px;top:0px;z-index:<?= ++$zi?>;" id="EAcommentsBox">
                        <table>
                            <tr bgcolor="#FFFF66">
                                ...
                                <td align="right"> <a href="#" onClick="EAcommentsBoxhide('YES');return false;"> minimize </a></td>
                            </tr>
                            <tr>
                                <td valign="top">
                    ...
                    <span style="position:absolute;left:695px;top:0px;z-index:<?= ++$zi?>;" id="EAcommentsMinBox">
                        <table border="0" bgcolor="#FFFFCC" width="40px" height="20px">
                            <tr bgcolor="#FFFF66">
                                <td align="left">
                                    <a href="#" onClick="EAcommentsBoxshow();return false;"> maximize </a> <br />Alt Phone Info
                                </td>
                            </tr>
                        </table>
                    </span>
                                    ...
                                    <td colspan="2">
                                        <span class="left"> 
                                            <span class="input-append">
                                                ...
                                                <a  href="#" onClick="NeWManuaLDiaLCalLSubmiT('PREVIEW');return false;" class="btn btn-primary">Marcar</a>
                                            </span>
...
?>
                    ...
                    <span style="position:absolute;left:0px;top:0px;z-index:<?= ++$zi?>;" id="CalLLoGDisplaYBox">
                        <table>
                            <tr>
                                <td align="center" valign="top">AGENT CALL LOG:<a href="#" onClick="CalLLoGVieWClose();return false;">close [X]</a>
                                    <br />
                    ...
                    <span style="position:absolute;left:0px;top:0px;z-index:<?= ++$zi?>;" id="CalLNotesDisplaYBox">
                        <table>
                            <tr>
                                <td align="center" valign="top">CALL NOTES LOG:<a href="#" onClick="hideDiv('CalLNotesDisplaYBox');return false;">close [X]</a><br />
                        ...
                        <table>
                            <tr>
                                <td> Alerta :<br />
                                    ...
                                    <br/>
                                    <br/>
                                    <a href="#" onClick="hideDiv('blind_monitor_alert_span');return false;">Voltar</a>
                                </td>
                            </tr>
                        </table>
                    </span>
                    ...
                    <form name="inert_form" id="inert_form" onSubmit="return false;">
                        ...
                        <div style="margin-left:-200px;z-index:<?= ++$zi?>;" id="AlertBox" class="grid-agent" >
