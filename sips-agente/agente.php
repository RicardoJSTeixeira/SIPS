...
<script type="text/javascript" src="js/agente.js?v=1.002"></script>
<script type="text/javascript" src="/ini/SeamlessLoop.js"></script>
...
?>
    ...
    var agent_allow_copy_record=!!<?=$agent_allow_copy_record?>
</script>
                ...
                <div class="span3" id="toolbox">
                    ...
                    <div class="grid">
                        ...
                        <table class="table table-condensed" id="statsTimer">
                            ...
                            <tr  <?= ($agent_allow_copy_record=="1") ? "" : "style='display:none'" ?>>
                                <th>Url Gravação</th>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul>
                                            ...
                                            <li><a tabindex="-1" href="#"  id="getPausas"><i class="icon-refresh"></i>Actualizar</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
