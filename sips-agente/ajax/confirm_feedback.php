...
switch ($action) {
    ...
    case "validate_call":
        $query = "INSERT INTO `crm_confirm_feedback`(`id`, `lead_id`, `feedback`, `sale`, `campaign`, `agent`, `comment`,date,admin) VALUES (NULL,$lead_id,'SP',1,'$campaign','$user','$comment','" . date('Y-m-d H:i:s') . "','NULL')";
        $query = mysql_query($query, $link) or die(mysql_error());
