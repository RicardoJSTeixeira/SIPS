...
#####################################################################		
            if ($VDloginDISPLAY && ($no_campaign == 1)) {
                ...
                if ($row['cloud'] == 1) {
                    ...
                    $sips_validate = mysql_fetch_assoc($query);
                    $data_validade = $sips_validate['validade'];
...
// Insert the new manual dial as a lead and go to manual dial screen
                ...
                function NeWManuaLDiaLCalLSubmiT(tempDiaLnow)
                {
                    ...
                    if (!$.isNumeric(mdphonenumber)) {
                        alert_box('Insira um nº de telefone válido');
                        return false;
                    }
                    //clearInterval(cm_timer);
                    //$('#timeoutcm').html('25');
...
// Send the Manual Dial Only - dial the previewed lead
                function ManualDialOnly(taskaltnum)
                {
                    ...
                    {
                        var manDiaLonly_num = document.vicidial_form.alt_phone.value;
                        if (!$.isNumeric(document.vicidial_form.alt_phone.value)) {
                            alert_box("Telefone Alternativo não é um nº de telefone válido.");
                            in_lead_preview_state = 1;
                            return false;
                        }
                        lead_dial_number = document.vicidial_form.alt_phone.value;
                    ...
                    else
                    {
                        ...
                        {
                            var manDiaLonly_num = document.vicidial_form.address3.value;
                            if (!$.isNumeric(document.vicidial_form.address3.value)) {
                                alert_box("Telefone Alternativo não é um nº de telefone válido.");
                                in_lead_preview_state = 1;
                                return false;
                            }
...
// open web form, then submit disposition
                function WeBForMDispoSelect_submit()
                {
                    ...
                    if (DispoChoice.length < 1) {
                        alert_box("Tem que seleccionar um resultado!!");
                    }
                    else
                    {
...
// Show message that there are no voice channels in the VICIDIAL session
                ...
                {
                    if ($("#NoneInSessionBox").css("visibility") === "hidden") {
                        loop_warning.start("disconnected");
                    }
...
// Refresh the FORM content
                function FormContentsLoad()
                {
                    ...
                    if (limesurvey_enabled === 1) {
                        document.getElementById('vcFormIFrame').src = TEMP_VDIC_web_form_address;
                    } else {
...
// Submitting the callback date and time to the system
                function CallBackDatE_submit()
                {
                    ...
                    else
                    {
                        ...
                        if ($("input[name='tipo_callback']:checked").attr("id") == "cb_pessoal") {
...
<?php if (($HK_statuses_camp > 0) && ( ($user_level >= $HKuser_level) or ($VU_hotkeys_active > 0) )) {
    echo "document.onkeypress = hotkeypress;\n";
            ...
            function start_all_refresh()
            {
                ...
                else
                {
                    ...
                    if ((custchannellive < -30) && (lastcustchannel.length > 3) && (no_empty_session_warnings < 1)) {
                        CustomerChanneLGone();
                    }
                    ...
                    if ((nochannelinsession > 16) && (check_n > 15) && (no_empty_session_warnings < 1)) {
                        NoneInSession();/*console.log("12005");*/
                    }
    ...
    <script>
            ...
            $("#CallHistoryStart").live("click", function() {
                ...
                oTable_CallHistory = $('#table-CallHistory').dataTable({
                    ...
                    "fnDrawCallback": function(oSettings, json) {
                        $('#table-CallHistory').css({"width": "100%"});
                    },
                    "fnPreDrawCallback": function(oSettings) {
                        if ($("#table-CallHistory-title").length == 0) {
            ...
            $(document).ready(function() {
                ...
                $("#change-lostcalls").button().click(function() {
                    $("#table-CallHistory-title").html("Chamadas Perdidas");
                    CallHistoryMode = "lostcalls";
                    oTable_CallHistory.fnReloadAjax();
                });
                $("#change-manual").button().click(function() {
                    $("#table-CallHistory-title").html("Chamadas Manuais");
                    CallHistoryMode = "manual";
                    oTable_CallHistory.fnReloadAjax();
                    CallHistoryMode = "lostcalls";
                });
                $("#change-outbound").button().click(function() {
                    $("#table-CallHistory-title").html("Outbound");
                    CallHistoryMode = "outbound";
                    oTable_CallHistory.fnReloadAjax();
                    CallHistoryMode = "lostcalls";
                });
                $("#change-inbound").button().click(function() {
                    $("#table-CallHistory-title").html("Inbound");
...
?>
    <body onLoad="begin_all_refresh();
                        SetFrameHeight();"  onunload="BrowserCloseLogout();" id="ib">
                            ...
                            <td width=425px align=right>
                                <table border=0>
                                    <tr>
                                        ...
                                        <td>
                                            <span style="cursor: pointer;" onClick="NormalLogout();
                                                        return false;" ><img src='/images/icons/door_in.png' style="vertical-align: middle" /> Logout  </span>
                                        </td> 
                                ...
                                <tr>
                                    <td valign="top" align="left" style='width:255px'>
                                        ...
                                        <div class='cc-submenu' style="display:block;">
                                            <table border="0">
                                                <tr id="DiaLControl" <? if ($dial_method != "INBOUND_MAN") {
    echo "style='display:none'";
                                                ...
                                                <div class="text_input" id="SendDTMFdiv">
                                                    ...
                                                    <td colspan="1" align="left">
                                                        ...
                                                        <span  id="SendDTMF">
                                                            <a href="#" onClick="SendConfDTMF(session_id);
                                                                        return false;">
                                                                Enviar Opção IVR
                                                            </a> &nbsp; &nbsp; &nbsp; 
                                                ...
                                                <tr onClick="AutoDial_ReSume_PauSe('VDADpause');
                                                            redial();" style='cursor:pointer'>
                                                ...
                                                <tr id='mdial' onClick="AutoDial_ReSume_PauSe('VDADpause');
                                                            NeWManuaLDiaLCalL('NO');
                                                            return false;" style='cursor:pointer'>
                                                    <td height='35px'><img src='/images/icons/phone_add.png' /></td>
                                                    <td height='35px'>
                                                        <span id="MDstatusSpan"><a href="#" >Chamada Manual</a></span> &nbsp; &nbsp; &nbsp; <a href="#" onClick="NeWManuaLDiaLCalL('FAST');
                                                                    return false;"></a><br />
                                                        </span>
                                                    </td>
                                                </tr>
...
<?php /* $query="SELECT id_calendar,cal_type FROM `sips_sd_agent_ref` WHERE user='$user'";
  ...
  <?php } */ ?>
                                                    ...
                                                    <tr id='iconf' style='cursor:pointer' onclick="NoneInSessionCalL();
                                                                return false;">
                                    ...
                                    <td valign=top>
                                        ...
                                        <table style='border-collapse:collapse; width:90%; margin-left:auto; margin-right:auto;'>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class=cc-mstyle onClick="Dinline('MainPanel');
                                                                Dnone('FormPanel');
                                                                Dnone('sips-crm');" style='cursor:pointer; width:100%; float:left;'> 
                                                        <table> 
                                                            <tr>
                                                ...
                                                <td>
                                                    <div class=cc-mstyle onClick="Dinline('FormPanel');
                                                                Dnone('MainPanel');
                                                                Dnone('sips-crm')" style='cursor:pointer; width:60%; '> 
                                                        <table> 
                                                            <tr>
                                                ...
                                                <td>
                                                    <div class=cc-mstyle onClick="Dnone('MainPanel');
                                                                Dnone('FormPanel');
                                                                Dinline('sips-crm');" style='cursor:pointer; width:60%; display:none; float:right;'> 
                                                        <table> 
                                                            <tr>
                                        ...
                                        <div id="work-area">
                                            ...
                                            <span id="sips-crm" style='display:none'>
                                                ...
                                                <div id="last-outbound-table-container" style='display:none;'>
                                                    ...
                                                    <br>
                                                    <img onClick="Dnone('last-outbound-table-container');
                                                                Dinline('crm-options');
                                                                " class="elem-pointer" src="/images/icons/resultset_previous_32.png"><span class="elem-pointer" onClick="Dnone('last-outbound-table-container');
                                                                            Dinline('crm-options');">Voltar ao Menu</span>
                                                </div>
                                            ...
                                            <script>
                                                    ...
                                                    $(".link-1").click(function() {
                                                        ...
                                                        var oTable = $('#last-outbound-table').dataTable({
                                                            ...
                                                            "fnDrawCallback": function(oSettings, json) {
                                                                $('#last-outbound-table-container').show();
                                                                $('#last-outbound-table').css({"width": "100%"})
                                                            },
                                                            "oLanguage": {"sUrl": "../../jquery/jsdatatable/language/pt-pt.txt"}
                                                        });
                                                                            ...
                                                                            <span style="z-index:1001; border:none;" class="form_settings" id="CBcommentsBox">
                                                                                <table style='border:1px solid #c0c0c0;width:100%' >
                                                                                    <tr style='border:1px solid #c0c0c0;'>
                                                                                        ...
                                                                                        <td align="right"> <a href="#" onClick="CBcommentsBoxhide();
                                                                                                    return false;" style='text-decoration:underline; font-weight:bold; font-size:14px;'>Fechar</a></td>
                                                                                    </tr>
                                                                                    <tr style='border:1px solid #c0c0c0;'>
...
echo $zi ?>;" id="WelcomeBoxA">
                        ...
                        <span style="display:none;position:absolute;left:0px;top:<?php echo $DBheight ?>px;z-index:<?php $zi++;
echo $zi ?>;" id="debugbottomspan">
                        ...
                        <span style="position:absolute;left:3px;top:380px;z-index:1000; width:1200px; " id="ManuaLDiaLButtons"  valign="center">
                            ...
                            <span style="position:absolute; left:0px; top:50px; z-index:<?php $zi++;
echo $zi ?>; width:1200px; display:none;" valign="center" id="MaiNfooterspan" class='form_settings'>
...
<?php echo "<a href='#'><img src=\"./images/logout.gif\" border=\"0\" alt=\"Logout\" onclick=\"NormalLogout();return false;\" /></a>\n"; ?>
                                        ...
                                        <td align="left" width=20%>
                                            <span id="MDstatusSpan"><a href="#" onClick="AutoDial_ReSume_PauSe('VDADpause');
                                                        NeWManuaLDiaLCalL('NO');
                                                        return false;">Fazer Chamada Manual</a></span> &nbsp; &nbsp; &nbsp; <a href="#" onClick="NeWManuaLDiaLCalL('FAST');
                                                                    return false;"></a><br />
                                            </span>
                                            <span style="z-index:1000;" align="center" id="PauseCodeButtons">
                                                ...
                                                <span style="z-index:1000;" id="CallLogButtons">
                                                    <span id="CallLogLinkSpan"><a href="#" onClick="VieWCalLLoG();
                                                                return false;">Ver o log de chamadas</a></span>
                                                </span>
                                                <div>
                                                    <span style="z-index:<?php $zi++;
echo $zi ?>; " id="CallbacksButtons">
...
echo $zi ?>;" id="AgentViewLinkSpan">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <span id="AgentViewLink">
                                                                    <a href="#" onClick="AgentsViewOpen('AgentViewSpan', 'open');
                                                                                return false;">Ver colegas +
                                                                    </a>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                ...
                                                <span id="RecorDControl" style="display:none">
                                                    <a href="#" onClick="conf_send_recording('MonitorConf', session_id, '');
                                                                return false;">
                                        ...
                                        <td width=20%>
                                            ...
                                            <!-- CONTROLO DE VOLUME -->
                                            <span style="z-index:<?php $zi++;
echo $zi ?>;" id="AgentMuteSpan" ></span><br><br>
                                            <span style="z-index:<?php $zi++;
echo $zi ?>;" id="VolumeControlSpan" >
                                            ...
                                            <span style="z-index:<?php $zi++;
echo $zi ?>;" id="SecondSspan">Duração da Chamada: 
...
<?php if (($HK_statuses_camp > 0) && ( ($user_level >= $HKuser_level) or ($VU_hotkeys_active > 0) )) { ?>
                                <span style="position:absolute;left:<?php echo $HKwidth - 190 ?>px;top:<?php echo $HKheight - 45 ?>px;z-index:<?php $zi++;
    echo $zi ?>;" id="hotkeysdisplay"><a href="#" onMouseOver="HotKeys('ON')"><img src="./images/vdc_XB_hotkeysactive_OFF.gif" border="0" alt="HOT KEYS INACTIVE" /></a></span>
<?php } ?>
...
echo $zi ?>;" id="AgentStatusSpan"><font class="body_text">
                        ...
                        <span style="position:absolute;left:<?php echo $PDwidth - 55 ?>px;top:<?php echo $AMheight + 42 ?>px;z-index:<?php $zi++;
...
?>
                        ...
                        <span style="display:none; position:absolute;left:0px;top:<?php echo $CQheight ?>px;width:<?php echo $MNwidth ?>px;overflow:scroll;z-index:<?php $zi++;
echo $zi ?>;background-color:<?php echo $SIDEBAR_COLOR ?>;" id="callsinqueuedisplay"></span>
                        ...
                        <font class="body_small"><span style="display:none;position:absolute;left:<?php echo $CLwidth ?>px;top:<?php echo $QLheight ?>px;z-index:<?php $zi++;
...
if ($is_webphone == 'Y') {
    ...
    echo $zi ?>;" id="webphoneLinkSpan"><table cellpadding="0" cellspacing="0" border="0" width="120px"><tr><td align="right"><font class="body_small"><span id="webphoneLink"> &nbsp; <a href="#" onClick="webphoneOpen('webphoneSpan', 'close');
                                        return false;">Ver Webphone -</a></span></font></td></tr></table></span>
...
?>
                        ...
                        <span style="display:none;position:absolute;left:200px;top:<?php echo $SFheight ?>px;z-index:<?php $zi++;
...
?>
                        ...
                        <span style="position:absolute;left:<?php echo $AMwidth + 20 ?>px;top:<?php echo $SRheight ?>px;z-index:<?php $zi++;
...
echo $zi ?>;" id="FormRefresH">
                        ...
                        <div class="cc-mstyle" style="position:fixed;width:500px;height:200px;margin-left:-250px;margin-top:-100px;left:50%;top:50%;z-index:<?php $zi++;
                                        ...
                                        <span class="text_input" id="TransferMaindiv">
                                            ...
                                            <table cellpadding="0" cellspacing="1" border="0">
                                                <tr>
                                                    <td align="left" colspan="3">
                                                        <span  style="display:none">
                                                            <span id="XfeRGrouPLisT"><select size="1" name="XfeRGrouP" id="XfeRGrouP" class="cust_form" onChange="XferAgentSelectLink();
                                                                        return false;"><option>-- SELECT A GROUP TO SEND YOUR CALL TO --</option></select></span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <span style="display:none"><span style="background-color: <?php echo $MAIN_COLOR ?>" id="HangupBothLines"><a href="#" onClick="bothcall_send_hangup();
...
?>
                                                    ...
                                                    <td align="left" style="height: 36px; width: 180px;">
                                                        <span style="display:none;float:left;color: rgb(0, 0, 0);padding: 0px;text-decoration: none;font-size: 16px;" id="Leave3WayCall"><a href="#" onClick="leave_3way_call('FIRST');
                                                                    return false;"><img src="/images/icons/telephone_go_32.png" border="0" alt="LEAVE 3-WAY CALL" style="vertical-align:middle" />Tranferir a Chamada</a></span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 36px; width: 180px;">
                                                        <span style="display:none">
                                                            ...
                                                            <span style="background-color: <?php echo $MAIN_COLOR ?>" id="DialWithCustomer"><a href="#" onClick="SendManualDial('YES');
                                                                        return false;"><img src="./images/vdc_XB_dialwithcustomer.gif" border="0" alt="Dial With Customer" style="vertical-align:middle" /></a></span>
                                                        </span>
                                                        <span style="float:left;color: rgb(0, 0, 0);padding: 0px;text-decoration: none;font-size: 16px;" id="ParkCustomerDial"><a href="#" onClick="xfer_park_dial();
                                                                    return false;"><img src="/images/icons/telephone_add_32.png" alt="Park Customer Dial" style="vertical-align:middle" />Solicitar Transferência</a></span>

<?php
if ($enable_xfer_presets == 'ENABLED') {
    ?>
                                                            <span style="background-color: <?php echo $MAIN_COLOR ?>" id="PresetPullDown"><a href="#" onClick="generate_presets_pulldown();
                                                                        return false;"><img src="./images/vdc_XB_presetsbutton.gif" border="0" alt="Presets Button" style="vertical-align:middle" /></a></span>
    <?php
} else {
    ?>
                                                            <span style="display: none;">
...
echo $zi ?>;" id="HotKeyActionBox">
                        ...
                        <span style="position:absolute;left:<?php echo $MNwidth - 200 ?>px;top:80px;z-index:<?php $zi++;
...
echo $zi ?>;" id="EAcommentsBox">
                            <table border="0" bgcolor="#FFFFCC" width="<?php echo $HCwidth ?>px" height="70px">
                                <tr bgcolor="#FFFF66">
                                    ...
                                    <td align="right"><font class="sk_text"> <a href="#" onClick="EAcommentsBoxhide('YES');
                                                return false;"> minimize </a> </font></td>
                                </tr><tr>
                                    <td valign="top"><font class="sk_text">
                        ...
                        <span style="position:absolute;left:695px;top:<?php echo $HTheight ?>px;z-iestabelendex:<?php $zi++;
echo $zi ?>;" id="EAcommentsMinBox">
                            <table border="0" bgcolor="#FFFFCC" width="40px" height="20px">
                                <tr bgcolor="#FFFF66">
                                    <td align="left"><font class="sk_text"><a href="#" onClick="EAcommentsBoxshow();
                                                return false;"> maximize </a> <br />Alt Phone Info</font></td>
                                </tr></table>
                        </span>
                        ...
                        <span style="position:fixed;left:0;top:0;z-index:1010;width:100%; height:100%;border-radius:0;" id="NoneInSessionBox" class="cc-mstyle" >
                            <table  width="1000px" height="600px" style=margin:auto><tr><td align="center" width="1000px"> Não foi possível estabelecer a ligação. <span id="NoneInSessionID"></span><br />
                                        <a href="#" onClick="NoneInSessionOK();
                                                    return false;">Ignorar</a>
                                        <br /><br />
                                        <span id="NoneInSessionLink"><a href="#" onClick="NoneInSessionCalL();
                                                    return false;">Voltar a fazer ligação</a></span>
                                    </td></tr></table>


                            <span class=form_settings style="padding:10px;position:fixed;left:0px;top:0px;height:100%;width:100%;z-index:<?php $zi++;
echo $zi ?>;" id="CustomerGoneBox">
                                <table border="0" bgcolor="#FFFFFF" width="100%" height="100%"><tr><td align="center" style="margin:auto;"> O Cliente desligou: <span id="CustomerGoneChanneL"></span><br />
                                            ...
                                            <a href="#" onClick="CustomerGoneHangup();
...
echo $zi ?>;" id="WrapupBox">
                            ...
                            <span style="border-radius:0;width:20%;height:25%;position:absolute;left:40%;top:38.5%;z-index:<?php $zi++;
echo $zi ?>;" id="TimerSpan" class='cc-mstyle'>
                                <table border="0" width="400px" height="200px"><tr><td align="center">
                                            <br /><span id="TimerContentSpan"></span><br /><br />
                                            <a href="#" onClick="hideDiv('TimerSpan');
                                                        return false;">Fechar Aviso</a> 
                                        </td></tr></table>
                            </span>

                            <div class=cc-mstyle style="border-radius:0;width:100%;height:100%;position:absolute;left:0;top:0;z-index:<?php $zi++;
echo $zi ?>;" id="AgenTDisablEBoX">
                                <table style="margin:auto;width:90%;height:90%;"  border="0" bgcolor="#FFFFFF" ><tr><td align="center">A sua sessão foi terminada.<br /><a href="#" onClick="LogouT('DISABLED');
                                            return false;">Logout</a><br /><br /><a href="#" onClick="hideDiv('AgenTDisablEBoX');
                                                        return false;">Voltar</a>
                                        </td></tr></table>
                            </div>
...
echo $zi ?>;" id="SysteMDisablEBoX">
                                <table border="0" bgcolor="#FFFFFF" width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center">Existe um problema de sincronização com o servidor, avise o administrador de sistemas.<br /><br /><br /><a href="#" onClick="hideDiv('SysteMDisablEBoX');
                                            return false;">Voltar</a>
                                        </td></tr></table>
                            </span>
...
echo $zi ?>;" id="DispoButtonHideC">
                            ...
                            <span style="overflow-y:auto; position:fixed;right:5%;top:5%;z-index:<?php $zi++;
echo $zi ?>; width:300px; height:550px;" class='popup_form' id="DispoSelectBox">
                                <br>
...
?>
                                            ...
                                            <div style='display:none'><input type="checkbox" name="DispoSelectStop" id="DispoSelectStop" size="1" value="0" /><label style="display:inline" for="DispoSelectStop">Pausa após terminar esta chamada</label><br />
                                                <a href="#" onClick="DispoSelectContent_create('', 'ReSET');
                                                            return false;">Limpar</a> | 
                                                <a href="#" onClick="DispoSelect_submit();
                                                            return false;">Escolher</a>
                                                <br /><br />
                                                <a href="#" onClick="WeBForMDispoSelect_submit();
                                                            return false;"></a>
                                                <br /><br /> &nbsp;</div>
                                        </td></tr></table>
                                <br>
                            ...
                            <div class=cc-mstyle style="position:fixed;left:50%;top:50%;z-index:1001;  height:610px; width:1000px; margin-left: -500px; margin-top: -305px;" class="popup_form" id="CallBacKsLisTBox" >
                                ...
                                <table style="width:95%;height:5%;table-layout:fixed;margin:10px auto;" >
                                    <tr>
                                        ...
                                        <td>
                                            <img style="float:right;cursor:pointer;" onclick="/*clearInterval(cb_timer);*/
                                                        CalLBacKsLisTClose();
                                                        /*cb_timer = undefined;*/" src="../images/icons/cross_32.png">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <span onClick="/*clearInterval(cb_timer);*/
                                                        CalLBacKsLisTCheck();
                                                        /*cb_timer = undefined;*/
                                                        return false;" style="cursor: pointer;">
...
?>
                                                    ...
                                                    <span class="popup_form" style="margin-left:-250px;margin-top:-115px;height:230px;width:500px;position:fixed;left:50%;top:50%;z-index:<?php $zi++;
                                                        ...
                                                        <table style="margin:10px auto;width:95%">
                                                            <tr>
                                                                <td colspan="3"><img src="/images/icons/telephone_go_32.png" style="float:left">
                                                                    ...
                                                                    <img src="/images/icons/cross_32.png" onClick="/*clearInterval(cm_timer);
                                                                                $('#timeoutcm').html('25');*/
                                                                                AutoDial_ReSume_PauSe('VDADpause');
                                                                                ManualDialHide();
                                                                                /*cm_timer = undefined;*/" style="float:right;cursor:pointer;">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" colspan="2">
                                                                    <a  href="#" onClick="NeWManuaLDiaLCalLSubmiT('PREVIEW');
                                                                                return false;" style="float:left">Marcar</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </span>

                                                    <span class="cc-mstyle" style="position: fixed;box-shadow: 0px 0px 120px 10000px rgba(0, 0, 0, 0.5); left: 50%; top: 50%;margin-left:-175px;margin-top:-250px; width: 350px;height:500px; z-index:<?php $zi++;
...
echo $zi ?>;" id="CalLLoGDisplaYBox">
                                                        <table border="0" width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center" valign="top"> &nbsp; &nbsp; &nbsp; AGENT CALL LOG: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="#" onClick="CalLLoGVieWClose();
...
?>
                                                    ...
                                                    <div class='cc-mstyle' style="padding:0 10px;margin-left:-300px;margin-top:-125px;width:600px;height:250px;position:fixed;left:50%;top:50%;z-index:<?php $zi++;
echo $zi ?>;" id="SearcHForMDisplaYBox">
                                                        <table style="width:95%;height:5%;margin-top:16px">
                                                            <tr>
                                                                <td id='icon32'><img src='/images/icons/zoom_32.png' /></td><td id='submenu-title'> <b>Procura de Contactos</b> </td><td id="icon32"><img onClick="LeaDSearcHVieWClose();
                                                                            return false;" src="/images/icons/cross_32.png"<br />
<?php
if ($webphone_location == 'bar') {
    echo "<br /><img src=\"images/pixel.gif\" width=\"1px\" height=\"" . $webphone_height . "px\" /><br />\n";
}
...
<?php echo $search_opt; ?>
                                                        ...
                                                        <table>	
                                                            <tr>
                                                                <td style='text-align:right;'>
                                                                    <span onClick="LeadSearchSubmit();
                                                                                return false;" style='cursor:pointer;float:right;margin-right: 2%;' >
                                                    ...
                                                    <div class='cc-mstyle' style="padding:0 10px;margin-left:-310px;margin-top:-135px;width:600px;height:270px;position:fixed;left:50%;top:50%;visibility:hidden;z-index:<?php $zi++;
echo $zi ?>;" id="pesquisa_morada">
                                                        <table style="width:95%;height:5%;margin-top:16px">
                                                            <tr>
                                                                <td id='icon32'><img src='/images/icons/map_magnify_32.png' /></td><td id='submenu-title'> <b>Procura de Moradas</b> </td><td id="icon32"><img src="/images/icons/cross_32.png" onClick="hideDiv('pesquisa_morada');
                                                                            return false;"  style="cursor:pointer;"><br />
...
<!-- <div class='cc-mstyle' style="min-width:600px;min-height:500px;position:absolute;left:350px;top:100px;z-index:<?php $zi++;
echo $zi ?>;" id="SearcHForMDisplaYBox">
...
<br> -->
                                                    ...
                                                    <div class='cc-mstyle' style="margin-left:-400px;margin-top:-250px;width:800px;height:500px;position:fixed;left:50%;top:50%;z-index:<?php $zi++;
echo $zi ?>;" id="SearcHResultSDisplaYBox">

                                                        <table style="width:95%;height:95%;margin-top:16px">
                                                            <tr>
                                                                <td id='icon32'><img src='/images/icons/zoom_32.png' /></td><td id='submenu-title'> <b>Resultado da Procura</b> </td><td id="icon32"><a href="#" onClick="hideDiv('SearcHResultSDisplaYBox');
                                                                            return false;"><img src="/images/icons/cross_32.png"</a></td>		
...
echo $zi ?>;" id="CalLNotesDisplaYBox">
                                                        <table border="0" width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center" valign="top"> &nbsp; &nbsp; &nbsp; CALL NOTES LOG: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="#" onClick="hideDiv('CalLNotesDisplaYBox');
                                                                    return false;">close [X]</a><br />
<?php
if ($webphone_location == 'bar') {
    echo "<br /><img src=\"images/pixel.gif\" width=\"1px\" height=\"" . $webphone_height . "px\" /><br />\n";
                                                        ...
                                                        <table >
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    ...
                                                                    <a href="#" onClick="hideDiv('LeaDInfOBox');
                                                                                return false;">Fechar</a>
                                                                </td></tr></table>
                                                    </span>
...
?>
                                                    ...
                                                    <span style="position:absolute;left:400px;top:80px;z-index:<?php $zi++;
echo $zi ?>; width:500px; height:200px;" id="blind_monitor_alert_span" class="popup_form">
                                                        <table border=0 width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px"><tr><td align="center" valign="top"> Alerta :<br />
                                                                    ...
                                                                    <br /><br /> <a href="#" onClick="hideDiv('blind_monitor_alert_span');
                                                                                return false;">Voltar</a>
                                                                </td></tr></table>
                                                    </span>
...
echo $zi ?>;" id="GENDERhideFORieALT"></span>
                                                    ...
                                                    <form name="alert_form" id="alert_form" onSubmit="return false;" >
                                                        ...
                                                        <span style="margin-left:-200px;margin-top:-100px;position:fixed;left:50%;top:50%;width:400px;height:200px;z-index:<?php $zi++;
echo $zi ?>;" id="AlertBox" class="popup_form" >
                                                            <br><br>
                                                                        ...
                                                                        <table border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td align="center" valign="top" colspan="2">
                                                                                    <button type="button" name="alert_button" id="alert_button" onClick="hideDiv('AlertBox');
