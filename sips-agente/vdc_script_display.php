...
if (isset($_GET["web_vars"]))			{$web_vars=$_GET["web_vars"];}
	...
	elseif (isset($_POST["extra11"]))	{$extra11=$_POST["extra12"];}
	
		if (isset($_GET["extra12"]))			{$extra12=$_GET["extra12"];}
	elseif (isset($_POST["extra12"]))	{$extra12=$_POST["extra12"];}
	
		if (isset($_GET["extra13"]))			{$extra1=$_GET["extra13"];}
	elseif (isset($_POST["extra13"]))	{$extra1=$_POST["extra13"];}
	
		if (isset($_GET["extra14"]))			{$extra1=$_GET["extra14"];}
	elseif (isset($_POST["extra14"]))	{$extra1=$_POST["extra14"];}

	if (isset($_GET["extra15"]))			{$extra1=$_GET["extra15"];}
	elseif (isset($_POST["extra15"]))	{$extra1=$_POST["extra15"];}
...
$script_text = eregi_replace('--A--extra1--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra2--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra4--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra5--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra6--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra7--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra8--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra9--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra10--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra11--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra12--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra13--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra14--B--',"$extra1",$script_text);
$script_text = eregi_replace('--A--extra15--B--',"$extra1",$script_text);
