...
if (isset($_GET["closer_choice"])) {
    $closer_choice = $_GET["closer_choice"];
} elseif (isset($_POST["closer_choice"])) {
    $closer_choice = $_POST["closer_choice"];
}
...
if (isset($_GET["campaign_cid"])) {
    $campaign_cid = $_GET["campaign_cid"];
} elseif (isset($_POST["campaign_cid"])) {
...
if (isset($_GET["length_in_sec"])) {
    $length_in_sec = $_GET["length_in_sec"];
} elseif (isset($_POST["length_in_sec"])) {
    $length_in_sec = $_POST["length_in_sec"];
}
...
if (isset($_GET["start_epoch"])) {
    $start_epoch = $_GET["start_epoch"];
} elseif (isset($_POST["start_epoch"])) {
    $start_epoch = $_POST["start_epoch"];
}
if (isset($_GET["dispo_choice"])) {
    $dispo_choice = $_GET["dispo_choice"];
} elseif (isset($_POST["dispo_choice"])) {
    $dispo_choice = $_POST["dispo_choice"];
}
...
if (isset($_GET["extra1"])) {
    $extra1 = $_GET["extra1"];
} elseif (isset($_POST["extra1"])) {
    $extra1 = $_POST["extra1"];
}

if (isset($_GET["extra2"])) {
    $extra2 = $_GET["extra2"];
} elseif (isset($_POST["extra2"])) {
    $extra2 = $_POST["extra2"];
}

if (isset($_GET["extra3"])) {
    $extra3 = $_GET["extra3"];
} elseif (isset($_POST["extra3"])) {
    $extra3 = $_POST["extra3"];
}

if (isset($_GET["extra4"])) {
    $extra4 = $_GET["extra4"];
} elseif (isset($_POST["extra4"])) {
    $extra4 = $_POST["extra4"];
}

if (isset($_GET["extra5"])) {
    $extra5 = $_GET["extra5"];
} elseif (isset($_POST["extra5"])) {
    $extra5 = $_POST["extra5"];
}

if (isset($_GET["extra6"])) {
    $extra6 = $_GET["extra6"];
} elseif (isset($_POST["extra6"])) {
    $extra6 = $_POST["extra6"];
}

if (isset($_GET["extra7"])) {
    $extra7 = $_GET["extra7"];
} elseif (isset($_POST["extra7"])) {
    $extra7 = $_POST["extra7"];
}

if (isset($_GET["extra8"])) {
    $extra8 = $_GET["extra8"];
} elseif (isset($_POST["extra8"])) {
    $extra8 = $_POST["extra8"];
}

if (isset($_GET["extra9"])) {
    $extra9 = $_GET["extra9"];
} elseif (isset($_POST["extra9"])) {
    $extra9 = $_POST["extra9"];
}

if (isset($_GET["extra10"])) {
    $extra10 = $_GET["extra10"];
} elseif (isset($_POST["extra10"])) {
    $extra10 = $_POST["extra10"];
}

if (isset($_GET["extra11"])) {
    $extra11 = $_GET["extra11"];
} elseif (isset($_POST["extra11"])) {
    $extra11 = $_POST["extra11"];
}

if (isset($_GET["extra12"])) {
    $extra12 = $_GET["extra12"];
} elseif (isset($_POST["extra12"])) {
    $extra12 = $_POST["extra12"];
}

if (isset($_GET["extra13"])) {
    $extra13 = $_GET["extra13"];
} elseif (isset($_POST["extra13"])) {
    $extra13 = $_POST["extra13"];
}

if (isset($_GET["extra14"])) {
    $extra14 = $_GET["extra14"];
} elseif (isset($_POST["extra14"])) {
    $extra14 = $_POST["extra14"];
}

if (isset($_GET["extra15"])) {
    $extra15 = $_GET["extra15"];
} elseif (isset($_POST["extra15"])) {
...
if (isset($_GET["VDstop_rec_after_each_call"])) {
    $VDstop_rec_after_each_call = $_GET["VDstop_rec_after_each_call"];
} elseif (isset($_POST["VDstop_rec_after_each_call"])) {
    $VDstop_rec_after_each_call = $_POST["VDstop_rec_after_each_call"];
}
if (isset($_GET["conf_silent_prefix"])) {
    $conf_silent_prefix = $_GET["conf_silent_prefix"];
} elseif (isset($_POST["conf_silent_prefix"])) {
    $conf_silent_prefix = $_POST["conf_silent_prefix"];
}
...
if (isset($_GET["user_abb"])) {
    $user_abb = $_GET["user_abb"];
} elseif (isset($_POST["user_abb"])) {
    $user_abb = $_POST["user_abb"];
}
...
if (isset($_GET["agent_log"])) {
    $agent_log = $_GET["agent_log"];
} elseif (isset($_POST["agent_log"])) {
    $agent_log = $_POST["agent_log"];
}
...
if (isset($_GET["CallBackDatETimE"])) {
    $CallBackDatETimE = $_GET["CallBackDatETimE"];
} elseif (isset($_POST["CallBackDatETimE"])) {
    $CallBackDatETimE = $_POST["CallBackDatETimE"];
}
...
if (isset($_GET["use_internal_dnc"])) {
    $use_internal_dnc = $_GET["use_internal_dnc"];
} elseif (isset($_POST["use_internal_dnc"])) {
    $use_internal_dnc = $_POST["use_internal_dnc"];
}
if (isset($_GET["use_campaign_dnc"])) {
    $use_campaign_dnc = $_GET["use_campaign_dnc"];
} elseif (isset($_POST["use_campaign_dnc"])) {
    $use_campaign_dnc = $_POST["use_campaign_dnc"];
}
if (isset($_GET["omit_phone_code"])) {
    $omit_phone_code = $_GET["omit_phone_code"];
} elseif (isset($_POST["omit_phone_code"])) {
...
if (isset($_GET["LogouTKicKAlL"])) {
    $LogouTKicKAlL = $_GET["LogouTKicKAlL"];
} elseif (isset($_POST["LogouTKicKAlL"])) {
    $LogouTKicKAlL = $_POST["LogouTKicKAlL"];
}
if (isset($_GET["closer_blended"])) {
    $closer_blended = $_GET["closer_blended"];
} elseif (isset($_POST["closer_blended"])) {
    $closer_blended = $_POST["closer_blended"];
}
if (isset($_GET["inOUT"])) {
    $inOUT = $_GET["inOUT"];
...
if (isset($_GET["manual_dial_filter"])) {
    $manual_dial_filter = $_GET["manual_dial_filter"];
} elseif (isset($_POST["manual_dial_filter"])) {
...
if (isset($_GET["conf_dialed"])) {
    $conf_dialed = $_GET["conf_dialed"];
} elseif (isset($_POST["conf_dialed"])) {
    $conf_dialed = $_POST["conf_dialed"];
}
if (isset($_GET["leaving_threeway"])) {
    $leaving_threeway = $_GET["leaving_threeway"];
} elseif (isset($_POST["leaving_threeway"])) {
    $leaving_threeway = $_POST["leaving_threeway"];
}
if (isset($_GET["hangup_all_non_reserved"])) {
    $hangup_all_non_reserved = $_GET["hangup_all_non_reserved"];
} elseif (isset($_POST["hangup_all_non_reserved"])) {
    $hangup_all_non_reserved = $_POST["hangup_all_non_reserved"];
}
if (isset($_GET["blind_transfer"])) {
    $blind_transfer = $_GET["blind_transfer"];
} elseif (isset($_POST["blind_transfer"])) {
    $blind_transfer = $_POST["blind_transfer"];
}
...
if (isset($_GET["wrapup"])) {
    $wrapup = $_GET["wrapup"];
} elseif (isset($_POST["wrapup"])) {
    $wrapup = $_POST["wrapup"];
}
if (isset($_GET["vtiger_callback_id"])) {
    $vtiger_callback_id = $_GET["vtiger_callback_id"];
} elseif (isset($_POST["vtiger_callback_id"])) {
...
if (isset($_GET["no_delete_sessions"])) {
    $no_delete_sessions = $_GET["no_delete_sessions"];
} elseif (isset($_POST["no_delete_sessions"])) {
    $no_delete_sessions = $_POST["no_delete_sessions"];
}
...
if (isset($_GET["agent_territories"])) {
    $agent_territories = $_GET["agent_territories"];
} elseif (isset($_POST["agent_territories"])) {
    $agent_territories = $_POST["agent_territories"];
}
if (isset($_GET["alt_num_status"])) {
    $alt_num_status = $_GET["alt_num_status"];
} elseif (isset($_POST["alt_num_status"])) {
    $alt_num_status = $_POST["alt_num_status"];
}
if (isset($_GET["DiaL_SecondS"])) {
    $DiaL_SecondS = $_GET["DiaL_SecondS"];
} elseif (isset($_POST["DiaL_SecondS"])) {
    $DiaL_SecondS = $_POST["DiaL_SecondS"];
}
if (isset($_GET["date"])) {
    $date = $_GET["date"];
...
if (isset($_GET["custom_field_names"])) {
    $FORMcustom_field_names = $_GET["custom_field_names"];
} elseif (isset($_POST["custom_field_names"])) {
    $FORMcustom_field_names = $_POST["custom_field_names"];
}
if (isset($_GET["qm_phone"])) {
    $qm_phone = $_GET["qm_phone"];
} elseif (isset($_POST["qm_phone"])) {
    $qm_phone = $_POST["qm_phone"];
}
if (isset($_GET["manual_dial_call_time_check"])) {
    $manual_dial_call_time_check = $_GET["manual_dial_call_time_check"];
} elseif (isset($_POST["manual_dial_call_time_check"])) {
    $manual_dial_call_time_check = $_POST["manual_dial_call_time_check"];
}
if (isset($_GET["CallBackLeadStatus"])) {
    $CallBackLeadStatus = $_GET["CallBackLeadStatus"];
} elseif (isset($_POST["CallBackLeadStatus"])) {
    $CallBackLeadStatus = $_POST["CallBackLeadStatus"];
}
...
} elseif (isset($_POST["sub_status"])) {
    $sub_status = $_POST["sub_status"];
}

if (isset($_GET["cb_id"])) {
    $cb_id = $_GET["cb_id"];
} elseif (isset($_POST["cb_id"])) {
    $cb_id = $_POST["cb_id"];
}

if (isset($_GET["ultimo_callback"])) {
    $ultimo_callback = $_GET["ultimo_callback"];
} elseif (isset($_POST["ultimo_callback"])) {
    $ultimo_callback = $_POST["ultimo_callback"];
}
...
if (isset($_GET["cb_date_1"])) {
    $cb_date_1 = $_GET["cb_date_1"];
} elseif (isset($_POST["cb_date_1"])) {
    $cb_date_1 = $_POST["cb_date_1"];
}
if (isset($_GET["cb_date_2"])) {
    $cb_date_2 = $_GET["cb_date_2"];
} elseif (isset($_POST["cb_date_2"])) {
    $cb_date_2 = $_POST["cb_date_2"];
}

if (isset($_GET["portabilidade"])) {
    $portabilidade = $_GET["portabilidade"];
} elseif (isset($_POST["portabilidade"])) {
    $portabilidade = $_POST["portabilidade"];
}

if (isset($_GET["cp_4"])) {
    $cp_4 = $_GET["cp_4"];
} elseif (isset($_POST["cp_4"])) {
    $cp_4 = $_POST["cp_4"];
}
if (isset($_GET["cp_3"])) {
    $cp_3 = $_GET["cp_3"];
} elseif (isset($_POST["cp_3"])) {
    $cp_3 = $_POST["cp_3"];
}

if (isset($_GET["cb_to_other_user"])) {
    $cb_to_other_user = $_GET["cb_to_other_user"];
} elseif (isset($_POST["cb_to_other_user"])) {
    $cb_to_other_user = $_POST["cb_to_other_user"];
}
if (isset($_GET["cb_to_other_username"])) {
    $cb_to_other_username = $_GET["cb_to_other_username"];
} elseif (isset($_POST["cb_to_other_username"])) {
    $cb_to_other_username = $_POST["cb_to_other_username"];
}
...
if ($ACTION == 'LogiNCamPaigns') {
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00002', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    $auth = $row[0];
    ...
    if ((strlen($user) < 2) or (strlen($pass) < 2) or ($auth == 0)) {
        ...
        if ((strlen($server_ip) < 6) or (!isset($server_ip)) or ((strlen($session_name) < 12) or (!isset($session_name)))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00003', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row = mysql_fetch_row($rslt);
            $SNauth = $row[0];
            if ($SNauth == 0) {
...
if ($ACTION == 'LogiNCamPaigns') {
    if ((strlen($user) < 1)) {
        echo "<select style=width:200px name=VD_campaign id=VD_campaign onFocus=\"login_allowable_campaigns()\">\n";
        echo "<option value=\"\">Prencha o Username</option>\n";
        echo "</select>\n";
        exit;
    }
    if ((strlen($pass) < 1)) {
        echo "<select style=width:200px name=VD_campaign id=VD_campaign onFocus=\"login_allowable_campaigns()\">\n";
        echo "<option value=\"\">Prencha a Password</option>\n";
        echo "</select>\n";
        exit;
    } else {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00004', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row = mysql_fetch_row($rslt);
        $VU_user_group = $row[0];
        $VU_user_level = $row[1];
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00005', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row = mysql_fetch_row($rslt);
        ...
        if ((ereg('Y', $forced_timeclock_login)) or ((ereg('ADMIN_EXEMPT', $forced_timeclock_login)) and ($VU_user_level < 8))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00184', $user, $server_ip, $session_name, $one_mysql_log);
            }
    ...
    if (((ereg("START|ALL", $shift_enforcement)) and (!ereg("OFF", $VU_agent_shift_enforcement_override))) or (ereg("START|ALL", $VU_agent_shift_enforcement_override))) {
        ...
        if ((strlen($LOGgroup_shiftsSQL) < 3) and ($VU_shift_override_flag < 1)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00193', $user, $server_ip, $session_name, $one_mysql_log);
            }
    ...
    if ($show_campaign_list > 0) {
        ...
        $stmt = "SELECT user,pass from vicidial_users WHERE user='$user' AND pass='$pass';";
        $rslt = mysql_query($stmt, $link);
        $rslt = mysql_num_rows($rslt);
        if ($rslt == 0) {
            $valogin = 0;
        } else {
            $valogin = 1;
        ...
        $stmt = "SELECT campaign_id,campaign_name from vicidial_campaigns where active='Y' $LOGallowed_campaignsSQL order by campaign_name";
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
        ...
        if ($valogin == 0) {
            echo "<select name=VD_campaign id=VD_campaign onfocus='login_allowable_campaigns()'>\n";
            echo "<option value=\"\">LogIn Incorrecto</option>\n";
        } else {
            echo "<select name=VD_campaign id=VD_campaign>\n";
            echo "<option value=\"\">Escolha uma campanha</option>\n";
        }
        $o = 0;
...
if ($ACTION == 'regCLOSER') {
    ...
    if ((strlen($closer_choice) < 1) || (strlen($user) < 1)) {
        ...
        if ($closer_choice == "MGRLOCK-") {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00007', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00008', $user, $server_ip, $session_name, $one_mysql_log);
            }
        } else {
            $stmt = "UPDATE vicidial_live_agents set closer_campaigns='$closer_choice',last_state_change='$NOW_TIME',outbound_autodial='$vla_autodial' where user='$user' and server_ip='$server_ip';";
            if ($format == 'debug') {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00009', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00010', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00011', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00012', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00349', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($format == 'debug') {
            echo "\n<!-- $rowx[0]|$stmt -->";
        }
        ...
        while ($k < $in_groups_ct) {
            if (strlen($in_groups[$k]) > 1) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00013', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00014', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if (($enable_queuemetrics_logging > 0) and ($queuemetrics_addmember_enabled > 0)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00388', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '0350', $user, $server_ip, $session_name, $one_mysql_log);
                    }
...
if ($ACTION == 'regTERRITORY') {
    ...
    if ((strlen($agent_territories) < 1) || (strlen($user) < 1)) {
        ...
        if (preg_match("/^MGRLOCK/", $agent_territories)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00253', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $territories_ct = mysql_num_rows($rslt);
            if ($DB) {
                echo "$territories_ct|$stmt\n";
            }
            $k = 0;
            $agent_territories = '';
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00254', $user, $server_ip, $session_name, $one_mysql_log);
            }
        } else {
            $stmt = "UPDATE vicidial_live_agents set agent_territories='$agent_territories',last_state_change='$NOW_TIME' where user='$user' and server_ip='$server_ip';";
            if ($format == 'debug') {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00255', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00256', $user, $server_ip, $session_name, $one_mysql_log);
        }
    }
...
$rslt = mysql_query($stmt, $link);
if ($mel > 0) {
    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00222', $user, $server_ip, $session_name, $one_mysql_log);
}
...
if ($ACTION == 'UpdateFields') {
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00276', $user, $server_ip, $session_name, $one_mysql_log);
    }

    $stmt = "SELECT lead_id from vicidial_live_agents where user='$user';";
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00274', $user, $server_ip, $session_name, $one_mysql_log);
    }
    ...
    if ($vla_records > 0) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00275', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($list_lead_ct > 0) {
            ...
            $LeaD_InfO[] = "GOOD";
            $LeaD_InfO[] = (string) $vendor_id;
            $LeaD_InfO[] = (string) $source_id;
            $LeaD_InfO[] = (string) $gmt_offset_now;
            $LeaD_InfO[] = (string) $phone_code;
            $LeaD_InfO[] = (string) $phone_number;
            $LeaD_InfO[] = (string) $title;
            $LeaD_InfO[] = (string) $first_name;
            $LeaD_InfO[] = (string) $middle_initial;
            $LeaD_InfO[] = (string) $last_name;
            $LeaD_InfO[] = (string) $address1;
            $LeaD_InfO[] = (string) $address2;
            $LeaD_InfO[] = (string) $address3;
            $LeaD_InfO[] = (string) $city;
            $LeaD_InfO[] = (string) $state;
            $LeaD_InfO[] = (string) $province;
            $LeaD_InfO[] = (string) $postal_code;
            $LeaD_InfO[] = (string) $country_code;
            $LeaD_InfO[] = (string) $gender;
            $LeaD_InfO[] = (string) $date_of_birth;
            $LeaD_InfO[] = (string) $alt_phone;
            $LeaD_InfO[] = (string) $email;
            $LeaD_InfO[] = (string) $security;
            $LeaD_InfO[] = (string) $comments;
            $LeaD_InfO[] = (string) $rank;
            $LeaD_InfO[] = (string) $owner;
            $LeaD_InfO[] = "\n";
...
if ($ACTION == 'manDiaLnextCaLL') {
    ...
    if ((strlen($conf_exten) < 1) || (strlen($campaign) < 1) || (strlen($ext_context) < 1)) {
        $channel_live = 0;
        echo json_encode(array("HOPPER EMPTY", "Conf Exten $conf_exten or campaign $campaign or ext_context $ext_context is not valid"));
        exit;
    } else {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00015', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00257', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ((strlen($callback_id) > 0) and (strlen($lead_id) > 0)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00016', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        elseif (strlen($lead_id) > 0) {
            ...
            if (strlen($phone_number) > 1) {
                if (ereg("ENABLED", $manual_dial_call_time_check)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00353', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($dialable < 1) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00354', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00355', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $VLAEDaffected_rows = mysql_affected_rows($link);

                        echo json_encode(array("OUTSIDE OF LOCAL CALL TIME   $VMDQaffected_rows|$VLAEDaffected_rows"));
                        exit;
                    }
                }
                ...
                if (ereg("DNC", $manual_dial_filter)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00017', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($row[0] > 0) {
                        ...
                        echo json_encode(array("DNC NUMBER"));
                        exit;
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00018', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($row[0] > 0) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00358', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $VMDQaffected_rows = mysql_affected_rows($link);
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00359', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $VLAEDaffected_rows = mysql_affected_rows($link);
                ...
                if (ereg("CAMPLISTS", $manual_dial_filter)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00019', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00020', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($row[0] < 1) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00360', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $VMDQaffected_rows = mysql_affected_rows($link);
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00361', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $VLAEDaffected_rows = mysql_affected_rows($link);

                        echo json_encode(array("NUMBER NOT IN CAMPLISTS"));
                        exit;
                    }
                }
                ...
                if ($stage == 'lookup') {
                    if (strlen($vendor_lead_code) > 0) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00021', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00362', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                    ...
                    if ($man_leadID_ct > 0) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00022', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00023', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($link);
                    $lead_id = mysql_insert_id($link);
                    $CBleadIDset = 1;
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00236', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if (eregi("N", $no_hopper_dialing)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00024', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($link);
                } else {
                    ...
                    if (strlen($dial_statuses) > 2) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00237', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $rowx = mysql_fetch_row($rslt);
                        ...
                        while ($ct_srs >= $b) {
                            if (strlen($state_rules[$b]) > 1) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00238', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                $row = mysql_fetch_row($rslt);
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00239', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $filtersql_ct = mysql_num_rows($rslt);
                        if ($DB) {
                            echo "$filtersql_ct|$stmt\n";
                        }
                        if ($filtersql_ct > 0) {
                            $row = mysql_fetch_row($rslt);
                            $fSQL = "and $row[0]";
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00240', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00241', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $userterr_ct = mysql_num_rows($rslt);
                        if ($DB) {
                            echo "$userterr_ct|$stmt\n";
                        }
                        if ($userterr_ct > 0) {
                            $row = mysql_fetch_row($rslt);
                            $user_group = $row[0];
                        ...
                        if (eregi("TERRITORY", $agent_dial_owner_only)) {
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00406', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            ...
                            if ($agent_choose_territories < 1) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00407', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00408', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                        ...
                        if (eregi("USER", $agent_dial_owner_only)) {
                            $adooSQL = "and owner='$user'";
                        }
                        if (eregi("USER_GROUP", $agent_dial_owner_only)) {
                            $adooSQL = "and owner='$user_group'";
                        }
                        ...
                        if ($lead_order_randomize == 'Y') {
                            ...
                            if ($lead_order_secondary == 'LEAD_ASCEND') {
                                $last_order = "lead_id asc";
                            }
                            if ($lead_order_secondary == 'LEAD_DESCEND') {
                                $last_order = "lead_id desc";
                            }
                            if ($lead_order_secondary == 'CALLTIME_ASCEND') {
                                $last_order = "last_local_call_time asc";
                            }
                            if ($lead_order_secondary == 'CALLTIME_DESCEND') {
                                $last_order = "last_local_call_time desc";
                            }
                        }

                        $order_stmt = '';
                        if (eregi("DOWN", $lead_order)) {
                            $order_stmt = 'order by lead_id asc';
                        }
                        if (eregi("UP", $lead_order)) {
                            $order_stmt = 'order by lead_id desc';
                        }
                        if (eregi("UP LAST NAME", $lead_order)) {
                            $order_stmt = "order by last_name desc, $last_order";
                        }
                        if (eregi("DOWN LAST NAME", $lead_order)) {
                            $order_stmt = "order by last_name, $last_order";
                        }
                        if (eregi("UP PHONE", $lead_order)) {
                            $order_stmt = "order by phone_number desc, $last_order";
                        }
                        if (eregi("DOWN PHONE", $lead_order)) {
                            $order_stmt = "order by phone_number, $last_order";
                        }
                        if (eregi("UP COUNT", $lead_order)) {
                            $order_stmt = "order by called_count desc, $last_order";
                        }
                        if (eregi("DOWN COUNT", $lead_order)) {
                            $order_stmt = "order by called_count, $last_order";
                        }
                        if (eregi("UP LAST CALL TIME", $lead_order)) {
                            $order_stmt = "order by last_local_call_time desc, $last_order";
                        }
                        if (eregi("DOWN LAST CALL TIME", $lead_order)) {
                            $order_stmt = "order by last_local_call_time, $last_order";
                        }
                        if (eregi("RANDOM", $lead_order)) {
                            $order_stmt = "order by RAND()";
                        }
                        if (eregi("UP RANK", $lead_order)) {
                            $order_stmt = "order by rank desc, $last_order";
                        }
                        if (eregi("DOWN RANK", $lead_order)) {
                            $order_stmt = "order by rank, $last_order";
                        }
                        if (eregi("UP OWNER", $lead_order)) {
                            $order_stmt = "order by owner desc, $last_order";
                        }
                        if (eregi("DOWN OWNER", $lead_order)) {
                            $order_stmt = "order by owner, $last_order";
                        }
                        if (eregi("UP TIMEZONE", $lead_order)) {
                            $order_stmt = "order by gmt_offset_now desc, $last_order";
                        }
                        if (eregi("DOWN TIMEZONE", $lead_order)) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00242', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysql_affected_rows($link);
                        ...
                        if ($affected_rows > 0) {
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00243', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            if ($DB) {
                                echo "$stmt\n";
                            }
                            ...
                            if ($leadpick_ct > 0) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00244', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                            }
                        }
                    }
        ...
        if ($affected_rows > 0) {
            if (!$CBleadIDset) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00025', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            ##### grab the data from vicidial_list for the lead_id
            $stmt = "SELECT lead_id,entry_date,modify_date,status,user,vendor_lead_code,source_id,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,date_of_birth,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,extra1,extra2,extra3,extra4,extra5,extra6,extra7,extra8,extra9,extra10,extra11,extra12,extra13,extra14,extra15 FROM vicidial_list where lead_id='$lead_id' LIMIT 1;";
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00026', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00414', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00027', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00366', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($CBstatus < 1) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00367', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            if (($CBstatus > 0) or ($dispo == 'CBHOLD')) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00028', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00029', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00030', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if (!$CBleadIDset) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00031', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00032', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if (strlen($list_id) > 1) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00245', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            if ((strlen($preview) < 1) || ($preview == 'NO')) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00313', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00322', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if ($CCID_on) {
                    $CIDstring = "\"$MqueryCID$EAC\" <$CCID>";
                } else {
                    $CIDstring = "$MqueryCID$EAC";
                }
                ...
                if ($portabilidade > 0) {
                    switch ($portabilidade) {
                        case "1": $agent_dialed_number = "96" . $agent_dialed_number;
                            break;
                        case "2": $agent_dialed_number = "91" . $agent_dialed_number;
                            break;
                        case "3": $agent_dialed_number = "93" . $agent_dialed_number;
                            break;
                    }
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00033', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00034', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00035', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00036', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00323', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00324', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($agent_dialed_number > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00191', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00037', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if ($enable_queuemetrics_logging > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00389', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00038', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($linkB);
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00039', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($linkB);
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00040', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($linkB);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00259', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($vls_vc_ct > 0) {
                ...
                if ($row[0] > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00260', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00277', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if (strlen($list_id) > 0) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00278', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00334', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if ($cffn_ct > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00335', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
            ...
            $LeaD_InfO[] = (string) $MqueryCID;
            $LeaD_InfO[] = (string) $lead_id;
            $LeaD_InfO[] = (string) $dispo;
            $LeaD_InfO[] = (string) $tsr;
            $LeaD_InfO[] = (string) $vendor_id;
            $LeaD_InfO[] = (string) $list_id;
            $LeaD_InfO[] = (string) $gmt_offset_now;
            $LeaD_InfO[] = (string) $phone_code;
            $LeaD_InfO[] = (string) $phone_number;
            $LeaD_InfO[] = (string) $title;
            ...
            $LeaD_InfO[] = (string) $security;
            $LeaD_InfO[] = (string) $comments;
            $LeaD_InfO[] = (string) $called_count;
            $LeaD_InfO[] = (string) $CBentry_time;
            $LeaD_InfO[] = (string) $CBcallback_time;
            $LeaD_InfO[] = (string) $CBuser;
            $LeaD_InfO[] = (string) $CBcomments;
            $LeaD_InfO[] = (string) $agent_dialed_number;
            $LeaD_InfO[] = (string) $agent_dialed_type;
            $LeaD_InfO[] = (string) $source_id;
            $LeaD_InfO[] = (string) $rank;
            $LeaD_InfO[] = (string) $owner;
            $LeaD_InfO[] = "\n";
            $LeaD_InfO[] = (string) $script_recording_delay;
            $LeaD_InfO[] = (string) $VDCL_xferconf_a_number;
            $LeaD_InfO[] = (string) $VDCL_xferconf_b_number;
            $LeaD_InfO[] = (string) $VDCL_xferconf_c_number;
            $LeaD_InfO[] = (string) $VDCL_xferconf_d_number;
            $LeaD_InfO[] = (string) $VDCL_xferconf_e_number;
            $LeaD_InfO[] = (string) $entry_list_id;
            $LeaD_InfO[] = (string) $custom_field_names;
            $LeaD_InfO[] = (string) $custom_field_values;
            $LeaD_InfO[] = (string) $custom_field_types;
            $LeaD_InfO[] = (string) $LISTweb_form_address;
            $LeaD_InfO[] = (string) $LISTweb_form_address_two;
            $LeaD_InfO[] = (string) $post_phone_time_diff_alert_message;
            $LeaD_InfO[] = (string) $extra1;
            $LeaD_InfO[] = (string) $extra2;
            $LeaD_InfO[] = (string) $extra3;
            $LeaD_InfO[] = (string) $extra4;
            $LeaD_InfO[] = (string) $extra5;
            $LeaD_InfO[] = (string) $extra6;
            $LeaD_InfO[] = (string) $extra7;
            $LeaD_InfO[] = (string) $extra8;
            $LeaD_InfO[] = (string) $extra9;
            $LeaD_InfO[] = (string) $extra10;
            $LeaD_InfO[] = (string) $extra11;
            $LeaD_InfO[] = (string) $extra12;
            $LeaD_InfO[] = (string) $extra13;
            $LeaD_InfO[] = (string) $extra14;
            $LeaD_InfO[] = (string) $extra15;


            echo json_encode($LeaD_InfO);
        } else {
            echo json_encode(array("HOPPER EMPTY"));
        }
    }
}
...
if ($ACTION == 'alt_phone_change') {
    ...
    if ((strlen($stage) < 1) || (strlen($called_count) < 1) || (strlen($lead_id) < 1) || (strlen($phone_number) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00041', $user, $server_ip, $session_name, $one_mysql_log);
        }
...
if ($ACTION == 'AlertControl') {
    if (strlen($stage) < 1) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '000185', $user, $server_ip, $session_name, $one_mysql_log);
        }
...
if ($ACTION == 'manDiaLskip') {
    ...
    if ((strlen($stage) < 1) || (strlen($called_count) < 1) || (strlen($lead_id) < 1)) {
        $channel_live = 0;
        echo json_encode(array("LEAD NOT REVERTED", "Conf Exten $conf_exten or campaign $campaign or ext_context $ext_context is not valid"));
        exit;
    } else {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00042', $user, $server_ip, $session_name, $one_mysql_log);
        }
        echo json_encode(array("LEAD REVERTED"));
    }
}
...
if ($ACTION == 'manDiaLonly') {
    ...
    if ((strlen($conf_exten) < 1) || (strlen($campaign) < 1) || (strlen($ext_context) < 1) || (strlen($phone_number) < 1) || (strlen($lead_id) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00043', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00325', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if (strlen($lead_id) > 1) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00246', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($lio_ct > 0) {
                ...
                if (strlen($list_id) > 1) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00247', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00314', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($portabilidade > 0) {
            switch ($portabilidade) {
                case "1": $phone_number = "96" . $phone_number;
                    break;
                case "2": $phone_number = "91" . $phone_number;
                    break;
                case "3": $phone_number = "93" . $phone_number;
                    break;
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00044', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00045', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00046', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $retry_count = 0;
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00047', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00326', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($val_dispo_epoch > 1000) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00327', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00328', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00329', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($link);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00330', $VD_login, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00331', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00048', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($enable_queuemetrics_logging > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00390', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00049', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($linkB);
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00050', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($linkB);
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00051', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($linkB);
...
if ($ACTION == 'manDiaLlookCaLL') {
    ...
    if (strlen($MDnextCID) < 18) {
        echo json_encode(array("NO", "MDnextCID $MDnextCID is not valid"));
        exit;
    } else {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00052', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($VM_mancall_ct > 0) {
            ...
            $uniqueid = $row[0];
            $channel = $row[1];
            $call_output = array($uniqueid, $channel);
            $call_good++;
        } else {
            ...
            if (($DiaL_SecondS > 0) and (preg_match("/0$/", $DiaL_SecondS))) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00291', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if ($VM_mancallX_ct > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00292', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    if ($CL_mancall_ct > 0) {
                        ...
                        $call_output = array($uniqueid, $channel, "ERROR", $hangup_cause_msg);
                        $call_good++;
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00293', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00399', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                }
            }
        ...
        if ($call_good > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00053', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VDpr_ct = mysql_num_rows($rslt);
            if ($VDpr_ct > 0) {
                $row = mysql_fetch_row($rslt);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00054', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00055', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00300', $user, $server_ip, $session_name, $one_mysql_log);
            }

            echo json_encode($call_output);
        } else {
            echo json_encode(array("NO", "$DiaL_SecondS"));
        }
    }
}
...
if ($ACTION == 'manDiaLlogCaLL') {
    ...
    if ($stage == "start") {
        if ((strlen($uniqueid) < 1) || (strlen($lead_id) < 1) || (strlen($list_id) < 1) || (strlen($phone_number) < 1) || (strlen($campaign) < 1)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00056', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00400', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00223', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($manualVLexists < 1) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00279', $user, $server_ip, $session_name, $one_mysql_log);
                }
            ...
            if (($manualVLexists > 0) or ($manualVLexistsDUP > 0)) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00224', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rows = mysql_affected_rows($link);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00058', $user, $server_ip, $session_name, $one_mysql_log);
            }
    ...
    if ($stage == "end") {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00059', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ((strlen($uniqueid) < 1) or (strlen($lead_id) < 1)) {
            ...
            if ($start_epoch < 1000) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00060', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if (($length_in_sec < 1) and ($VLA_inOUT == 'INBOUND')) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00061', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
            ...
            if (strlen($VDcampaign_id) < 1) {
                $VDcampaign_id = $campaign;
            }
            ...
            if ($VLA_inOUT == 'INBOUND') {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00062', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rows = mysql_affected_rows($link);
                if ($affected_rows > 0) {
                    echo "$uniqueid\n$channel\n";
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00063', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($auto_dial_level > 0) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00064', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if (eregi("(ALT_ONLY|ADDR3_ONLY|ALT_AND_ADDR3|ALT_AND_EXTENDED|ALT_AND_ADDR3_AND_EXTENDED|EXTENDED_ONLY)", $auto_alt_dial)) {
                    ...
                    if ($VLA_inOUT == 'INBOUND') {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00235', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                    ...
                    if ((eregi("(NONE|MAIN)", $alt_dial)) and (eregi("(ALT_ONLY|ALT_AND_ADDR3|ALT_AND_EXTENDED)", $auto_alt_dial))) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00065', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        if (strlen($alt_phone) > 5) {
                            if ((ereg("Y", $use_internal_dnc)) or (ereg("AREACODE", $use_internal_dnc))) {
                                ...
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00066', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                if ($DB) {
                                    echo "$stmt\n";
                                }
                            ...
                            if ((ereg("Y", $use_campaign_dnc)) or (ereg("AREACODE", $use_campaign_dnc))) {
                                ...
                                $rslt = mysql_query($stmtA, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00067', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                if ($DB) {
                                    echo "$stmt\n";
                                }
                            ...
                            if ($VD_alt_dnc_count < 1) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00068', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                            } else {
                                $alt_dial_skip = 1;
                            }
                    ...
                    if (((eregi("(ALT)", $alt_dial)) and (eregi("ALT_AND_ADDR3", $auto_alt_dial))) or ((eregi("(NONE|MAIN)", $alt_dial)) and (eregi("ADDR3_ONLY", $auto_alt_dial)))) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00069', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        if (strlen($address3) > 5) {
                            if ((ereg("Y", $use_internal_dnc)) or (ereg("AREACODE", $use_internal_dnc))) {
                                ...
                                $rslt = mysql_query($stmtA, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00070', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                if ($DB) {
                                    echo "$stmt\n";
                                }
                            ...
                            if ((ereg("Y", $use_campaign_dnc)) or (ereg("AREACODE", $use_campaign_dnc))) {
                                ...
                                $rslt = mysql_query($stmtA, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00071', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                if ($DB) {
                                    echo "$stmt\n";
                                }
                            ...
                            if ($VD_alt_dnc_count < 1) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00072', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                            } else {
                                $addr3_dial_skip = 1;
                            }
                    ...
                    if ((((eregi("(NONE|MAIN)", $alt_dial)) and (eregi("EXTENDED_ONLY", $auto_alt_dial))) or ((eregi("(ALT)", $alt_dial)) and (eregi("(ALT_AND_EXTENDED)", $auto_alt_dial))) or ((eregi("(ADDR3)", $alt_dial)) and (eregi("(ADDR3_AND_EXTENDED|ALT_AND_ADDR3_AND_EXTENDED)", $auto_alt_dial))) or ((eregi("(X)", $alt_dial)) and (eregi("EXTENDED", $auto_alt_dial)))) and (!eregi("LAST", $alt_dial))) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00073', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00074', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        while (($alt_dial_phones_count > 0) and ($alt_dial_phones_count > $Xlast)) {
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00075', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            if ($DB) {
                                echo "$stmt\n";
                            }
                            ...
                            if (ereg("Y", $VD_altdial_active)) {
                                if ((ereg("Y", $use_internal_dnc)) or (ereg("AREACODE", $use_internal_dnc))) {
                                    ...
                                    $rslt = mysql_query($stmtA, $link);
                                    if ($mel > 0) {
                                        mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00076', $user, $server_ip, $session_name, $one_mysql_log);
                                    }
                                    if ($DB) {
                                        echo "$stmt\n";
                                    }
                                ...
                                if ((ereg("Y", $use_campaign_dnc)) or (ereg("AREACODE", $use_campaign_dnc))) {
                                    ...
                                    $rslt = mysql_query($stmtA, $link);
                                    if ($mel > 0) {
                                        mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00077', $user, $server_ip, $session_name, $one_mysql_log);
                                    }
                                    if ($DB) {
                                        echo "$stmt\n";
                                    }
                                ...
                                if ($VD_alt_dnc_count < 1) {
                                    ...
                                    $rslt = mysql_query($stmt, $link);
                                    if ($mel > 0) {
                                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00078', $user, $server_ip, $session_name, $one_mysql_log);
                                    }
                                    $Xlast = 9999999999;
                                }
                            }
                ...
                if ($enable_queuemetrics_logging > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00079', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00080', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                ...
                if ($nodeletevdac < 1) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00081', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00082', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $retry_count = 0;
                while (($errno > 0) and ($retry_count < 9)) {
                    $rslt = mysql_query($stmt, $link);
                ...
                if ($affected_rows > 0) {
                    if ($enable_queuemetrics_logging > 0) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00391', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        $rslt = mysql_query($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00083', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysql_affected_rows($linkB);
                    }
                }
                ...
                if ($enable_queuemetrics_logging > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00084', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00392', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00085', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($linkB);
                }
                ...
                if ($nodeletevdac < 1) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00086', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00087', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $retry_count = 0;
                while (($errno > 0) and ($retry_count < 9)) {
                    $rslt = mysql_query($stmt, $link);
                ...
                if ($affected_rows > 0) {
                    if ($enable_queuemetrics_logging > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00088', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysql_affected_rows($linkB);
                    }
                }
            ...
            if (($VLA_inOUT == 'AUTO') or ($VLA_inOUT == 'MANUAL')) {
                ...
                if ((ereg("NONE", $term_reason)) or (ereg("NONE", $VDterm_reason)) or (strlen($VDterm_reason) < 1)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00089', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VAC_qm_ct = mysql_num_rows($rslt);
                    if ($VAC_qm_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00401', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rowsX = mysql_affected_rows($link);
                ...
                if ($manualVLexists < 1) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00280', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($link);
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00057', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($link);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00090', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rows = mysql_affected_rows($link);
                ...
                if ((ereg("NONE", $term_reason)) or (ereg("NONE", $VDterm_reason)) or (strlen($VDterm_reason) < 1)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00091', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VAC_qm_ct = mysql_num_rows($rslt);
                    if ($VAC_qm_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                if (strlen($SQLterm) > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00092', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($link);
                }
                ...
                if ($enable_queuemetrics_logging > 0) {
                    if ((strlen($QL_term) > 0) and ($leaving_threeway > 0)) {
                        ...
                        $rslt = mysql_query($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00093', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "$stmt\n";
                        }
                        ...
                        if ($agent_complete < 1) {
                            if (strlen($VDqueue_position) < 1) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00273', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                                $VAC_qm_ct = mysql_num_rows($rslt);
                                if ($VAC_qm_ct > 0) {
                                    $row = mysql_fetch_row($rslt);
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00393', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            if ($DB) {
                                echo "$stmt\n";
                            }
                            ...
                            $rslt = mysql_query($stmt, $linkB);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00094', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $affected_rows = mysql_affected_rows($linkB);
                        }
                    }
        ...
        if ($VDstop_rec_after_each_call == 1) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00095', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($rslt) {
                $rec_list = mysql_num_rows($rslt);
            }
            ...
            if ((($conf_dialed > 0) or ($hangup_all_non_reserved > 0)) and ($leaving_threeway < 1) and ($blind_transfer < 1)) {
                ...
                while ($loop_count < $total_hangup) {
                    if (strlen($hangup_channels[$loop_count]) > 5) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00096', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                    $loop_count++;
                }
            ...
            $loop_count = 0;
            $filename = $MT;
            # not necessary : and cmd_line_f LIKE \"%_$user_abb\"
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00097', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($rslt) {
                $recFN_list = mysql_num_rows($rslt);
            }
            ...
            while ($loop_count < $total_rec) {
                if (strlen($rec_channels[$loop_count]) > 5) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00098', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    if (strlen($filename[$loop_count]) > 2) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00099', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($rslt) {
                            $fn_count = mysql_num_rows($rslt);
                        }
                        if ($fn_count) {
                            $row = mysql_fetch_row($rslt);
                            $recording_id = $row[0];
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00100', $user, $server_ip, $session_name, $one_mysql_log);
                            }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00101', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $VDpr_ct = mysql_num_rows($rslt);
        if ($VDpr_ct > 0) {
            $row = mysql_fetch_row($rslt);
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00102', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00299', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        if (strlen($queuemetrics_dispo_pause) > 0) {
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00364', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($linkB);
        }
    }
...
if ($ACTION == 'VDADREcheckINCOMING') {
    ...
    if ((strlen($campaign) < 1) || (strlen($server_ip) < 1) || (strlen($lead_id) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00103', $user, $server_ip, $session_name, $one_mysql_log);
        }
...
if ($ACTION == 'VDADcheckINCOMING') {
    ...
    if ((strlen($campaign) < 1) || (strlen($server_ip) < 1)) {
        $channel_live = 0;
        echo json_emcode(array("0", "Campaign $campaign is not valid"));
        exit;
    } else {
        ### grab the call and lead info from the vicidial_live_agents table
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00104', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $queue_leadID_ct = mysql_num_rows($rslt);
        ...
        if ($queue_leadID_ct > 0) {
            ...
            $LeaD_InfO[] = "1";
            $LeaD_InfO[] = $lead_id . '|' . $uniqueid . '|' . $callerid . '|' . $channel . '|' . $call_server_ip . "|";

            ##### grab number of calls today in this campaign and increment
            $stmt = "SELECT calls_today FROM vicidial_live_agents WHERE user='$user' and campaign_id='$campaign';";
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00105', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00106', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $retry_count = 0;
            while (($errno > 0) and ($retry_count < 9)) {
                $rslt = mysql_query($stmt, $link);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00107', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00108', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00368', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($CBstatus < 1) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00369', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            if (($CBstatus > 0) or ($dispo == 'CBHOLD')) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00109', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00110', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00333', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00111', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00112', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if ($VDAC_cid_ct > 0) {
                ...
                if (($dialed_number != $phone_number) and (strlen($dialed_label) < 3)) {
                    if ($dialed_number != $alt_phone) {
                        if ($dialed_number != $address3) {
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00248', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            ...
                            if ($VDAP_cid_ct > 0) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00249', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                ...
                if (preg_match('/^M|^V/', $callerid)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00183', $user, $server_ip, $session_name, $one_mysql_log);
                    }
            ...
            if (($call_type == 'OUT') or ($call_type == 'OUTBALANCE')) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00113', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00261', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00114', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($VDIG_cid_ct > 0) {
                    ...
                    if (strlen($VDCL_default_xfer_group) < 2) {
                        $VDCL_default_xfer_group = 'X';
                    }
                ...
                if (strlen($list_id) > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00281', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                ...
                if (ereg('X', $dialed_label)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00116', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VLAP_ct = mysql_num_rows($rslt);
                    if ($VLAP_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00117', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if (strlen($closecallid) < 1) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00336', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VDCL_mvac_ct = mysql_num_rows($rslt);
                    if ($VDCL_mvac_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00118', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00262', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00119', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $VDIG_cid_ct = mysql_num_rows($rslt);
                if ($VDIG_cid_ct > 0) {
                    $row = mysql_fetch_row($rslt);
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00181', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    if ($VDIG_cidOR_ct > 0) {
                        ...
                        if (((ereg('NONE', $VDCL_ingroup_script)) and (strlen($VDCL_ingroup_script) < 5)) or (strlen($VDCL_ingroup_script) < 1)) {
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00263', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            if ($DB) {
                                echo "$stmt\n";
                            }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00188', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    if (strlen($VDCL_group_web_vars) < 1) {
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00189', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00120', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00121', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VDIG_cid_ct = mysql_num_rows($rslt);
                    if ($VDIG_cid_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00264', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00190', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VDIG_cidogwv = mysql_num_rows($rslt);
                    if ($VDIG_cidogwv > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                if (strlen($VDCL_default_group_alias) > 1) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00187', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                ...
                if (strlen($list_id) > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00282', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VDIG_cidOR_ct = mysql_num_rows($rslt);
                    if ($VDIG_cidOR_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00337', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ($VDIDL_ct > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00338', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $VDIDL_ct = mysql_num_rows($rslt);
                    if ($VDIDL_ct > 0) {
                        $row = mysql_fetch_row($rslt);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00122', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $VDU_cid_ct = mysql_num_rows($rslt);
                if ($VDU_cid_ct > 0) {
                    $row = mysql_fetch_row($rslt);
                    $fronter_full_name = $row[0];
                    $LeaD_InfO[] = $fronter_full_name . '|' . $tsr;
                } else {
                    $LeaD_InfO[] = '|' . $tsr;
                }
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00265', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($vls_vc_ct > 0) {
                ...
                if ($row[0] > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00266', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00339', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($cffn_ct > 0) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00340', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            $LeaD_InfO[] = (string) $CBuser;
            $LeaD_InfO[] = (string) $CBcomments;
            $LeaD_InfO[] = (string) $dialed_number;
            $LeaD_InfO[] = (string) $dialed_label;
            $LeaD_InfO[] = (string) $source_id;
            $LeaD_InfO[] = (string) $alt_phone_code;
            $LeaD_InfO[] = (string) $alt_phone_number;
            $LeaD_InfO[] = (string) $alt_phone_note;
            $LeaD_InfO[] = (string) $alt_phone_active;
            $LeaD_InfO[] = (string) $alt_phone_count;
            $LeaD_InfO[] = (string) $rank;
            $LeaD_InfO[] = (string) $owner;
            $LeaD_InfO[] = (string) $script_recording_delay;
            $LeaD_InfO[] = (string) $entry_list_id;
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00123', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VDpr_ct = mysql_num_rows($rslt);
            if ($VDpr_ct > 0) {
                $row = mysql_fetch_row($rslt);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00124', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00370', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($CBstatus < 1) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00371', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            if (($CBstatus > 0) or (eregi("CALLBK|CBHOLD", $dispo))) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00125', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00126', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if (strlen($VDCL_start_call_url) > 7) {
                if (eregi('--A--user_custom_', $VDCL_start_call_url)) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00283', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                ...
                if (strlen($custom_field_names) > 2) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00344', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00294', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                if ((($enable_vtiger_integration > 0) and (ereg('callxfer', $VDCL_start_call_url)) and (ereg('contactwsid', $VDCL_start_call_url))) or (preg_match("/minuteswarning/", $VDCL_start_call_url))) {
                    ...
                    if ((strlen($SCUoutput) > 4) or (preg_match("/minuteswarning/", $VDCL_start_call_url))) {
                        ...
                        if (preg_match("/callcard=/", $VDCL_start_call_url)) {
                            ...
                            $rslt = mysql_query($stmt, $link);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00315', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            if ($DB) {
                                echo "$stmt\n";
                            }
                            ...
                            if ($bms_ct > 0) {
                                ...
                                $rslt = mysql_query($stmt, $link);
                                if ($mel > 0) {
                                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00316', $user, $server_ip, $session_name, $one_mysql_log);
                                }
                        ...
                        if (strlen($durationLimit) < 1) {
                            $durationLimit = 0;
                        }
                        $durationLimitSECnext = (($minuteswarning + 0) * 60);
                        $durationLimitSEC = ((($durationLimit + 0) - $minuteswarning) * 60);
                        # minutes - 3 for 3-minute-warning
                        if ($durationLimitSEC < 5) {
                            $durationLimitSEC = 5;
                        }
                        if (($durationLimitSECnext < 30) or (strlen($durationLimitSECnext) < 1)) {
                            $durationLimitSECnext = 30;
                        }
                        ...
                        $rslt = mysql_query($stmt, $link);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00295', $user, $server_ip, $session_name, $one_mysql_log);
                        }
...
if ($ACTION == 'userLOGout') {
    ...
    if ((strlen($campaign) < 1) || (strlen($conf_exten) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00127', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00128', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        if ($no_delete_sessions < 1) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00129', $user, $server_ip, $session_name, $one_mysql_log);
            }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00132', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00133', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($rslt) {
            $row = mysql_fetch_row($rslt);
            $agent_channel = "$row[0]";
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00134', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        if ($LogouTKicKAlL > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00135', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00130', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $retry_count = 0;
        while (($errno > 0) and ($retry_count < 9)) {
            $rslt = mysql_query($stmt, $link);
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00131', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00136', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $VDpr_ct = mysql_num_rows($rslt);
        if (($VDpr_ct > 0) and (strlen($row[3] < 5)) and (strlen($row[4] < 5))) {
            $row = mysql_fetch_row($rslt);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00137', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        if ($vla_delete > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00138', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($enable_queuemetrics_logging > 0) {
                ...
                $rslt = mysql_query($stmt, $linkB);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00139', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00394', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                if ($queuemetrics_loginout != 'NONE') {
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00140', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rows = mysql_affected_rows($linkB);
                }
                ...
                if ($queuemetrics_addmember_enabled > 0) {
                    if ($queuemetrics_loginout == 'NONE') {
                        ...
                        $rslt = mysql_query($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00396', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysql_affected_rows($linkB);
                    }
                    if (($logintime < 1) or ($queuemetrics_loginout == 'NONE')) {
                        ...
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00365', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "<BR>$stmtB\n";
                        }
                    ...
                    $rslt = mysql_query($stmt, $linkB);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00351', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    while ($i < $amq_conf_ct) {
                        ...
                        $rslt = mysql_query($stmt, $linkB);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00352', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $affected_rows = mysql_affected_rows($linkB);
                        $i++;
                    }
...
if ($ACTION == 'updateDISPO') {
    ...
    if ((strlen($dispo_choice) < 1) || (strlen($lead_id) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00284', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00141', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $retry_count = 0;
        while (($errno > 0) and ($retry_count < 9)) {
            $rslt = mysql_query($stmt, $link);
        ...
        if ($auto_dial_level < 1) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00285', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00142', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        if (strlen($CallBackLeadStatus) > 0) {
            $log_dispo_choice = $CallBackLeadStatus;
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00143', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row = mysql_fetch_row($rslt);
        if ($row[0] > 0) {
            $call_type = 'IN';
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00144', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00286', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row = mysql_fetch_row($rslt);
            $dispo_call_url = $row[0];
        } else {
            ...
            if (($auto_dial_level < 1) or (preg_match('/^M/', $MDnextCID))) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00213', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row = mysql_fetch_row($rslt);
                if ($row[0] > 0) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00145', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                } else {
                    $VLlist_id = '';
                    $VLphone_number = '';
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00217', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00216', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                            ...
                            if ($phone_number == "$row[1]") {
                                ...
                                if ($phone_number != $VLalt_phone) {
                                    if ($phone_number != $VLaddress3) {
                                        ...
                                        $rslt = mysql_query($stmt, $link);
                                        if ($mel > 0) {
                                            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00250', $user, $server_ip, $session_name, $one_mysql_log);
                                        }
                                        $VDAP_cid_ct = mysql_num_rows($rslt);
                                        if ($VDAP_cid_ct > 0) {
                                            $row = mysql_fetch_row($rslt);
                                            ...
                                            $rslt = mysql_query($stmt, $link);
                                            if ($mel > 0) {
                                                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00251', $user, $server_ip, $session_name, $one_mysql_log);
                                            }
                                            $VDAPct_cid_ct = mysql_num_rows($rslt);
                                            if ($VDAPct_cid_ct > 0) {
                                                $row = mysql_fetch_row($rslt);
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00215', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00402', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $affected_rowsX = mysql_affected_rows($link);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00219', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00403', $user, $server_ip, $session_name, $one_mysql_log);
                }
            } else {
        ...
        if (($use_internal_dnc == 'Y') or ($use_campaign_dnc == 'Y')) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00195', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00196', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
        ...
        if (($use_internal_dnc == 'Y') and (eregi("\|$log_dispo_choice\|", $DNC_string_check))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00146', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row = mysql_fetch_row($rslt);
            $stmt = "INSERT IGNORE INTO vicidial_dnc (phone_number) values('$row[0]');";
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00147', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
        ...
        if (($use_campaign_dnc == 'Y') and (eregi("\|$log_dispo_choice\|", $DNC_string_check))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00148', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row = mysql_fetch_row($rslt);
            $stmt = "INSERT IGNORE INTO vicidial_campaign_dnc (phone_number,campaign_id) values('$row[0]','$campaign');";
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00149', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00150', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $VDpr_ct = mysql_num_rows($rslt);
    if ($VDpr_ct > 0) {
        $row = mysql_fetch_row($rslt);
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00151', $user, $server_ip, $session_name, $one_mysql_log);
    }
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00272', $user, $server_ip, $session_name, $one_mysql_log);
    }
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00152', $user, $server_ip, $session_name, $one_mysql_log);
    }
    if ($DB) {
        echo "$stmt\n";
    }
    ...
    if ($auto_dial_level < 1) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00153', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $affected_rows = mysql_affected_rows($link);
        $agent_log_id = mysql_insert_id($link);
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00220', $VD_login, $server_ip, $session_name, $one_mysql_log);
        }
        $VLAaffected_rows_update = mysql_affected_rows($link);
    }

    
    //Limpar callbacks gerais
    $stmt = "UPDATE `vicidial_callbacks` SET `status` = 'INACTIVE' WHERE `recipient`='ANYONE' AND `campaign_id`='$campaign' AND `lead_id` = '$lead_id';";
    ...
    if (($dispo_choice == 'CBHOLD') and (strlen($CallBackDatETimE) > 10)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00154', $user, $server_ip, $session_name, $one_mysql_log);
        }
    }
    ...
    if (strlen($call_notes) > 1) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00372', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00373', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $affected_rows = mysql_affected_rows($link);
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00155', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    ...
    if (($auto_dial_level > 0) and (ereg(" $dispo_choice ", $VC_auto_alt_dial_statuses))) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00156', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row = mysql_fetch_row($rslt);
        ...
        if ($row[0] > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00267', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ((ereg("Y", $use_internal_dnc)) or (ereg("AREACODE", $use_internal_dnc))) {
                ...
                $rslt = mysql_query($stmtA, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00268', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            if ((ereg("Y", $use_campaign_dnc)) or (ereg("AREACODE", $use_campaign_dnc))) {
                ...
                $rslt = mysql_query($stmtA, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmtA, '00269', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
            ...
            if (($UD_DNC_campaign > 0) or ($UD_DNC_internal > 0)) {
                if (((ereg(" DNCC ", $VC_auto_alt_dial_statuses)) and ($UD_DNC_campaign > 0)) or ((ereg(" DNCL ", $VC_auto_alt_dial_statuses)) and ($UD_DNC_internal > 0))) {
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00157', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                }
            } else {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00158', $user, $server_ip, $session_name, $one_mysql_log);
        }
    }
    if (($api_manual_dial == 'QUEUE') or ($api_manual_dial == 'QUEUE_AND_AUTOCALL')) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00363', $user, $server_ip, $session_name, $one_mysql_log);
        }
    }
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00197', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $ss_conf_ct = mysql_num_rows($rslt);
    if ($ss_conf_ct > 0) {
        $row = mysql_fetch_row($rslt);
    ...
    if ($enable_vtiger_integration > 0) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00198', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        if ((ereg('ACCTID', $vtiger_search_category)) or (ereg('ACCOUNT', $vtiger_search_category))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00211', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if ($vs_ct > 0) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00212', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $vs_ct = mysql_num_rows($rslt);
                if ($vs_ct > 0) {
                    $row = mysql_fetch_row($rslt);
            ...
            if (strlen($status_name) < 1) {
                $status_name = $dispo_choice;
            }

            ### connect to your vtiger database
            $linkV = mysql_connect("$vtiger_server_ip", "$vtiger_login", "$vtiger_pass");
            if (!$linkV) {
                die("Could not connect: $vtiger_server_ip|$vtiger_dbname|$vtiger_login|$vtiger_pass" . mysql_error());
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00210', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00199', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row = mysql_fetch_row($rslt);
            $VIDcount = $row[0];
            if ($VIDcount > 0) {
                ...
                if (ereg('DISPO', $vtiger_create_call_record)) {
                    ...
                    $rslt = mysql_query($stmt, $linkV);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00200', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $row = mysql_fetch_row($rslt);
                    $user_id = $row[0];
                    ...
                    if ($vtiger_callback_id > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00213', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        if ($activity_check > 0) {
                            ...
                            $rslt = mysql_query($stmt, $linkV);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00214', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            ...
                            $rslt = mysql_query($stmt, $linkV);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00215', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            $vt_actd_ct = mysql_num_rows($rslt);
                            if ($vt_actd_ct > 0) {
                                $row = mysql_fetch_row($rslt);
                            ...
                            $rslt = mysql_query($stmt, $linkV);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00216', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                            ...
                            $rslt = mysql_query($stmt, $linkV);
                            if ($mel > 0) {
                                mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00217', $user, $server_ip, $session_name, $one_mysql_log);
                            }
                    ...
                    if ($vtiger_callback_modified < 1) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00201', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $row = mysql_fetch_row($rslt);
                        $activityid = ($row[0] + 1);
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00202', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00203', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00204', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00205', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00206', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        if ($DB) {
                            echo "|$leadid|\n";
                        }
                ...
                if (ereg('Y', $vtiger_status_call)) {
                    ...
                    $rslt = mysql_query($stmt, $linkV);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00207', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    $row = mysql_fetch_row($rslt);
                    $user_id = $row[0];
                    ...
                    $rslt = mysql_query($stmt, $linkV);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00208', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "|$leadid|\n";
                    }

                    if ($insert_into_dnc > 0) {
                        $emailoptoutSQL = ", emailoptout='1'";
                    }
                    ...
                    $rslt = mysql_query($stmt, $linkV);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00209', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "|$leadid|\n";
                    }
                    ...
                    $rslt = mysql_query($stmt, $link);
                    if ($mel > 0) {
                        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00287', $user, $server_ip, $session_name, $one_mysql_log);
                    }
                    if ($DB) {
                        echo "$stmt\n";
                    }
                    ...
                    $VT_last_noncontact_update = 0;
                    $VT_last_noncontact_ct = 0;
                    $VT_last_contact_update = 0;
                    $VT_last_contact_ct = 0;
                    $VT_last_sale_update = 0;
                    $VT_last_sale_ct = 0;
                    ...
                    if ($VT_last_sale_update > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00218', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $row = mysql_fetch_row($rslt);
                    ...
                    if ($VT_last_attempt_ct > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00219', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $row = mysql_fetch_row($rslt);
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00223', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                    if ($VT_last_noncontact_ct > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00220', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $row = mysql_fetch_row($rslt);
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00224', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                    if ($VT_last_contact_ct > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00221', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $row = mysql_fetch_row($rslt);
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00225', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                    if ($VT_last_sale_ct > 0) {
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00222', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                        $row = mysql_fetch_row($rslt);
                        ...
                        $rslt = mysql_query($stmt, $linkV);
                        if ($mel > 0) {
                            mysql_error_logging($NOW_TIME, $linkV, $mel, $stmt, '00226', $user, $server_ip, $session_name, $one_mysql_log);
                        }
                    }
                }
            }
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00159', $user, $server_ip, $session_name, $one_mysql_log);
    }
    if ($DB) {
        echo "$stmt\n";
    }
    ...
    if (($enable_queuemetrics_logging > 0) and ((($queuemetrics_callstatus > 0) or ($queuemetrics_callstatus_override == 'YES')) and ($queuemetrics_callstatus_override != 'NO'))) {
        ...
        $rslt = mysql_query($stmt, $linkB);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00160', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $affected_rows = mysql_affected_rows($linkB);
        ...
        $rslt = mysql_query($stmt, $linkB);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00409', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ($QLcomplete_records < 1) {
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00410', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00411', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($QLcomplete_length < 0) {
                $QLcomplete_length = 0;
            }
            if ($QLcomplete_length > 86400) {
                $QLcomplete_length = 1;
            }
            ...
            if (preg_match("/^Y/", $MDnextCID)) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00412', $user, $server_ip, $session_name, $one_mysql_log);
                }
            ...
            $rslt = mysql_query($stmt, $linkB);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00413', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($linkB);
        }
    ...
    if (strlen($dispo_call_url) > 7) {
        ...
        if (eregi('--A--user_custom_', $dispo_call_url)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00288', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VUC_ct = mysql_num_rows($rslt);
            if ($VUC_ct > 0) {
                $row = mysql_fetch_row($rslt);
        ...
        if (eregi('--A--talk_time', $dispo_call_url)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00289', $user, $server_ip, $session_name, $one_mysql_log);
            }
        ...
        if (eregi('--A--dispo_name--B--', $dispo_call_url)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00297', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            if ($vs_name_ct > 0) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00298', $user, $server_ip, $session_name, $one_mysql_log);
                }
        ...
        if (eregi('--A--dialed_', $dispo_call_url)) {
            ...
            if ($call_type == 'OUT') {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00341', $user, $server_ip, $session_name, $one_mysql_log);
                }
        ...
        if (eregi('--A--did_', $dispo_call_url)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00346', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VDIDL_ct = mysql_num_rows($rslt);
            if ($VDIDL_ct > 0) {
                $row = mysql_fetch_row($rslt);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00347', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $VDIDL_ct = mysql_num_rows($rslt);
                if ($VDIDL_ct > 0) {
                    $row = mysql_fetch_row($rslt);
        ...
        if ((eregi('callid--B--', $dispo_call_url)) or (eregi('group--B--', $dispo_call_url))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00348', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VDCL_mvac_ct = mysql_num_rows($rslt);
            if ($VDCL_mvac_ct > 0) {
                $row = mysql_fetch_row($rslt);
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00290', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if (strlen($FORMcustom_field_names) > 2) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00345', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00296', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $ss_conf_ct = mysql_num_rows($rslt);
        if ($ss_conf_ct > 0) {
            $row = mysql_fetch_row($rslt);
        ...
        if (preg_match("/callcard/", $dispo_call_url)) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00317', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($bms_ct > 0) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00318', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $ccl_update = mysql_affected_rows($link);
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00319', $user, $server_ip, $session_name, $one_mysql_log);
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00320', $user, $server_ip, $session_name, $one_mysql_log);
                }
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00311', $user, $server_ip, $session_name, $one_mysql_log);
    }
    if ($DB) {
        echo "$stmt\n";
    }
    ...
    if (($WeBRooTWritablE > 0) and ($enable_agc_dispo_log > 0)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00312', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $VAL_talk_ct = mysql_num_rows($rslt);
        if ($VAL_talk_ct > 0) {
            $row = mysql_fetch_row($rslt);
...
if ($ACTION == 'updateLEAD') {
    ...
    $qquery = "SELECT status FROM vicidial_callbacks WHERE user='$user' AND status='LIVE';";

    $rsl = mysql_query($qquery, $link);

    #echo "ola".$rsl;
    #if (mysql_num_rows($rsl) > 0 ) { echo "Tem CallBacks activos, por favor pause as chamadas, e consulte a sua lista de callbacks.";}

    /* 	for ($i=0;$i<mysql_num_rows($rsl);$i++)
      { $row = mysql_fetch_row($rsl); echo $row[0];
    ...
    if ((strlen($phone_number) < 1) || (strlen($lead_id) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00161', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($DB) {
            echo "$stmt\n";
        }
        ...
        if ((ereg('Y', $disable_alter_custdata)) or (ereg('Y', $disable_alter_custphone))) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00162', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
        ...
        if ($DO_NOT_UPDATE < 1) {
            ...
            $stmt = "UPDATE vicidial_list set phone_number='" . mysql_real_escape_string($phone_number) . "', vendor_lead_code='" . mysql_real_escape_string($vendor_lead_code) . "', title='" . mysql_real_escape_string($title) . "', first_name='" . mysql_real_escape_string($first_name) . "', middle_initial='" . mysql_real_escape_string($middle_initial) . "', last_name='" . mysql_real_escape_string($last_name) . "', address1='" . mysql_real_escape_string($address1) . "', address2='" . mysql_real_escape_string($address2) . "', address3='" . mysql_real_escape_string($address3) . "', city='" . mysql_real_escape_string($city) . "', state='" . mysql_real_escape_string($state) . "', province='" . mysql_real_escape_string($province) . "', postal_code='" . mysql_real_escape_string($postal_code) . "', country_code='" . mysql_real_escape_string($country_code) . "', gender='" . mysql_real_escape_string($gender) . "', date_of_birth='" . mysql_real_escape_string($date_of_birth) . "', alt_phone='" . mysql_real_escape_string($alt_phone) . "', email='" . mysql_real_escape_string($email) . "', security_phrase='" . mysql_real_escape_string($security_phrase) . "', comments='" . mysql_real_escape_string($comments) . "', extra1='" . mysql_real_escape_string($extra1) . "', extra2='" . mysql_real_escape_string($extra2) . "', extra3='" . mysql_real_escape_string($extra3) . "', extra4='" . mysql_real_escape_string($extra4) . "', extra5='" . mysql_real_escape_string($extra5) . "', extra6='" . mysql_real_escape_string($extra6) . "', extra7='" . mysql_real_escape_string($extra7) . "', extra8='" . mysql_real_escape_string($extra8) . "', extra9='" . mysql_real_escape_string($extra9) . "', extra10='" . mysql_real_escape_string($extra10) . "', extra11='" . mysql_real_escape_string($extra11) . "', extra12='" . mysql_real_escape_string($extra12) . "', extra13='" . mysql_real_escape_string($extra13) . "', extra14='" . mysql_real_escape_string($extra14) . "', extra15='" . mysql_real_escape_string($extra15) . "' $phoneSQL where lead_id='$lead_id';";
            if ($format == 'debug') {
                echo "\n<!-- $stmt -->";
            }
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00163', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00164', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $retry_count = 0;
        while (($errno > 0) and ($retry_count < 9)) {
            $rslt = mysql_query($stmt, $link);
    ...
    $check_query = "SELECT last_local_call_time FROM vicidial_list WHERE lead_id='$lead_id'";
    $check_query = mysql_query($check_query);
    $qResult = mysql_fetch_row($check_query);
    if ($qResult[0] == null || $qResult[0] == '') {
        $query = "UPDATE vicidial_list SET last_local_call_time=entry_date WHERE lead_id='$lead_id'";
...
if (($ACTION == 'VDADpause') || ($ACTION == 'VDADready')) {
    ...
    if ((strlen($stage) < 2) || (strlen($server_ip) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00165', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $retry_count = 0;
        while (($errno > 0) and ($retry_count < 9)) {
            $rslt = mysql_query($stmt, $link);
        ...
        if ($comments != 'NO_STATUS_CHANGE') {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                $errno = mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00166', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $retry_count = 0;
            while (($errno > 0) and ($retry_count < 9)) {
                $rslt = mysql_query($stmt, $link);
        ...
        if (($affected_rows > 0) or ($comments == 'NO_STATUS_CHANGE')) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00167', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            ###########################################
            if ($enable_queuemetrics_logging > 0) {
                if ((ereg('READY', $stage)) or (ereg('CLOSER', $stage))) {
                    $QMstatus = 'UNPAUSEALL';
                }
                if (ereg('PAUSE', $stage)) {
                    $QMstatus = 'PAUSEALL';
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00182', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00395', $user, $server_ip, $session_name, $one_mysql_log);
                }
                if ($DB) {
                    echo "$stmt\n";
                }
                ...
                $rslt = mysql_query($stmt, $linkB);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00168', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rows = mysql_affected_rows($linkB);
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00169', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $VDpr_ct = mysql_num_rows($rslt);
        if ($VDpr_ct > 0) {
            $row = mysql_fetch_row($rslt);
        ...
        if ($ACTION == 'VDADready') {
            if ((eregi("NULL", $dispo_epoch)) or ($dispo_epoch < 1000)) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00170', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
        }
        if ($ACTION == 'VDADpause') {
            if ((eregi("NULL", $dispo_epoch)) or ($dispo_epoch < 1000)) {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00171', $user, $server_ip, $session_name, $one_mysql_log);
                }
            }
        ...
        if ($wrapup == 'WRAPUP') {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00194', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
        ...
        if ($agent_log == 'NEW_ID') {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00221', $VD_login, $server_ip, $session_name, $one_mysql_log);
            }
            $VLAaffected_rows_update = mysql_affected_rows($link);
        }
    }
...
if ($ACTION == 'UpdatEFavoritEs') {
    ...
    if ((strlen($favorites_list) < 1) || (strlen($user) < 1) || (strlen($exten) < 1)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00172', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row = mysql_fetch_row($rslt);
        ...
        if ($row[0] > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00173', $user, $server_ip, $session_name, $one_mysql_log);
            }
        } else {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00174', $user, $server_ip, $session_name, $one_mysql_log);
            }
        }
    }
...
if ($ACTION == 'PauseCodeSubmit') {
    ...
    if ((strlen($status) < 1) || (strlen($agent_log_id) < 1)) {
        ...
        if ($stage < 1) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00175', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($link);
        }
        ### this is not the first pause code entry, insert new vicidial_agent_log entry
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00306', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $VDpr_ct = mysql_num_rows($rslt);
            if ($VDpr_ct > 0) {
                $row = mysql_fetch_row($rslt);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00307', $user, $server_ip, $session_name, $one_mysql_log);
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00308', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00309', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $affected_rows = mysql_affected_rows($link);
            $agent_log_id = mysql_insert_id($link);
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00310', $VD_login, $server_ip, $session_name, $one_mysql_log);
            }
            $VLAaffected_rows_update = mysql_affected_rows($link);
        }
        ...
        if ($affected_rows > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00176', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($DB) {
                echo "$stmt\n";
            }
            ...
            if ($enable_queuemetrics_logging > 0) {
                $pause_call_id = 'NONE';
                if (strlen($campaign_cid) > 12) {
                    $pause_call_id = $campaign_cid;
                }
                $linkB = mysql_connect("$queuemetrics_server_ip", "$queuemetrics_login", "$queuemetrics_pass");
                mysql_select_db("$queuemetrics_dbname", $linkB);
                ...
                $rslt = mysql_query($stmt, $linkB);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $linkB, $mel, $stmt, '00177', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rows = mysql_affected_rows($linkB);
...
if ($ACTION == 'AGENTSview') {
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00225', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    $VU_user_group = $row[0];
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00226', $VD_login, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    ...
    $agentviewlistSQL = '';
    $j = 0;
    $stmt = "SELECT vla.user,vla.status,vu.full_name,UNIX_TIMESTAMP(last_call_time),UNIX_TIMESTAMP(last_call_finish) from vicidial_live_agents vla inner join vicidial_users vu on vla.user=vu.user $AGENTviewSQL order by vu.full_name;";
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00227', $VD_login, $server_ip, $session_name, $one_mysql_log);
    }
    if ($rslt) {
        $agents_count = mysql_num_rows($rslt);
    }
    $colegas["colegas"] = array();
    $colegas["view_time"] = $agent_status_view_time;
    while ($row = mysql_fetch_row($rslt)) {
        ...
        if ($comments == 'AgentXferViewSelect') {
            ...
            $colegas["colegas"][] = array("color" => $statuscolor, "user" => $user, "name" => $full_name, "time" => $call_time);
        }
    }
    ...
    if (ereg("NOT-LOGGED-IN-AGENTS", $agent_status_viewable_groups)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00301', $VD_login, $server_ip, $session_name, $one_mysql_log);
        }
        if ($rslt) {
            $agents_count = mysql_num_rows($rslt);
        }
        while ($row = mysql_fetch_row($rslt)) {
            ...
            if ($comments == 'AgentXferViewSelect') {
                ...
                $colegas["colegas"][] = array("color" => "", "user" => $user, "name" => $full_name, "time" => "0");
            }
        }
    }
    ...
    if ($comments == 'AgentXferViewSelect') {
        ...
        while ($j > $k) {
            ...
            echo "<TR BGCOLOR=\"$AXVSstatuscolor[$i]\"><TD><font style=\"font-size: $AXVSfontsize; \"> &nbsp; <a href=\"#\" onclick=\"AgentsXferSelect('$AXVSuser[$i]','AgentXferViewSelect');return false;\">$AXVSuser[$i] - $AXVSfull_name[$i]</a></font></TD>";
            if ($agent_status_view_time > 0) {
                echo "<TD><font style=\"font-size: $AXVSfontsize;  \">&nbsp; $AXVScall_time[$i] &nbsp;</font></TD>";
            }
            echo "</TR>";
    ...
    //echo "<font style=\"font-size:10px;\"><font style=\"background-color:#ADD8E6;\"> &nbsp; &nbsp;</font>-READY &nbsp; <font style=\"background-color:#D8BFD8;\">&nbsp; &nbsp;</font>-INCALL &nbsp; <font style=\"background-color:#F0E68C;\"> &nbsp; &nbsp;</font>-PAUSED &nbsp;\n";
    //if (ereg("NOT-LOGGED-IN-AGENTS", $agent_status_viewable_groups)) {echo "<font style=\"background-color:#FFFFFF;\"> &nbsp; &nbsp;</font>-LOGGED-OUT &nbsp;\n";}
}
...
if ($ACTION == 'CALLSINQUEUEview') {
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00228', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    ...
    if (eregi('NONE', $view_calls_in_queue)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00229', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $row = mysql_fetch_row($rslt);
        $Alogin = $row[0];
        $Acampaign = $row[1];
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00230', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($rslt) {
            $calls_count = mysql_num_rows($rslt);
        }
        $loop_count = 0;
        ...
        while (($calls_count > $loop_count) and ($view_calls_in_queue > $loop_count)) {
            ...
            if ($OQcall_type[$loop_count] == 'IN') {
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00231', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $row = mysql_fetch_row($rslt);
                $group_name = $row[0];
                $group_color = $row[1];
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00232', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $row = mysql_fetch_row($rslt);
            $comments = $row[0];
            $agent = $row[1];
            ...
            if ($rslt) {
                $agent_name_count = mysql_num_rows($rslt);
            }
            ...
            if (strlen($caller_name) > 30) {
                $caller_name = substr("$caller_name", 0, 30);
            }

            if (eregi("0$|2$|4$|6$|8$", $loop_count)) {
                $Qcolor = 'bgcolor="#FCFCFC"';
            } else {
                $Qcolor = 'bgcolor="#ECECEC"';
            }
            ...
            if ((eregi('Y', $grab_calls_in_queue)) and ($OQcall_type[$loop_count] == 'IN')) {
                /* echo "<TR $Qcolor>";
                  ...
                  echo "</TR>"; */
                $inbound_queue[] = array("phone" => $OQphone_number[$loop_count], "name" => $caller_name, "time" => $call_time, "call_id" => $OQauto_call_id[$loop_count]);
            } else {
                /* echo "<TR $Qcolor>";
                  echo "<TD> &nbsp; </TD>";
                  echo "<TD><font style=\"font-size: 11px; font-family: sans-serif;\"> &nbsp; $OQphone_number[$loop_count] &nbsp; </font></TD>";
        ...
        //echo "</TABLE><BR> &nbsp;\n";
        echo json_encode($inbound_queue);
    }
}
...
if ($ACTION == 'CALLLOGview') {
    ...
    while ($g > $u) {
        ...
        echo "<td align=right>$ALLcall_date[$i]</td>";
        echo "<td align=right> $ALLlength_in_sec[$i]</td>\n";
        echo "<td align=right> $ALLstatus[$i]</td>\n";
        echo "<td align=right> $ALLphone_code[$i] $ALLphone_number[$i] </td>\n";
        echo "<td align=right> $Allfirst_name[$i] $Alllast_name[$i] </td>\n";
        echo "<td align=right> $ALLcampaign_id[$i] </td>\n";
        echo "<td align=right> $ALLin_out[$i] </td>\n";
        echo "<td align=right> $ALLalt_dial[$i] </td>\n";
        echo "<td align=right> $ALLhangup_reason[$i] </td>\n";
        echo "<td align=right> <a href=\"#\" onclick=\"VieWLeaDInfO($ALLlead_id[$i]);return false;\">INFO</A> </td>\n";
        echo "<td align=right> <a href=\"#\" onclick=\"NeWManuaLDiaLCalL('CALLLOG','$ALLphone_code[$i]','$ALLphone_number[$i]','$ALLlead_id[$i]');return false;\">DIAL</A> </td>\n";
        echo "</tr>\n";
    }
...
if ($ACTION == 'SEARCHRESULTSview') {
    ...
    if (strlen($search_query) < 1) {
        $js["error"][] = "O campo de pesquisa não pode estar vazio.";
        exit;
    }
    ...
    if (preg_match('/CAMPLISTS_ALL/', $agent_lead_search_method)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00375', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $lists_to_parse = mysql_num_rows($rslt);
        $camp_lists = '';
        $o = 0;
    ...
    if (preg_match('/CAMPAIGNLISTS/', $agent_lead_search_method)) {
        ...
        $rslt = mysql_query($stmt, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00376', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $lists_to_parse = mysql_num_rows($rslt);
        $camp_lists = '';
        $o = 0;
    ...
    if ($is_cloud == 1) {
        ...
        if (preg_match("/-ALL-CAMPAIGNS-/i", $allowed_camp)) {
            ...
            $allowed_camp = " AND campaign_id IN (" . rtrim($allowed_camp, ",") . ") ";
        }
    }
    ...
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00377', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $search_log_id = mysql_insert_id($link);

    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00378', $user, $server_ip, $session_name, $one_mysql_log);
    }
    ...
    if ($counts_to_print > 0) {
        ...
        $rslt = mysql_query($stmtL, $link);
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00379', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        if ($search_result_count) {
            ...
            if (!mysql_num_rows($rslt)) {
                $js["error"][] = "Não foram encontrados resultados.";
                echo json_encode($js);
                exit;
            }
            ...
            $rslt = mysql_query($stmtL, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00381', $user, $server_ip, $session_name, $one_mysql_log);
            }
        ...
        $js["error"][] = " Ouve um erro com a sua pesquisa.";
        echo json_encode($js);
        exit;
    }
}
...
if ($ACTION == 'LEADINFOview') {
    if (strlen($lead_id) < 1) {
        ...
        if (strlen($callback_id) > 0) {
            $stmt = "select a.status,entry_time,callback_time,modify_date,user,recipient,comments,b.status_name from vicidial_callbacks a inner join (Select status, status_name from vicidial_statuses union all select status,status_name from vicidial_campaign_statuses group by status) b on a.lead_status=b.status where lead_id='$lead_id' and callback_id='$callback_id' limit 1;";
            $rslt = mysql_query($stmt, $link) or die(mysql_error());
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00397', $user, $server_ip, $session_name, $one_mysql_log);
            }
            $cb_to_print = mysql_num_rows($rslt);
            if ($format == 'debug') {
                echo "|$cb_to_print|$stmt|";
            }
            if ($row = mysql_fetch_assoc($rslt)) {
                $cb_status = array(
                    "status" => $row["status"],
                    "entry_time" => $row["entry_time"],
                    "lead_status" => $row["status_name"],
        ...
        $stmt = "SELECT NAME,DISPLAY_NAME,READONLY,ACTIVE FROM `vicidial_list_ref` WHERE campaign_id='$campaign' ORDER BY field_order asc";
        $rslt = mysql_query($stmt, $link) or die(mysql_error());
        $fields_order = array();
        while ($row = mysql_fetch_assoc($rslt)) {
            $fields_order[] = array(
                ...
                "active" => $row['ACTIVE'] == 1,
                "readonly" => ($row['READONLY'] == 1 ? "readonly" : ""),
                "display" => $row['DISPLAY_NAME']);
        }

        $stmt = "select status,vendor_lead_code,list_id,gmt_offset_now,called_since_last_reset,phone_code,phone_number,title,first_name,middle_initial,last_name,address1,address2,address3,city,state,province,postal_code,country_code,gender,alt_phone,email,security_phrase,comments,called_count,last_local_call_time,rank,owner,entry_list_id,extra1,extra2,extra3,extra4,extra5,extra6,extra7,extra8,extra9,extra10,extra11,extra12,extra13,extra14,extra15 from vicidial_list where lead_id='$lead_id' limit 1;";
        $rslt = mysql_query($stmt, $link) or die(mysql_error());
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00398', $user, $server_ip, $session_name, $one_mysql_log);
        }
        $info_to_print = mysql_num_rows($rslt);
        if ($format == 'debug') {
            $INFOout .= "|$out_logs_to_print|$stmt|";
        }

        $row = mysql_fetch_assoc($rslt);
        $lead_info = array();
        for ($i = 0; $i < count($fields_order); $i++) {
            if ($fields_order[$i]["active"]) {
                $lead_info[] = array("name" => $fields_order[$i]["display"], "value" => $row[$fields_order[$i]["name"]]);
            }
        }
        ...
        $stmt = "select call_date,campaign_name,length_in_sec,status_name,phone_number,lead_id,term_reason,uniqueid,full_name,comments from vicidial_log a inner join (Select status, status_name from vicidial_statuses union all select status,status_name from vicidial_campaign_statuses group by status) b on a.status=b.status inner join vicidial_users c on a.user=c.user inner join vicidial_campaigns d on a.campaign_id=d.campaign_id where lead_id='$lead_id' order by call_date desc limit 10000";
        $rslt = mysql_query($stmt, $link) or die(mysql_error());
        $out_logs_to_print = mysql_num_rows($rslt);
        if ($format == 'debug') {
        ...
        while ($row = mysql_fetch_assoc($rslt)) {
            $lead_log[] = array(
                ...
                "lead_id" => $row[lead_id],
                "term_reason" => ucwords(strtolower($row[term_reason])),
                "unique_id" => $row[uniqueid],
                "user" => $row[full_name],
                "io" => ucwords(strtolower($row[comments])));
            ...
            /* $stmtA = "SELECT call_notes FROM vicidial_call_notes WHERE lead_id='$ALLlead_id[$g]' and vicidial_id='$ALLuniqueid[$g]';";
              ...
              if (strlen($Allcall_notes[$g]) > 0) {$Allcall_notes[$g] = "<b>NOTES: </b> $Allcall_notes[$g]";
              }
              } */
        }

        $stmt = "select call_date,group_name,length_in_sec,status_name,phone_number,lead_id,term_reason,queue_seconds,uniqueid from vicidial_closer_log a inner join (Select status, status_name from vicidial_statuses union all select status,status_name from vicidial_campaign_statuses group by status) b on a.status=b.status inner join vicidial_users c on a.user=c.user inner join vicidial_inbound_groups d on a.campaign_id=d.group_id where lead_id='$lead_id' order by call_date desc limit 10000";
        $rslt = mysql_query($stmt, $link);
        $in_logs_to_print = mysql_num_rows($rslt);
        if ($format == 'debug') {
        ...
        while ($row = mysql_fetch_assoc($rslt)) {
            $lead_log[] = array(
                "call_date" => $row[call_date],
                "campaign" => $row[group_name],
                "length" => (($row[length_in_sec] - $row[queue_seconds]) < 0) ? 0 : ($row[length_in_sec] - $row[queue_seconds]),
                "status" => $row[status_name],
                "phone_number" => $row[phone_number],
                "lead_id" => $row[lead_id],
                "term_reason" => ucwords(strtolower($row[term_reason])),
        ...
        echo json_encode(array("callback_info" => $cb_status, "lead_info" => $lead_info, "lead_log" => $lead_log));
    }
}
...
if ($ACTION == 'CALLSINQUEUEgrab') {
    $js = array("error" => array(), "success" => array());
    $stmt = "SELECT view_calls_in_queue,grab_calls_in_queue from vicidial_campaigns where campaign_id='$campaign'";
    if ($non_latin > 0) {
        $rslt = mysql_query("SET NAMES 'UTF8'") OR die(mysql_error());
    }
    $rslt = mysql_query($stmt, $link) OR die(mysql_error());
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00233', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    $view_calls_in_queue = $row[0];
    $grab_calls_in_queue = $row[1];
    ...
    if ((eregi('NONE', $view_calls_in_queue)) or (eregi('N', $grab_calls_in_queue))) {
        $js["error"][] = "Calls in Queue View Disabled for this campaign";
        echo json_encode($js);
        exit;
    } else {
        ...
        $rslt = mysql_query($stmtU, $link) OR die(mysql_error());
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00234', $user, $server_ip, $session_name, $one_mysql_log);
        }
        ...
        if ($VACaffected_rows > 0) {
            ...
            $rslt = mysql_query($stmt, $link);
            if ($mel > 0) {
                mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00270', $user, $server_ip, $session_name, $one_mysql_log);
            }
            if ($rslt) {
                $vac_count = mysql_num_rows($rslt);
            }
            if ($vac_count > 0) {
                $row = mysql_fetch_row($rslt);
                $GCcall_time = $row[0];
                ...
                $rslt = mysql_query($stmt, $link);
                if ($mel > 0) {
                    mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00271', $user, $server_ip, $session_name, $one_mysql_log);
                }
                $affected_rows = mysql_affected_rows($link);
            }

            $js["success"][] = "Call $stage grabbed for $user";
            echo json_encode($js);
        } else {
            $js["error"][] = "Call $stage could not be grabbed for $user";
            echo json_encode($js);
        }

        $stmtD = "SELECT * from vicidial_auto_calls where auto_call_id='$stage';";
        $rslt = mysql_query($stmtD, $link) OR die(mysql_error());
        if ($mel > 0) {
            mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00321', $user, $server_ip, $session_name, $one_mysql_log);
        }
        if ($rslt) {
            $DEBUGvac_count = mysql_num_rows($rslt);
        }
        if ($DEBUGvac_count > 0) {
            $row = mysql_fetch_row($rslt);
            if ($WeBRooTWritablE > 0) {
...
if ($ACTION == 'CalLBacKLisT') {
    if ($agentonly_callback_campaign_lock > 0) {
        $campaignCBsql = "and a.campaign_id='$campaign'";
    } else {
        $campaignCBsql = '';
    }

    if (strtotime($cb_date_1) AND strtotime($cb_date_2)) {
        $cb_date = " and `callback_time` between '" . mysql_real_escape_string($cb_date_1) . "' AND '" . mysql_real_escape_string($cb_date_2) . "'  + Interval 1 DAY   ";
    } elseif (strtotime($cb_date_1) AND !strtotime($cb_date_2)) {
        $cb_date = " and `callback_time` >= '" . mysql_real_escape_string($cb_date_1) . "' ";
    } elseif (!strtotime($cb_date_1) AND strtotime($cb_date_2)) {
        $cb_date = " and `callback_time` <= '" . mysql_real_escape_string($cb_date_2) . "' ";
    } else {
    ...
    if ($rslt) {
        $callbacks_count = mysql_num_rows($rslt);
    }
    ...
    while ($callbacks_count > $loop_count) {
        ...
        $row = mysql_fetch_row($rslt);
        //$comentario=str_replace(PHP_EOL,' ',$comments[$loop_count]);
        $comentario = (strlen($comments[$loop_count]) > 53) ? substr($comments[$loop_count], 0, 50) . '...' : $comments[$loop_count];
        switch ($status[$loop_count]) {
            case "ACTIVE":
                $estado = "Activo";
                break;
            case "LIVE":
            ...
            case "INACTIVE":
                ...
                break;
            default:
                $estado = $status[$loop_count];
                break;
        }


        $callback[] = array("name" => $row[0] . " " . $row[1], "phone" => $row[2], "callback_id" => $callback_id[$loop_count], "lead_id" => $lead_id[$loop_count], "campaign_id" => $campaign_id[$loop_count], "status" => $estado, "entry_time" => date("c", strtotime($entry_time[$loop_count])), "callback_time" => date("c", strtotime($callback_time[$loop_count])), "comment" => $comentario);
        $loop_count++;
    }
...
if ($ACTION == 'CalLBacKCounT') {
    ...
    $rslt = mysql_query($stmt, $link) OR die(mysql_error());
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00180', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    $cbcount = $row[0];
    ...
    $rslt = mysql_query($stmt, $link) OR die(mysql_error());
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00332', $user, $server_ip, $session_name, $one_mysql_log);
    }
    $row = mysql_fetch_row($rslt);
    $cbcount_live = $row[0];

    echo json_encode(array("expired" => $cbcount, "live" => $cbcount_live));
}
...
if ($ACTION == 'customer_3way_hangup_process') {
    ...
    $rslt = mysql_query($stmt, $link) OR die(mysql_error());
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00342', $user, $server_ip, $session_name, $one_mysql_log);
    }
...
if ($ACTION == 'DiaLableLeaDsCounT') {
    ...
    $rslt = mysql_query($stmt, $link) OR die(mysql_error());
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00252', $user, $server_ip, $session_name, $one_mysql_log);
    }
    if ($rslt) {
        $dialable_count = mysql_num_rows($rslt);
    }
    if ($dialable_count > 0) {
        $row = mysql_fetch_row($rslt);
        $DLcount = $row[0];
    ...
    echo json_encode(array("count" => $DLcount));
}

################################################################################
### apaga callback
################################################################################
if ($ACTION == 'apagacallback') {

    $query = "SELECT a.lead_id,b.phone_number FROM vicidial_callbacks a INNER JOIN vicidial_list b ON a.lead_id=b.lead_id WHERE callback_id='$cb_id'";
    $rslt = mysql_query($query, $link) OR die(mysql_error());
    $row = mysql_fetch_row($rslt);
    $temp_LEAD = $row[0];
    $phone = $row[1];

    $query = "SELECT lead_id FROM vicidial_callbacks WHERE lead_id='$temp_LEAD' AND status!='INACTIVE'";
    $rslt = mysql_query($query, $link) OR die(mysql_error());
    ...
    $stmt = "INSERT INTO vicidial_log (uniqueid,lead_id,list_id,campaign_id,call_date,start_epoch,status,phone_code,phone_number,user,comments,processed,user_group) values('" . date('U') . "." . rand(0, 255) . "','$temp_LEAD','$row[1]','$campaign','$NOW_TIME','','CBDEL','','$phone','$user','ELIMINADO','N','$user_group');";
    $stmt = mysql_query($stmt, $link) OR die(mysql_error());


    $qquery = "UPDATE vicidial_callbacks SET status='INACTIVE' WHERE callback_id='$cb_id';";
    $rslt = mysql_query($qquery, $link) OR die(mysql_error());
...
### check force ready
################################################################################
if ($ACTION == 'forcereadycheck') {
    $query = "select user from sips_forceready_control where user='$user'";
    $query = mysql_query($query, $link) OR die(mysql_error());
    $row = mysql_fetch_row($query);

    if (mysql_num_rows($query) > 0) {

        $query = "delete from sips_forceready_control where user='$user'";
        $query = mysql_query($query, $link);
        echo 'force';
    }
}
################################################################################
### Vai buscar o tempo de pausa dos operadores
################################################################################
...
################################################################################
### Verificação de Campos Dinamicos REQUIRED
################################################################################
if ($ACTION == 'custom_required') {
    $active_camp = $_POST['current_campaign'];
    $query = mysql_query("SELECT field_label, field_type FROM vicidial_lists_fields WHERE campaign_id='$active_camp' AND field_type NOT IN('SCRIPT', 'DISPLAY') AND field_required='Y'", $link) or die(mysql_error());
    #echo "SELECT field_label, field_type FROM vicidial_lists_fields WHERE campaign_id='$active_camp' AND field_type NOT IN('SCRIPT', 'DISPLAY') AND field_required='Y'";
    for ($i = 0; $i < mysql_num_rows($query); $i++) {
        $row = mysql_fetch_assoc($query);

        if ($i == mysql_num_rows($query) - 1) {
            echo "$row[field_label]---$row[field_type]";
        } else {
            echo "$row[field_label]---$row[field_type]\n";
        }
    }
...
if ($ACTION == 'pesquisa_morada') {
    ...
    $cp_4 = ereg_replace("[^0-9]", "", $cp_4);
    $cp_3 = ereg_replace("[^0-9]", "", $cp_3);

    $cp_4 = (strlen($cp_4) < 4) ? "%$cp_4%" : $cp_4;
    $cp_3 = (strlen($cp_3) < 3) ? "%$cp_3%" : $cp_3;


    $rsl = mysql_query("SELECT * FROM `cp7` WHERE `cod_postal` LIKE '$cp_4-$cp_3' Limit 250;", $link);

    $js = array();
    while ($linha = mysql_fetch_assoc($rsl)) {
        $js[] = array("rua" => $linha[rua], "cod_postal" => $linha[cod_postal], "localidade" => $linha[localidade], "conselho" => $linha[concelho], "distrito" => $linha[distrito]);
    }
    echo json_encode($js);
}
################################################################################
...
if ($ACTION == 'Clear_API_Field') {
    ...
    $rslt = mysql_query($stmt, $link);
    if ($mel > 0) {
        mysql_error_logging($NOW_TIME, $link, $mel, $stmt, '00343', $user, $server_ip, $session_name, $one_mysql_log);
    }
