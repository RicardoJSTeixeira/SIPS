...
function OnZoiperReady(phone)
	...
	Account.Domain = "sipsps.dyndns.org";
	Account.Host = "sipsps.dyndns.org";
	...
	Zoiper.UseAccount("SIPS");

	var Contact         = Zoiper.AddContact("SIPS CC");
	Contact.Account     = "SIPS";
...
<div id="supportedBrowsersScreen" style="display:block;">	   
		...
		<object id="ZoiperA" classid="clsid:BCCA9B64-41B3-4A20-8D8B-E69FE61F1F8B" align="center" width="434" height="236" CODEBASE="http://sipsps.dyndns.org/sips-agente/InstallerWeb.cab#Version=1,17,0,6802">
