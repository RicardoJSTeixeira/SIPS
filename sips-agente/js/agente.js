...
function nc_log() {
    ...
    $.post("/client_files/acusticamedica/novocliente/nc_log.php", {inOUT: inOUT_hack, agent_log_id: agent_log_id, lead_id: nc_live_id, lead_id_o: lead_id_hack}, function(data) {
        console.log(data);
    });
}
// ################################################################################
...
function reactive_last_callback()
{
    $.post('vdc_db_query.php', {
        ...
        ultimo_callback: ultimo_callback}, function() {
        ultimo_callback = 0;
    });
}
...
$(document).on("click", "#validar_chamada_button", function()
{
    ...
    $.post("ajax/confirm_feedback.php", {action: "validate_call", lead_id: $(this).data("lead_id"), comment: $("#vc_comment").val(), user: user, campaign: campaign},
    function(data)
    {
