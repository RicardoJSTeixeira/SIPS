...
if ( ($stage == 'login') or ($stage == 'logout') )
	...
	if ($valid_user < 1)
		...
		$VDdisplayMESSAGE = "The user and password you entered<BR>are not active in the system<BR>Please try again:";

		echo"<HTML><HEAD>\n";
		echo"<TITLE>GoAutoDial - Agent Timeclock</TITLE>\n";
		...
		echo "<TABLE WIDTH=460 CELLPADDING=0 CELLSPACING=0>\n";
		...
		echo "<TR><TD ALIGN=CENTER COLSPAN=2><font size=1><BR>VICIDIAL VERSION: $version &nbsp; &nbsp; &nbsp; BUILD: $build</TD></TR>\n";
		echo "</TABLE>\n";
		echo "</FORM>\n\n";
		...
		if ( ($last_action_sec < 30) and ($status != 'START') )
			...
			$VDdisplayMESSAGE = "You cannot log in or out within 30 seconds<br>of your last login or logout";
