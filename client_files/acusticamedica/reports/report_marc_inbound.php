            ...
            <div class="cc-mstyle">	
                <table>
                    <tr>
                        ...
                        <td id='submenu-title'> Report Marcações e Novos Clientes Inbound </td>
                        <td style="text-align:right">Obter Report</td>
                        <td id='icon32'><input type="image" src='/images/icons/document_export_32.png'/><input type="hidden" id="report_marc_inbound" name="report_marc_inbound" value="1" /></td>
                    </tr>
                </table>
            </div>
