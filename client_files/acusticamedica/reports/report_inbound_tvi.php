...
##################################################
        ...
        $query = "SELECT did_id,did_description FROM vicidial_inbound_dids WHERE did_id in ('5','6','113','114')";
        ...
        for ($i = 0; $i < $num_camps; $i++) {
            ...
            $camp_options .= "<option value=$row[did_id]>$row[did_description]</option>";
        }
##################################################
        ?>
    </head>
            ...
            <div class="cc-mstyle">	
                <table>
                    <tr>
                        ...
                        <td id='submenu-title'> Report Resumo Inbound </td>
                        <td style="text-align:right">Obter Report</td>
                        <td id='icon32'><input type="image" src='/images/icons/document_export_32.png'/><input type="hidden" name="report_inbound_tvi" value="1" /></td>
                    </tr>
                </table>
            </div>
            ...
            <div id="work-area" style="min-height:0px"><br><br>
                        <div class=cc-mstyle style="border:none">
                            <table>
                                ...
                                <tr> 
                                    <td>Linhas:</td><td><select name="camp_options[]" id="camp_options[]" multiple style="height:100px;width:250px" ><?php echo $camp_options; ?></select></td>	
                                </tr>
