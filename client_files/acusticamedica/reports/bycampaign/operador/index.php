    ...
    <div class="cc-mstyle">    
        <table>
            <tr>
                ...
                <td id='submenu-title'> Feedbacks por Operador </td>
                <td></td>
            </tr>
        </table>
    </div>
    ...
    <br><br>
        ...
        <div class=cc-mstyle style="border:none;">
            <table border=0>
                ...
                <tr style="height:32px"><td></td><td style="text-align:center"><div style="width:212px; border-top:1px dotted gray"></div></td><td></td><td style="text-align:center"></tr>
                <tr><td></td><td style="text-align:left; padding-left:6px"><b>Campanha</b></td><td></td><td style="text-align:left; padding-left:6px"><b>Opções</b></td></tr>
                <tr><td></td><td style="text-align:left"><select name="camp_options[]" id="camp_options[]" style="height:260px; width:212px;" multiple><option onclick="SelectAll('camp_options[]');">Todas as Campanhas</option><?php echo $camp_options; ?></select></td><td></td><td valign="top" style="text-align:left"><br><input type="checkbox" checked="checked" name="group_camps" value="lol">&nbsp; Agrupar Campanhas<br><input type="checkbox" checked="checked" name="active_agents" value="lol">&nbsp; Apenas Operadores Activos</td></tr>
