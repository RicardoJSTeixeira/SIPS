...
<body>
<form name="totais_db" action="exportcsv_fc.php" method="post">
<input type="hidden" value="go" name="resumo_geral_db">
<div class="cc-mstyle">	
<table>
<tr>
<td id='icon32'><img src='/images/icons/document_inspector_32.png' /></td>
<td id='submenu-title'> Resumo Geral por Base de Dados  </td>
...
<tr>
<td>Base de Dados:</td><td><select name="db_options[]" multiple="multiple" id="db_options" style="width:202px; height:150px;"><?php echo $list_options; ?></select></td>	
</tr>
</table> 
</form>	
<br><br>
