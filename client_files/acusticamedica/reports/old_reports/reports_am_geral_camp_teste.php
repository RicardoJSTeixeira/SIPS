...
<input type="hidden" value='go' name="geral_camp_teste">
<div class="cc-mstyle">	
<table>
<tr>
<td id='icon32'><img src='/images/icons/document_inspector_32.png' /></td>
<td id='submenu-title'> Report Geral AM por Campanha </td>
...
<tr> 
<td>Campanha:</td><td><select name="camp_options[]" id="camp_options[]" style="height:95px; width:200px;" multiple><option onclick="SelectAll('camp_options[]');">Todas as Campanhas</option><?php echo $camp_options; ?></select></td>	
</tr>
<tr>
