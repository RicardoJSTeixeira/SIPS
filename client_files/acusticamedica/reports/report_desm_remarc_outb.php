...
$query = "	SELECT 	campaign_id, campaign_name 
			FROM 	vicidial_campaigns WHERE campaign_id IN ($AllowedCampaigns) and active='Y'";
...
<td id='submenu-title'> Report Desmarcações e Remarcações Outbound </td>
<td style="text-align:right">Obter Report</td>
<td id='icon32'><input type="image" src='/images/icons/document_export_32.png'/><input type="hidden" id="report_desm_remarc_outb" name="report_desm_remarc_outb" value="1" /></td>
</tr>
</table>
</div>
