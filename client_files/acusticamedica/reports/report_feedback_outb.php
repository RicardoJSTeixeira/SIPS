...
$query = "	SELECT 	campaign_id, campaign_name 
			FROM 	vicidial_campaigns WHERE active='Y' AND campaign_id IN ($AllowedCampaigns) order by campaign_name ASC";
...
<td id='submenu-title'> Report Outbound por Feedback </td>
<td style="text-align:right">Obter Report</td>
<td id='icon32'><input type="image" src='/images/icons/document_export_32.png'/><input type="hidden" id="report_feedback_outbound" name="report_feedback_outbound" value="1" /></td>
</tr>
</table>
</div>
...
<tr> 
<td>Campanhas:</td><td><select name="camp_options[]" id="camp_options[]" multiple style="height:150px;width:250px" ><?php echo $camp_options; ?></select></td>	
</tr>
