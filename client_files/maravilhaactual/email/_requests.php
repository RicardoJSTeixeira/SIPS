...
if($action=="send_email")
{
    ...
    $message->setBody('
       ...
       <span style="font-size:14px; font-family:Calibri;"> Exmo(a). Senhor(a), <br><br>
        ...
        <a href="mailto:parceiro@exemplyrigor.com">parceiro@exemplyrigor.com</a> <br>

        <span style="font-size:11px; font-family:Arial;"><b><font color="#404040">Tel/Fax: &nbsp;&nbsp;&nbsp;&nbsp; +351 211 381 779 &nbsp;&nbsp;&nbsp;&nbsp; Tel: &nbsp;&nbsp;&nbsp;&nbsp; +351 910 456 970 </font></b></span> <br>
