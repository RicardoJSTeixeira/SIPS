...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
	...
	public function writeChart(PHPExcel_Chart $pChart = null)
	{
		...
		$objWriter->startElement('c:chartSpace');
			...
			$objWriter->endElement();
/////////////////hard coded nao faz parte do codigo hehehehehehee o Pedro esteve aqui!!/////////////////////////////////
$objWriter->startElement('c:spPr');
    ...
    $objWriter->endElement();
$objWriter->endElement();
//http://stackoverflow.com/questions/18612897/phpexcel-graph-design-border-graph-color-graph-inner-position
/////////////////hard coded nao faz parte do codigo hehehehehehee o Pedro esteve aqui!!/////////////////////////////////
