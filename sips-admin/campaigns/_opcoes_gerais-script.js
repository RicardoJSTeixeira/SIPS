      ...
      $.ajax({
            ...
            success: function(data)
            {
                  ...
                  else
                  {
                        ...
                        $("#campaign_callback_limit").val(data.callback_hours_block);
...
function campaignCallbackLimit()
{
      if (!isNAN($("#campaign_callback_limit").val()))
      {
            $.ajax({
                  ...
                  data:
                          {
                                action: "CampaignCallbackLimit",
                                CampaignID: CampaignID,
                                max: $("#campaign_callback_limit").val()
                          },
                  success: function(data)
                  {
                  }
...
$("body")
        ...
        .on("change", "#campaign_callback_limit", campaignCallbackLimit);
