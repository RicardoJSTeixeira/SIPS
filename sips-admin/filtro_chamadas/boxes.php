...
function cria_listagem() {
    ...
    $query = "SELECT "
            ...
            . "LEFT JOIN `sips_sd_reservations` c ON b.id_resource=c.id_resource and a.active=1 and b.active=1 and start_date between '$date 00:00:00' and '$date_end 23:59:59' group by b.id_resource";
