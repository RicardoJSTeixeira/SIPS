...
function cria_listagem() {
    ...
    $query = "SELECT "
            ...
            . "LEFT JOIN `sips_sd_reservations` c ON b.id_resource=c.id_resource and a.active=1 and b.active=1 and  ((start_date <='$date_end' And start_date >='$date') or (end_date <='$date_end' And end_date >='$date') or (start_date <='$date_end' And end_date >='$date')) group by b.id_resource";
