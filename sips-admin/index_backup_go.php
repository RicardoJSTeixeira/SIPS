...
<body id="ib">
    ...
    <div class="container-fluid">
        ...
        <div id='cc-header' class="row-fluid">
            <div class="span3">
                <img style='float:left' src='/images/pictures/sipslogo_header.png' id="menu-hide" >
            </div>
            <div class="span9">
                <a href="../index.php?logout=yes" ><img style='height:60px;float:right;' src='/images/pictures/new_logo.png' /></a>
            </div>
        </div>
            ...
            <div class="span2" id="menu"   style='margin-top:1px;'><!-- MENU -->
                ...
                <div class='cc-menu'>
                    <div class="grid-title">
                        <div class="pull-left  tooltip-top offset1" data-t="tooltip" title="SIPS.Menu">SIPS.Menu</div>
