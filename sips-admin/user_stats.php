...
<?
	...
	echo "<td id='submenu-title'> Estatisticas de $user </td>";
...
echo "<input type=hidden name=did value=\"$did\">\n";
	...
	echo "<td style='text-align:right'>De";
	echo "<input type=text name=begin_date value=\"$begin_date\" style='width:68px; height:24px' maxsize=10>";
...
<?
echo "</td>";
	echo "<td style='text-align:left'> a <input type=text name=end_date value=\"$end_date\" style='width:68px; height:24px' maxsize=10>";
?>
...
if ($did < 1)
	...
	echo "<div class=cc-mstyle>";
	echo "<B>Tempo em conversação e status:</B>\n";

	echo "<table>\n";
	echo "<tr><th>Status</th><th>Total</th><th>Horas:MM:SS</th></tr>";
	...
	echo "<tr><td>Total de Chamadas</td><td>$total_calls</td><td> $call_hours_minutes</td></tr>";
	echo "</TABLE></div>";
	...
	echo "<B>Tempo de Login/Logout do utilizador:</B>\n";
	echo "<table>";
	echo "<tr><td><font size=2>Tipo</td><td align=right><font size=2>Data</td><td align=right><font size=2>Campanha</td><td align=right><font size=2>Grupo</td><td align=right><font size=2>Horas:MM:SS</td><td align=right><font size=2>Sessão</td><td align=right><font size=2>Servidor</td><td align=right><font size=2>Telefone</td><td align=right><font size=2>LAN IP</td></tr>\n";
	...
	echo "<B>Chamadas em Outbound para este período: (Limite de 10000 registos)</B>\n";
	echo "<TABLE width=670 cellspacing=0 cellpadding=1 class='userlist'>\n";
	echo "<tr><td><font size=1># </td><td><font size=2>Data/Hora</td><td align=left><font size=2>Duração</td><td align=left><font size=2> Status</td><td align=left><font size=2> Telefone</td><td align=right><font size=2> Campanha</td><td align=right><font size=2> Grupo</td><td align=right><font size=2> ID Lista</td><td align=right><font size=2> ID Lead</td><td align=right><font size=2>Quem desligou</td></tr>\n";
...
echo "<B>Chamadas em Inbound para este período: (Limite de 10000 registos)</B>\n";
echo "<TABLE width=750 cellspacing=0 cellpadding=1 class='userlist'>\n";
echo "<tr><td><font size=1># </td><td><font size=2>Data/Hora </td><td align=left><font size=2>Duração</td><td align=left><font size=2> Status</td><td align=left><font size=2> Telefone</td><td align=right><font size=2> Campanha</td><td align=right><font size=2> Espera (s)</td><td align=right><font size=2> Utilizador (s)</td><td align=right><font size=2> ID Lista</td><td align=right><font size=2> Lead</td><td align=right><font size=2> Quem desligou</td></tr>\n";
...
echo "<td colspan=2><font size=2>Totais</td>";
...
if ($did < 1)
	{
	echo "<B>Actividade do utilizador neste período: (Limite de 10000 registos)</B>\n";
	echo "<TABLE width=750 cellspacing=0 cellpadding=1 class='userlist'>\n";
	echo "<tr><td colspan=2><font size=1> &nbsp; </td><td colspan=6 align=center bgcolor=white><font size=1>estes valores são em segundos </td><td colspan=4><font size=1> &nbsp; </td></tr>\n";
	echo "<tr><td><font size=1># </td><td><font size=2>Data/Hora </td><td align=left><font size=2>Pausa</td><td align=left><font size=2> Espera</td><td align=left><font size=2> Conversa</td><td align=right><font size=2> Disponível</td><td align=right><font size=2> Dead</td><td align=right><font size=2> Cliente</td><td align=right><font size=2> Status</td><td align=right><font size=2> ID Lead</td><td align=right><font size=2> Campanha</td><td align=right><font size=2> Código de Pausa</td></tr>\n";
...
echo "<B>Gravações neste período: (Limite de 10000 registos)</B>\n";
echo "<TABLE width=750 cellspacing=0 cellpadding=1 class='userlist'>\n";
