...
if($action=="submit_campaign_fields")
{
	...
	while (!feof($file)) 
	{
		...
		$headers_ids_sql = "";
				...
				mysql_query("INSERT INTO vicidial_list (".$field_ids_sql.", entry_date, called_since_last_reset, gmt_offset_now, last_local_call_time, list_id ) VALUES (".$headers_ids_sql.", '$entry_date', '$called_since_last_reset', '$gmt_offset', '$last_local_call_time', '$sent_list_id')", $link) or die(mysql_error);
		}
...
$convert = "/srv/www/htdocs/_sipsdev/sips-admin/campaign_manager/wizard/sheet2tab.pl /srv/www/htdocs/_sipsdev/sips-admin/campaign_manager/wizard/upload/$copyfilename /srv/www/htdocs/_sipsdev/sips-admin/campaign_manager/wizard/upload/$convertedfilename";
passthru("$convert");
