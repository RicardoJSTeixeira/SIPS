...
<div style='width:97%; margin:0 auto; border:none;'>
	...
	<div id="wizard-tabs" style="display:none"> 
		<ul> 
			...
			<li class="tab-hidden" id="li-pausas"><a href="#tab2">Pausas</a></li>
	        <li class="tab-hidden" id="li-feeds"><a href="#tab3">Feedbacks</a></li>
            <li class="tab-hidden" id="li-recycle"><a href="#tab8">Reciclagem</a></li> 
			<li class="tab-hidden" id="li-scripts"><a href="#tab4">Scripts</a></li>
			<li class="tab-hidden" id="li-dfields"><a href="#tab5">Campos Dinâmicos</a></li>
			<li class="tab-hidden" id="li-dbs"><a href="#tab6">Bases de Dados</a></li>
