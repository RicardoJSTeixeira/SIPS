...
if ($action=="add_new_database_campaign")
{
	...
	mysql_query("INSERT INTO vicidial_list_ref (Name, Display_name, readonly, active, campaign_id, field_order) VALUES ('COMMENTS', 'Mensagem', '0', '1', '$sent_campaign_id', '1')") or die(mysql_error());	
	mysql_query("INSERT INTO vicidial_list_ref (Name, Display_name, readonly, active, campaign_id, field_order) VALUES ('EMAIL', 'Email', '0', '1', '$sent_campaign_id', '2')") or die(mysql_error());	
