...
<div class="div-title">Opções do <i>Dialer</i></div>
<table>
<tr>
<td>Randomização do <i>Dialer</i> </td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Ordem de Marcação</td> 
<td class="td-text">
<select>
	<option <? if($aCampInfo['lead_order']=="RANDOM"){echo "selected='selected'";} ?> value="RANDOM">Aleatória</option>
    <option <? if($aCampInfo['lead_order']=="DOWN"){echo "selected='selected'";} ?> value="DOWN">Descendente</option>
    <option <? if($aCampInfo['lead_order']=="UP"){echo "selected=selected";} ?> value="UP">Ascendente</option>
</select>
</td> <td class="td-icon"> <img id="icon-campaign-leads" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Ordem de Marcação Secundária </td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>

<tr class="spacer8"></tr>

<tr>
<td>Nível Mínimo do <i>Dialer</i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Nível Automático do <i>Dialer</i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Multiplicador do <i>Dialer</i> Automático</td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Remoção Automática do Excesso de Leads</td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table> -->
...
<div class="div-title">Tranferência de Chamadas</div>
<table>
<tr>
<td>Permitir <i>Closers</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Grupos de Transferência</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Grupo de Tranferência por Defeito</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table>


<div class="div-title">Chamadas Manuais</div>
<table>
<tr>
<td>Manual Dial Override</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Manual Dial List ID</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Manual Dial Filter</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Manual Dial Preview</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Manual Dial API</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table>
...
<div class="div-title">Operadores</div>
<table>
<tr>
<td>Agent Pause after Each Call</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent Call Re-Queue Button</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent Grab Calls in Queue</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>View Calls in Queue Launch</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent View Calls in Queue</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent Display Queue Count</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent Display Dialable Leads</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent Lead Search</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Agent LEad Search Methos</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table>
...
<table>
<tr>
<td>Agent Pause Codes Active</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Auto Pause Pre-Call Work</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Auto Resume Pre-Call Work</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Auto Pause Pre-Call Code</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table>
...
<div class="div-title">Listas DNC</div>
<table>
<tr>
<td>Use Internal DNC List</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Use Campaign DNC List</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table>


<div class="div-title">Chamadas Perdidas</div>
<table>
<tr>
<td>Drop Call Secounds</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Drop Action</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Voice Mail</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Drop Transfer Group</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
</table>
...
<table>
<tr>
<td>Scheduled Callbacks</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Scheduled Callbacks Alert</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Scheduled Callbacks Count</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Drop Transfer Group</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
...
<div class="div-title">Gravação de Chamadas</div>
<table>
<tr>
<td>Campaign Recording</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Campaing Rec Filename</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Recording Delay</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
<tr>
<td>Drop Transfer Group</i></i></td> <td class="td-text"></td> <td class="td-icon"> <img id="icon-campaign-recycle" class="td-image-help" src="/images/icons/document_properties_16.png"> </td>
</tr>
...
/* INI */
$(".td-image-help").attr("title", "Clique para visualizar mais informação sobre este item.");
$(".td-image-edit").attr("title", "Clique para editar este item.");
/* ERROR DIALOG */ 
var $error = $('<div></div>')
...
/* BOTOES */
$(function(){
	$( "#buttonedit-call-options" ).button().click(function(){ $("#dialog-campaign-name").dialog("open") });
});
/* EDIT DIALOGS */
