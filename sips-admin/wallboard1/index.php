...
//fazer função em php para acertar as horas
//1 for a passar pelos ticks com step 5 minutos e acerta tudo
                                                                                                                                  ...
                                                                                                                                  if ($("#linhas_filtro").val() === "2")
                                                                                                                                            switch ($("#linhas_serie").val())
                                                                                                                                            {
                                                                                                                                                      case "1":
                                                                                                                                                                ...
                                                                                                                                                                querie = get_query(13);
                                                                                                                                                                querie[1] = querie[1].replace("$hour", 1);
                                                                                                                                                                querie[1] = querie[1].replace("$status", $("#status_venda").val());
                                                                                                                                                                querie[1] = querie[1].replace("$user", $("#user").val());
                                                                                                                                                                manipulate_dataset("insert_dataset", 0, id_wallboard, querie[1], querie[2], "inbound", "1", $("#status_venda").val(), $("#user").val(), 0);
                                                                                                                                                                break;
                                                                                                                                                      case "2":
                                                                                                                                                                ...
                                                                                                                                                                querie[1] = querie[1].replace("$status", $("#status_venda").val());
                                                                                                                                                                querie[1] = querie[1].replace("$user_group", $("#user_group").val());
                                                                                                                                                                manipulate_dataset("insert_dataset", 0, id_wallboard, querie[1], querie[2], "inbound", "1", $("#status_venda").val(), $("#user_group").val(), 0);
                                                                                                                                                                break;
                                                                                                                                                      case "3":
                                                                                                                                                                ...
                                                                                                                                                                querie[1] = querie[1].replace("$status", $("#status_venda").val());
                                                                                                                                                                querie[1] = querie[1].replace("$campaign_id", $("#campaign").val());
                                                                                                                                                                manipulate_dataset("insert_dataset", 0, id_wallboard, querie[1], querie[2], "inbound", "1", $("#status_venda").val(), $("#campaign").val(), 0);
                                                                                                                                                                break;
                                                                                                                                                      case "4":
                                                                                                                                                                ...
                                                                                                                                                                querie[1] = querie[1].replace("$hour", 1);
                                                                                                                                                                querie[1] = querie[1].replace("$status", $("#status_venda").val());
                                                                                                                                                                manipulate_dataset("insert_dataset", 0, id_wallboard, querie[1], querie[2], "inbound", "1", $("#status_venda").val(), 0, 0);
                                                                                                                                                                break;
                                                                                                                                                      case "5":
                                                                                                    ...
                                                                                                    $("#dialog_delete ").dialog({
                                                                                                              ...
                                                                                                              buttons: {
                                                                                                                        ...
                                                                                                                        "Sim": function() {
                                                                                                                                  ...
                                                                                                                                  {
                                                                                                                                            console.log(layouts[0] + " aaa " + idLayout)
                                                                                                    ...
                                                                                                    $("#dialog_inbound").dialog({
                                                                                                              ...
                                                                                                              buttons: {
                                                                                                                        ...
                                                                                                                        "Criar": function() {
                                                                                                                                  ...
                                                                                                                                  manipulate_dataset("insert_dataset", 0, $("#group_inbound_select option:selected").text(), Math.floor((Math.random() * 500) + 1), Math.floor((Math.random() * 250) + 1), 429, 242, idLayout, query, $("#group_inbound_select").val(), 10000, selected_type_graph, 0);
                                                                                                                                  load_dados("wbe", idLayout);
                                                                                                                                  $(this).dialog("close");
                                                                                                                        }
                                                                                                              }
                                                                                          ...
                                                                                          function manipulate_dataset(Opcao, Id, id_Wallboard, Query_text, Opcao_query, Mode, Param1, Param2, Param3, Param4)
                                                                                          {
                                                                                          ...
                                                                                          //wallboard
                                                                                          function manipulate_dados(opcao, Id, Name, Pos_x, Pos_y, Width, Height, id_layout, graph_ID)
                                                                                          {
                                                                                          ...
                                                                                          function manipulate_graph(Opcao, Id, Name, Pos_x, Pos_y, Width, Height, id_Layout, Update_time, Graph_type, Param1, Param2)
                                                                                          {
                                                                                                    ...
                                                                                                    function(data)
                                                                                                    {
                                                                                                              ...
                                                                                                              {
                                                                                                                        $.each(data, function(index, value) {
                                                                                                                                  queries.push([this.id, this.query_text, this.opcao_query, this.type_query, this.codigo]);
                                                                                                                        });
                                                                                                              }
                                                                                                    }, "json");
                                                                                          }
                                                                                          ...
                                                                                          function flot_extra(opcao)
                                                                                          {
                                                                                                    ...
                                                                                                    function(data)
                                                                                                    {
                                                                                                              ...
                                                                                                              if (opcao === "total_cc")
                                                                                                              {
                                                                                                                        var db = document.getElementById("total_cc");
                                                                                                                        $.each(data, function(index, value) {
                                                                                                                                  var opt1 = document.createElement("option");
                                                                                                                                  opt1.value = this.id;
                                                                                                                                  opt1.text = this.name;
