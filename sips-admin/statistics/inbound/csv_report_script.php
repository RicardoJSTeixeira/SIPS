...
$stmt="	SELECT 
			...
			$campos, 
			vcs.status_name as 'Feedback',c.length_in_sec as 'Tempo de Chamada', c.queue_position as 'Posicao na Fila', c.queue_seconds as 'Tempo de Queue', c.term_reason as 'Motivo de Hangup'
