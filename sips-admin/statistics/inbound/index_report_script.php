...
echo "<td id='submenu-title'> Report de Script - Inbound </td>";
...
echo "<INPUT READONLY TYPE=TEXT style='width:175px; text-align:center; text:indent:0;' id='data_inicial' MAXLENGTH=10 NAME=query_date VALUE=\"$query_date\">";
...
<?php
echo "<INPUT READONLY TYPE=TEXT style='width:175px; text-align:center; text:indent:0;' MAXLENGTH=10 NAME=end_date id='data_final' VALUE=\"$end_date\"></TD><TD VALIGN=TOP> <label>Campanhas: </label>";
