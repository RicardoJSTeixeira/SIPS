...
if ($user->user_group != "ADMIN") {
    $where = " AND b.campaign_id in('" . implode("','", $user->allowed_campaigns) . "')";
}
        ...
        <div id="work-area" style="min-height:0px"><br><br>
            <div class=cc-mstyle style=border:none>
                <table>
                    ...
                    <tr>
                        <td>Base de Dados:</td><td><select name="db_options" id="db_options" style="width:202px;"><?php echo $db_options; ?></select></td>	
                    </tr>
                    <tr>
