...
var render = function(script_id, lead_id, unique_id, user_id, campaign_id, admin_review)
{
      var page_info = {"script_id": script_id, "lead_id": lead_id, "unique_id": unique_id, "user_id": user_id, "campaign_id": campaign_id, "admin_review": admin_review};
      $.get("/sips-admin/script_dinamico/items.html", function(data) {
            $("#dummie").html(data);
    ...
    $(function() {
            ...
            $(document).on("click", "#myform #script_div .previous_pag", function(e) {
                  e.preventDefault();
            ...
            $(document).on("click", "#myform #script_div .next_pag", function(e) {
                  e.preventDefault();
            ...
            $(document).on("click", "#myform #script_div .scheduler_button_go", function(e) {
                  e.preventDefault();
            ...
            $(document).on("click", "#myform #script_div .pdf_button", function(e)
            {
...
//UPDATES DE INFO
      function update_script(callback)
      {
            ...
            {
                  $.post("/sips-admin/script_dinamico/requests.php", {action: "get_scripts_by_id_script", id_script: page_info.script_id},
                  function(data)
                  {
                        if (data !== null)
                        {
            ...
            else
            {
                  ...
                  $.post("/sips-admin/script_dinamico/requests.php", {action: "get_scripts_by_campaign", id_campaign: camp_linha},
                  function(data)
                  {
                        if (data !== null)
                        {
      ...
      function update_info()
      {
            ...
            $.post("/sips-admin/script_dinamico/requests.php", {action: "get_data_render", id_script: page_info.script_id},
            function(data)
            {
                  $("#script_div").empty();
...
//FAZER O APPEND DOS ITEMS A LISTA
            ...
            switch (opcao)
            {
                  case "texto":
                        ...
                        if (data.default_value.toString().length > 2)
                        {
                              ...
                              $.post("/sips-admin/script_dinamico/requests.php", {action: "get_client_info_by_lead_id", lead_id: page_info.lead_id, user_logged: page_info.user_id},
                              function(data1)
                              {
                  ...
                  case "scheduler":
                        ...
                        $.post("/sips-admin/script_dinamico/requests.php", {action: "get_schedule_by_id", ids: data.values_text.join(",")},
                        function(data3)
                        {
      ...
      {
            $.post("/sips-admin/script_dinamico/requests.php", {action: "get_results_to_populate", lead_id: page_info.lead_id, id_script: page_info.script_id},
            function(data)
            {
...
//RULES  
      ...
      function rules(callback)
      {
            ...
            $.post("/sips-admin/script_dinamico/requests.php", {action: "get_rules", id_script: page_info.script_id},
            function(data)
            {
...
//FORM MANIPULATION
      ...
      {
            $.post("/sips-admin/script_dinamico/requests.php", {action: "save_form_result", id_script: page_info.script_id, results: $("#myform").serializeArray(), user_id: page_info.user_id, unique_id: unique_id, campaign_id: page_info.campaign_id, lead_id: page_info.lead_id, admin_review: admin_review},
            function() {
                  admin_review = 0;
                  if (typeof callback === "function")
                  {
