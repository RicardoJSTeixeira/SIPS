...
<TR BGCOLOR=#E6E6E6>
<TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a href="<?php echo "../goautodial-admin/$PHP_SELF" ?>">List Territories</a></TD>
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a href="<?php echo "../goautodial-admin/$PHP_SELF" ?>?action=ADD_TERRITORY">Add Territory</a></TD>
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a href="<?php echo "../goautodial-admin/$PHP_SELF" ?>?action=ADD_USER_TERRITORY">Add User Territory</a></TD>
<?
if ($enable_vtiger_integration > 0)
	{ ?>
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a href="<?php echo "../goautodial-admin/$PHP_SELF" ?>?action=CHANGE_TERRITORY_OWNER">Change Vtiger Territory Owner</a></TD>
<?
	$colspan='4';
	} ?>
