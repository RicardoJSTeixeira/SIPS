...
<html>
    ...
    <body>
        ...
        <div id=load class=cc-mstyle style=display:none;width:600px;position:absolute;z-index:1000;margin-left:-300px;left:50%;border-top-left-radius:0px;border-top-right-radius:0px;><img src="/images/icons/loading.gif" alt=Espera style="margin-right:auto;margin-left:auto;display:block;" />
            <p style=text-align:center>A enviar...<p>
        </div>
                ...
                <div class="grid">
                    ...
                    <div class="grid-content">
                        ...
                        <div class="formRow"  id="uni">
                            <label data-t="tooltip" title="">Número:</label>
                            <div class="formRight">
                        ...
                        <div class="formRow"><label data-t="tooltip" title="">Mensagem:</label>
                            <div class="formRight">
                                <div style=margin-top:20px>
                                    ...
                                    <p style="margin-left:40%" class="camp" id="msgc"><input type="checkbox" value="1" name="msg_comments" id="msg_comments"/><label for="msg_comments"><span></span> Mensagem no campo <i>Comentários</i></label></p>
