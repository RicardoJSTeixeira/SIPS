...
if (isset($_GET["list_id"])) {
    $list_id = strtoupper($_GET["list_id"]);
} elseif (isset($_POST["list_id"])) {
    $list_id = strtoupper($_POST["list_id"]);
}
...
if (isset($_GET["field_action"])) {
    $field_action = $_GET["field_action"];
} elseif (isset($_POST["field_action"])) {
...
##### BEGIN copy list fields submit
                                                                                    if (($action == "COPY_FIELDS_SUBMIT") and (strlen($copy_option) > 2)) {
                                                                                        if ($list_id == "$source_list_id") {
                                                                                            ...
                                                                                            if (!$linkCUSTOM) {
                                                                                                die("Could not connect: $VARDB_server|$VARDB_port|$VARDB_database|$VARDB_custom_user|$VARDB_custom_pass" . mysql_error());
                                                                                            }
                                                                                        ...
                                                                                        if ($navigation == "resumo") {
                                                                                            ...
                                                                                            while ($fields_to_print > $o) {
                                                                                                ...
                                                                                                switch ($A_field_type[$o]) {
                                                                                                    ...
                                                                                                    case "TEXT" : $ftype = "Texto";
                                                                                                        break;
                                                                                                    case "AREA" : $ftype = "Caixa de Texto";
                                                                                                        break;
                                                                                                    case "SELECT" : $ftype = "Combo-Box";
                                                                                                        break;
                                                                                                    case "MULTI" : $ftype = "Multi Selecção";
                                                                                                        break;
                                                                                                    case "RADIO" : $ftype = "Botão Rádio";
                                                                                                        break;
                                                                                                    case "CHECKBOX" : $ftype = "Checkbox";
                                                                                                        break;
                                                                                                    case "DATE" : $ftype = "Data";
                                                                                                        break;
                                                                                                    case "TIME" : $ftype = "Hora";
                                                                                                        break;
                                                                                                    case "DISPLAY" : $ftype = "Script sem variáveis";
                                                                                                        break;
                                                                                                    case "SCRIPT" : $ftype = "Script com variáveis";
                                                                                                        break;
                                                                                                    case "JSCRIPT" : $ftype = "JavaScript";
                                                                                                        break;
                                                                                                }
                                                                                        ...
                                                                                        if ($navigation == "editar") {
                                                                                            ...
                                                                                            switch ($A_field_order[$o]) {
                                                                                                ...
                                                                                                case 3: $selected3 = "selected";
                                                                                                    break;
                                                                                                case 4: $selected4 = "selected";
                                                                                                    break;
                                                                                                case 5: $selected5 = "selected";
                                                                                                    break;
                                                                                            }
                                                                                            ...
                                                                                            switch ($A_field_type[$o]) {
                                                                                                ...
                                                                                                case "TEXT" : $selected = "selected";
                                                                                                    break;
                                                                                                case "AREA" : $selected1 = "selected";
                                                                                                    break;
                                                                                                case "SELECT" : $selected2 = "selected";
                                                                                                    break;
                                                                                                case "MULTI" : $selected3 = "selected";
                                                                                                    break;
                                                                                                case "RADIO" : $selected4 = "selected";
                                                                                                    break;
                                                                                                case "CHECKBOX" : $selected5 = "selected";
                                                                                                    break;
                                                                                                case "DATE" : $selected6 = "selected";
                                                                                                    break;
                                                                                                case "TIME" : $selected7 = "selected";
                                                                                                    break;
                                                                                                case "DISPLAY" : $selected8 = "selected";
                                                                                                    break;
                                                                                                case "SCRIPT" : $selected9 = "selected";
                                                                                                    break;
                                                                                                case "JSCRIPT" : $selected10 = "selected";
                                                                                                    break;
                                                                                            }
                                                                                            ...
                                                                                            if ($LOGuser_level == 9) {
                                                                                                echo "<option $selected10 value=JSCRIPT>Java Script</option>\n";
                                                                                            }
                                                                                            ...
                                                                                            if ($A_multi_position[$o] == "HORIZONTAL") {
                                                                                                $selected = "selected";
                                                                                            } else {
                                                                                                $selected1 = "selected";
                                                                                            }
...
########################################
                                                                                    ...
                                                                                    if ($navigation == "novo") {
                                                                                        ...
                                                                                        if ($LOGuser_level == 9) {
                                                                                            echo "<option value=JSCRIPT>Java Script</option>\n";
                                                                                        }
...
##### BEGIN list lists as well as the number of custom fields in each list
                                                                                    if ($action == "LIST") {
                                                                                        ...
                                                                                        while ($total_camps > $o) {
                                                                                            ...
                                                                                            if ($A_active[$o] == "Y") {
                                                                                                $img_active = "<img src=../images/icons/tick_16.png />";
                                                                                            } else {
                                                                                                $img_active = "<img src=../images/icons/cross_16.png />";
                                                                                            }
                                                                                    ...
                                                                                    if ($action == "ADMIN_LOG") {
                                                                                        if ($LOGuser_level >= 9) {
                                                                                            ...
                                                                                            while ($logs_to_print > $o) {
                                                                                                ...
                                                                                                if (eregi("USER|AGENT", $row[4])) {
                                                                                                    $record_link = "ADD=3&user=$row[6]";
                                                                                                }
                                                                                                if (eregi('CAMPAIGN', $row[4])) {
                                                                                                    $record_link = "ADD=31&campaign_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('LIST', $row[4])) {
                                                                                                    $record_link = "ADD=311&list_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('SCRIPT', $row[4])) {
                                                                                                    $record_link = "ADD=3111111&script_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('FILTER', $row[4])) {
                                                                                                    $record_link = "ADD=31111111&lead_filter_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('INGROUP', $row[4])) {
                                                                                                    $record_link = "ADD=3111&group_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('DID', $row[4])) {
                                                                                                    $record_link = "ADD=3311&did_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('USERGROUP', $row[4])) {
                                                                                                    $record_link = "ADD=311111&user_group=$row[6]";
                                                                                                }
                                                                                                if (eregi('REMOTEAGENT', $row[4])) {
                                                                                                    $record_link = "ADD=31111&remote_agent_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('PHONE', $row[4])) {
                                                                                                    $record_link = "ADD=10000000000";
                                                                                                }
                                                                                                if (eregi('CALLTIME', $row[4])) {
                                                                                                    $record_link = "ADD=311111111&call_time_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('SHIFT', $row[4])) {
                                                                                                    $record_link = "ADD=331111111&shift_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('CONFTEMPLATE', $row[4])) {
                                                                                                    $record_link = "ADD=331111111111&template_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('CARRIER', $row[4])) {
                                                                                                    $record_link = "ADD=341111111111&carrier_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('SERVER', $row[4])) {
                                                                                                    $record_link = "ADD=311111111111&server_id=$row[6]";
                                                                                                }
                                                                                                if (eregi('CONFERENCE', $row[4])) {
                                                                                                    $record_link = "ADD=1000000000000";
                                                                                                }
                                                                                                if (eregi('SYSTEM', $row[4])) {
                                                                                                    $record_link = "ADD=311111111111111";
                                                                                                }
                                                                                                if (eregi('CATEGOR', $row[4])) {
                                                                                                    $record_link = "ADD=331111111111111";
                                                                                                }
                                                                                                if (eregi('GROUPALIAS', $row[4])) {
                                                                                                    $record_link = "ADD=33111111111&group_alias_id=$row[6]";
                                                                                                }
...
##### BEGIN add field function
                                                                                    ...
                                                                                    function add_field_function($DB, $link, $linkCUSTOM, $ip, $user, $table_exists, $field_id, $list_id, $field_label, $field_name, $field_description, $field_rank, $field_help, $field_type, $field_options, $field_size, $field_max, $field_default, $field_required, $field_cost, $multi_position, $name_position, $field_order, $vicidial_list_fields, $mod_action) {
                                                                                        ...
                                                                                        if (($field_type == 'DISPLAY') or ($field_type == 'SCRIPT') or ($field_type == 'JSCRIPT') or (preg_match("/\|$field_label\|/", $vicidial_list_fields))) {
                                                                                            if ($DB) {
                                                                                        ...
                                                                                        if ($field_type == 'JSCRIPT') {
                                                                                            $field_options = mysql_real_escape_string($field_options);
                                                                                        }
                                                                                        #working
