...
$(function() {
    ...
    $(".datetimep").datetimepicker({format: 'yyyy-mm-dd hh:ii:ss', autoclose: true, language: "pt"}).bind("cut copy paste", function(e) {
        e.preventDefault();
    });
...
function get_table_data()
{
    ...
    $('#callback_info').dataTable({
        ...
        "fnServerParams": function(aoData) {
            ...
            {"name": "inactive", "value": $("#checkboxinactive").is(":checked")}
            );
        },
        "aoColumns": [
