...
require("../sips-admin/functions.php");
...
$open_list = "<TABLE WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#EFEFEF\"><TR><TD ALIGN=CENTER><a href=\"#\" onclick=\"showDiv(\'campaign_select_list\');\"><font size=2>Choose Report Display Options</a></TD></TR></TABLE>";
...
echo "<TITLE>$report_name: $group</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0 style='background:url(../images/bg1.jpg)' onload='parent.bload('SIPS - RealTimeReport');'>\n";
...
echo "<span style=\"position:absolute;margin-left:-250px;top:3px;z-index:20;\" id=campaign_select_list_link>\n";
echo "<TABLE WIDTH=250 CELLPADDING=0 CELLSPACING=0 ><TR><TD ALIGN=CENTER>\n";
echo "<a href='#' onclick=\"showDiv('campaign_select_list');\">Choose Report Display Options</a>";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
echo "<span style=\"position:absolute;left:100px;top:40px;z-index:21;border:1px solid #000;\" id=campaign_select_list>\n";
...
if ($webphone_bufh > 10)
	{echo "<BR><img src=../sips-admin//'images/pixel.gif/' width=1 height=$webphone_bufh>\n";}
echo "<BR>\n\n";
...
echo "</TD></TR></TABLE>\n";
echo "</TD></TR></TABLE>\n";
//require("../sips-admin/admin_footer.php");
?>
