...
if (file_exists('../sips-admin/options.php'))
	{
	require('../sips-admin/options.php');
	}
...
while ($groups_to_print > $o)
	...
	if (ereg("\|$LISTgroups[$o]\|",$group_string)) 
		{$group_string_alterado = ($LISTgroups[$o]=="ALL-ACTIVE") ? "Todos Activos" : "$LISTgroups[$o] - $LISTnames[$o]" ;
...
$select_list .= "</select></td></table><br>";
$select_list .= "<TABLE>";


#$select_list .= "<tr><td>Dial Level</td><td><select name=change_dial_level><option value=1>1</option><option value=2>2</option><option value=3>3</option></select></td></tr>";



$select_list .= "<TR><TD align=right>";
$select_list .= "Tempo de Actualização:  </TD><TD align=left><SELECT SIZE=1 NAME=RR ID=RR>";
$select_list .= "<option value=\"5\"";   if ($RR < 6) {$select_list .= " selected";}    $select_list .= ">5 Segundos</option>";
$select_list .= "<option value=\"10\"";   if ( ($RR >= 5) and ($RR <=10) ) {$select_list .= " selected";}    $select_list .= ">10 Segundos</option>";
$select_list .= "<option value=\"20\"";   if ( ($RR >= 11) and ($RR <=20) ) {$select_list .= " selected";}    $select_list .= ">20 Segundos</option>";
$select_list .= "<option value=\"30\"";   if ( ($RR >= 21) and ($RR <=30) ) {$select_list .= " selected";}    $select_list .= ">30 Segundos</option>";
$select_list .= "<option value=\"40\"";   if ( ($RR >= 31) and ($RR <=40) ) {$select_list .= " selected";}    $select_list .= ">40 Segundos</option>";
$select_list .= "<option value=\"60\"";   if ( ($RR >= 41) and ($RR <=60) ) {$select_list .= " selected";}    $select_list .= ">60 Segundos</option>";
$select_list .= "<option value=\"120\"";   if ( ($RR >= 61) and ($RR <=120) ) {$select_list .= " selected";}    $select_list .= ">2 Minutos</option>";
$select_list .= "<option value=\"300\"";   if ( ($RR >= 121) and ($RR <=300) ) {$select_list .= " selected";}    $select_list .= ">5 Minutos</option>";
$select_list .= "<option value=\"600\"";   if ( ($RR >= 301) and ($RR <=600) ) {$select_list .= " selected";}    $select_list .= ">10 Minutos</option>";
$select_list .= "<option value=\"1200\"";   if ( ($RR >= 601) and ($RR <=1200) ) {$select_list .= " selected";}    $select_list .= ">20 Minutos</option>";
$select_list .= "<option value=\"1800\"";   if ( ($RR >= 1201) and ($RR <=1800) ) {$select_list .= " selected";}    $select_list .= ">30 Minutos</option>";
$select_list .= "<option value=\"2400\"";   if ( ($RR >= 1801) and ($RR <=2400) ) {$select_list .= " selected";}    $select_list .= ">40 Minutos</option>";
$select_list .= "<option value=\"3600\"";   if ( ($RR >= 2401) and ($RR <=3600) ) {$select_list .= " selected";}    $select_list .= ">60 Minutos</option>";
$select_list .= "<option value=\"7200\"";   if ( ($RR >= 3601) and ($RR <=7200) ) {$select_list .= " selected";}    $select_list .= ">2 Horas</option>";
$select_list .= "<option value=\"63072000\"";   if ($RR >= 7201) {$select_list .= " selected";}    $select_list .= ">2 Anos</option>";
...
$select_list .= "<INPUT type=text style=width: NAME=monitor_phone ID=monitor_phone VALUE=\"$monitor_phone\">";
$select_list .= "</TD></TR>";
...
function ForceReady(user)
	{
		...
		if (xmlhttp) 
			{
			forceready_query = "ACTION=updateforceready" + "&user=" + user;
			xmlhttp.open('POST', 'sips_xmlrequests.php'); 
			xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
			xmlhttp.send(forceready_query); 
...
/*echo "<TABLE WIDTH=180 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#fff\"><TR><TD ALIGN=CENTER>\n";
echo "<a href='#' onclick=\"showDiv('campaign_select_list');\">Choose Report Display Options</a>";
echo "</TD></TR></TABLE>\n";
echo "</span>\n"; */
/*echo "<TABLE WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#fff\"><TR><TD ALIGN=CENTER>\n";
echo "";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";*/
...
if ($webphone_bufh > 10)
	{echo "<BR><img src='..../images/icons/pixel.gif/' width=1 height=$webphone_bufh>\n";}*/


/*if ($adastats<2)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('adastats','');\"><span id=adastatsTXT>+ VIEW MORE</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('adastats','');\"><span id=adastatsTXT>- VIEW LESS</span></a>";}
if ($UGdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('UGdisplay','');\"><span id=UGdisplayTXT>HIDE USER GROUP</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('UGdisplay','');\"><span id=UGdisplayTXT>VIEW USER GROUP</span></a>";}
if ($SERVdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('SERVdisplay','');\"><span id=SERVdisplayTXT>HIDE SERVER INFO</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('SERVdisplay','');\"><span id=SERVdisplayTXT>SHOW SERVER INFO</span></a>";}
if ($CALLSdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('CALLSdisplay','');\"><span id=CALLSdisplayTXT>HIDE WAITING CALLS</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('CALLSdisplay','');\"><span id=CALLSdisplayTXT>SHOW WAITING CALLS</span></a>";}
if ($ALLINGROUPstats>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('ALLINGROUPstats','');\"><span id=ALLINGROUPstatsTXT>HIDE IN-GROUP STATS</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('ALLINGROUPstats','');\"><span id=ALLINGROUPstatsTXT>SHOW IN-GROUP STATS</span></a>";}
if ($PHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('PHONEdisplay','');\"><span id=PHONEdisplayTXT>HIDE PHONES</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('PHONEdisplay','');\"><span id=PHONEdisplayTXT>SHOW PHONES</span></a>";}
if ($CUSTPHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('CUSTPHONEdisplay','');\"><span id=CUSTPHONEdisplayTXT>HIDE CUSTPHONES</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('CUSTPHONEdisplay','');\"><span id=CUSTPHONEdisplayTXT>SHOW CUSTPHONES</span></a>";} */
...
#echo "<table>"; #esta table tem de tar aqui senao o REALTIMEform não funciona ...
...
######################
	...
	/*		if ($adastats<2)
			{echo "<td><a href='#' onclick=\"update_variables('adastats','');\"><span id=adastatsTXT>Detalhes</span></a></td>";}
		else
			{echo "<td><a href='#' onclick=\"update_variables('adastats','');\"><span id=adastatsTXT>Detalhes</span></a></td>";} */
/*		if ($UGdisplay>0)
			{echo "<td><a href='#' onclick=\"update_variables('UGdisplay','');\"><span id=UGdisplayTXT>Grupos</span></a></td>";}
		else
			{echo "<td><a href='#' onclick=\"update_variables('UGdisplay','');\"><span id=UGdisplayTXT>Grupos</span></a></td>";} */
/*		if ($SERVdisplay>0)
			{echo "<td><a href='#' onclick=\"update_variables('SERVdisplay','');\"><span id=SERVdisplayTXT>Server</span></a></td>";}
		else
			{echo "<td><a href='#' onclick=\"update_variables('SERVdisplay','');\"><span id=SERVdisplayTXT>Server</span></a></td>";} */
	/*	if ($CALLSdisplay>0)
			{echo "<td style='width:80px;'><a href='#' onclick=\"update_variables('CALLSdisplay','');\"><span id=CALLSdisplayTXT>Em Espera</span></a></td>";}
		else
			{echo "<td style='width:80px;'><a href='#' onclick=\"update_variables('CALLSdisplay','');\"><span id=CALLSdisplayTXT>Em Espera</span></a></td>";}
			
			
	/*	if ($ALLINGROUPstats>0)
			{echo "<td><a href='#' onclick=\"update_variables('ALLINGROUPstats','');\"><span id=ALLINGROUPstatsTXT>HIDE IN-GROUP STATS</span></a></td>";}
		else
			{echo "<td><a href='#' onclick=\"update_variables('ALLINGROUPstats','');\"><span id=ALLINGROUPstatsTXT>SHOW IN-GROUP STATS</span></a></td>";}
	/*	if ($PHONEdisplay>0)
			{echo "<td><a href='#' onclick=\"update_variables('PHONEdisplay','');\"><span id=PHONEdisplayTXT>HIDE PHONES</span></a>";}
		else
			{echo "<td><a href='#' onclick=\"update_variables('PHONEdisplay','');\"><span id=PHONEdisplayTXT>SHOW PHONES</span></a></td>";} */
	/*	if ($CUSTPHONEdisplay>0)
			{echo "<td><a href='#' onclick=\"update_variables('CUSTPHONEdisplay','');\"><span id=CUSTPHONEdisplayTXT>HIDE CUSTPHONES</span></a></td>";}
		else
			{echo "<td><a href='#' onclick=\"update_variables('CUSTPHONEdisplay','');\"><span id=CUSTPHONEdisplayTXT>SHOW CUSTPHONES</span></a></td>";}
		
	/*	if (eregi('ALL-ACTIVE',$group_string))
			{echo "<td><a href=../sips-admin/admin.php?ADD=10\">MODIFY</a></td>";}
		else
			{echo "<td><a href=../sips-admin/admin.php?ADD=34&campaign_id=$group\">MODIFY</a></td>";} */

	/*	echo "<td><a href=../sips-admin/AST_timeonVDADallSUMMARY.php?RR=$RR&DB=$DB&adastats=$adastats\">SUMMARY</a></td>"; */ 
