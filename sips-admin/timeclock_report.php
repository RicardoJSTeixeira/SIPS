...
require("../goautodial-admin/dbconnect.php");
...
<script language="JavaScript" src="../goautodial-admin/calendar_db.js"></script>
<link rel="stylesheet" href="../goautodial-admin/calendar.css">
...
require("../goautodial-admin/admin_header.php");
...
echo "</TD></TR></TABLE>\n";
echo "</TD></TR></TABLE>\n";
require("../goautodial-admin/admin_footer.php");
