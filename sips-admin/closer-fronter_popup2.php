...
$browser = getenv("HTTP_USER_AGENT");
  ...
  if( (strlen($user)<2) or (strlen($pass)<2) or (!$auth))
	{
    Header("WWW-Authenticate: Basic realm=\"SIPS Call-Center - $user - $PHP_AUTH_USER\"");
...
if (eregi('UNIV',$channel_group))
	...
	<form action="../goautodial-admin/uk_mail_lookup.php" method="post" onSubmit="return CheckForm()">
